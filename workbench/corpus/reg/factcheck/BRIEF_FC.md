...
Input: /home/claude/corpus/factcheck/in_<GROUP>.json — MCQs whose keyed answer depends on a statutory/regulatory fact
...
Output: /home/claude/corpus/factcheck/out_<GROUP>.json — list, one entry per input id, EVERY id present:
