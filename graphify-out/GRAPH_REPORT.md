# Graph Report - ccp-mainbuild-v1  (2026-09-23)

## Corpus Check
- 2589 files · ~3,325,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 59723 nodes · 124499 edges · 6200 communities (1650 shown, 4550 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 34004 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3af5946f`
...
1. `SBStub` - 1424 edges
2. `SBStub` - 1055 edges
3. `get_supabase_admin()` - 868 edges
4. `get_supabase_admin()` - 741 edges
5. `LIST` - 306 edges
6. `All()` - 269 edges
7. `MasteryWriter` - 257 edges
8. `api` - 255 edges
9. `TaxSBStub` - 233 edges
10. `SBStub` - 226 edges
...
## Communities (6200 total, 4550 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (713): cancel_booking(), list_bookings(), _shape_booking(), _audit(), create_rematch_block(), _emit_mod_event(), get_group_detail(), get_mentor_detail() (+705 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (570): create_mentor_order(), _is_uuid(), join_group(), _mentor_price_total(), Create a Razorpay order for a mentor booking (amount fixed server-side)., Resolve `mentor_id` into (profile_uuid, mentor_slug, catalogue_row)., Server-derived booking price in whole INR (None => not bookable)., _resolve_mentor() (+562 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (600): list_partners(), _bulk_resolve_for_recruitment_scope(), _list_open_conflicts(), _load_conflict(), _patch_queue_extracted_data(), _patch_recruitment_field(), Patch ``scrape_queue.extracted_data[field_key]`` with the chosen value., Patch a single canonical column on a recruitment row.      Only columns in :da (+592 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (589): bulk_import(), _constraint_violation_http_error(), create_pyq_question_stimulus(), create_pyq_stimulus(), create_syllabus_document(), _exam_slug(), get_diagnostics(), get_pyq_paper() (+581 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (155): EMPTY_FORM, apiFetch(), _apiFetchOnce(), buildApiError(), formatApiErrorDetail(), getAccessToken(), getApiBlockingFields(), getApiBlockingIssues() (+147 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (256): CandidateCountsSection(), emptyForm(), parseCount(), scopeError(), renderCC(), CompetitionPanel(), emptyCutoffMap(), emptyVacancyMap() (+248 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (224): VerificationReportsContent(), CaQuestionReviewQueue(), AnswerStructureReviewQueue(), DECISION_LABEL, formPatch(), label(), LIST_FIELDS, ReviewDialog() (+216 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (275): book_mentor(), Confirm a mentor booking AFTER verifying the Razorpay payment.      Previously, Create a *pending* partner request. Consent-first: the pair is created     only, Recipient accepts/declines a pending request. Accept atomically creates     the, request_partner(), respond_partner_request(), list_queue_item_conflicts(), list_recruitment_conflicts() (+267 more)

### Community 8 - "Community 8"
Cohesion: 0.01
Nodes (162): renderAt(), renderSidebar(), renderCms(), renderCms(), renderWithClient(), renderWithClient(), renderPage(), renderWithClient() (+154 more)

### Community 9 - "Community 9"
Cohesion: 0.01
Nodes (130): ReverificationBatches(), ACTION_TYPES, AdminVerificationReports(), ApplyRegistryActionPanel(), buildUrl(), BulkToolbar(), ConfirmProofPanel(), CYCLE_DATE_FIELDS (+122 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (250): _build_app(), Tests for the admin CRUD endpoints on ``exam_eligibility_rules`` (PR-D2)., Non-trust edits must not be blocked by provenance check., test_admin_with_permission_can_list(), test_audit_log_captures_waiver_reason_in_notes(), test_create_draft_discipline_with_verified_percentage_sibling_is_allowed(), test_create_new_rule_type_as_draft_is_allowed(), test_create_new_rule_type_lands_draft() (+242 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (245): _client(), _ConflictStub, _ProvenanceRaceStub, Tests for the PYQ-paper trust_status lifecycle endpoint (review).  POST /admin, set-provenance with a pyq_source_id that does not exist → 422., Changing pyq_source_id via generic PATCH on a verified paper is blocked     bec, set-provenance can change pyq_source_id on a verified paper, which     demotes, All four provenance fields (source_type, source_url, source_document_id,     py (+237 more)

### Community 12 - "Community 12"
Cohesion: 0.01
Nodes (243): _AcceptCommitBody, _AcceptPreviewBody, _as_float(), CandidateCountEvidenceBody, CompetitionEvidenceBody, compute_score_snapshots(), ComputeSnapshotBody, _console_base_filters() (+235 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (225): Scraper trust-gate API.  Endpoints:     GET  /api/sources, List scrape queue items with server-side filter/search/sort.      The previous, Endpoint decorator: map an unrecovered Supabase transport disconnect     into a, Parse a dotted field path like ``posts.0.min_age`` into segments.      Each se, Mark a queue item as backed by a verified official source.      Promotion is g, Return a dry-run preview of what promoting this queue item would create., Show what merging this queue item into the recruitment would do.      Returns, Undo a claim-first promote claim after a downstream failure.      Only reverts (+217 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (241): _clamp(), generate_plan(), Generate and persist today's study plan for ``user_id``.      Thin wrapper ove, Return ``(priority_score, mastery_gap)`` for one coverage row.      Transparen, _score_topic(), _clamp(), generate_plan(), Generate and persist today's study plan for ``user_id``.      Thin wrapper ove (+233 more)

### Community 15 - "Community 15"
Cohesion: 0.01
Nodes (172): _client(), Tests for the universal /api/evidence/{kind}/{id} endpoint.  Admin-permission, pyq_option is now a registered evidence kind so the review-queue     EvidenceDr, test_evidence_400_for_unknown_kind(), test_evidence_404_for_missing_row(), test_evidence_pyq_option_kind_returns_row(), test_evidence_returns_row_and_trust_envelope(), Resolve the entry context for a unified onboarding session.      Returns a dic (+164 more)

### Community 16 - "Community 16"
Cohesion: 0.01
Nodes (109): AppBreadcrumbs(), getBreadcrumbs(), renderAt(), useBreadcrumbLeaf(), useBreadcrumbLeafValue(), COMMUNITY_LINKS, ChannelRules(), CommunityScreen() (+101 more)

### Community 17 - "Community 17"
Cohesion: 0.01
Nodes (230): CancelBody, GroupJoinBody, list_groups(), MentorBook, MentorOrderCreate, _now_iso(), PartnerReq, PartnerRespondReq (+222 more)
...
Cohesion: 0.01
Nodes (147): ExamGovernanceConsole(), queryClient, actual, cbs, mockExecute, mockLoginWithGoogle, mockNavigate, mockRequestPhoneOtp (+139 more)

### Community 20 - "Community 20"
Cohesion: 0.01
Nodes (110): FOCUSABLE_SELECTOR, getFocusableElements(), useFocusTrap(), AuditDrawer(), AdminOrganizations(), NewOrgModal(), ORG_TYPES, OrganizationDrawer() (+102 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (208): _happy_result(), Admin coverage-derivation API tests.  Covers the single endpoint added to ``ap, role='admin' only carries exam_intelligence.review, not .manage., _seed(), test_derive_blocked_for_caller_without_manage_permission(), test_derive_blocked_for_plain_user(), test_derive_empty_body_returns_422_missing_required_key(), test_derive_explicit_null_exam_phase_id_succeeds_exam_wide() (+200 more)

### Community 22 - "Community 22"
Cohesion: 0.01
Nodes (77): AdminMentors(), badge(), fmt(), kycBadge(), detailCalls(), inspect, listCalls(), mockGet (+69 more)
...
Cohesion: 0.02
Nodes (194): promote_to_recruitments(), _is_duplicate_slug_rpc_error(), _is_rpc_missing_error(), promote_run(), promote_to_recruitments(), Run a single scrape pass over active sources.      Returns the summary dict +, Stamp newly-promoted ``recruitment_id`` onto unattached lifecycle     events th, Clear ``currently_scraping_at``. Called from a finally block. (+186 more)

### Community 25 - "Community 25"
Cohesion: 0.02
Nodes (199): Standard write-body shape used by every CMS endpoint., WriteEnvelope, Admin Exam Intelligence — Manage Exam operational editors (J2-A).  This router, Both endpoints of an edge must belong to the exam's resolved subjects (PD-1)., Return the distinct subject ids the exam covers.      Resolution path is the e, Return human-readable dependency labels blocking a topic delete.      Covers e, List the subjects an exam covers (coverage path, OD-4).      Empty coverage →, Bounded delete (rule 5). Blocked (409) when the topic has aliases,     coverage (+191 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (77): TABS, FILTERS, ROWS, INTEL_STATUS, IdentitySection(), IdentityStep(), Chips(), Grid() (+69 more)

### Community 27 - "Community 27"
Cohesion: 0.02
Nodes (173): _active_plan_row(), add_comment(), add_tracker(), _aggregate_error_types(), ApplicationUpsert, _assemble_profile_payload(), carry_forward_tasks(), categories() (+165 more)
...
Cohesion: 0.03
Nodes (171): get_attempt(), get_result(), _question_section_index(), Score and finalise the attempt. Idempotent — second call returns same result., Create a new in_progress attempt.      Raises:         LookupError — template, Return current attempt state with saved responses and time_remaining_sec., Idempotent upsert for a single answer.      ``numeric_answer`` carries the lea, save_answer() (+163 more)

### Community 30 - "Community 30"
Cohesion: 0.01
Nodes (61): useCalculationGym(), CalculationGymShell(), formatClock(), renderShell(), StudyCompare(), CycleCountdown(), titleCase(), CycleProgressRail() (+53 more)

### Community 31 - "Community 31"
Cohesion: 0.02
Nodes (167): _clean_events(), _live_row(), _make_mock_ad(), _make_mock_inputs(), _make_sr_pass_data(), _raise_prereq(), Tests for tools/mastery_shadow_analysis/shadow_analysis.py.  RB5: shadow_repla, Sufficient matched pairs + missing_audit > 0 → FAIL status (not PASS). (+159 more)

### Community 32 - "Community 32"
Cohesion: 0.02
Nodes (151): apply_plan(), Apply today's computed plan. Always persists when ``generated=True``.      Ide, apply_plan(), compute_draft_plan(), _diff_tasks(), Return a structured diff: ``added`` / ``removed`` / ``unchanged`` topic ids., Return a structured diff: ``added`` / ``removed`` / ``unchanged`` topic ids., Rough risk label from how much of the plan is mutating. (+143 more)
...
Cohesion: 0.02
Nodes (149): open(), _backoff_s(), batched(), build_sql(), fixture_client(), idempotency_key(), _is_transient(), load_alias_map() (+141 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (111): _AuditFailRpcQuery, _AuditFailSBStub, _client(), _DocRaceRpcQuery, _DocRaceSBStub, _pyq_review_client(), Backend CMS endpoints for the subject/topic taxonomy (migration 029).  Covers, Mirror every check in migration 193's cms_review_pyq_source() function. (+103 more)
...
Cohesion: 0.03
Nodes (125): submit(), _now_iso(), Attempt event service (PR2b).  Responsibilities:   - record_server_event : sy, _backoff_seconds(), _require(), get_events(), ingest_client_events(), _now_iso() (+117 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (139): _build_app(), _competition_seed(), _lane_seed(), _large_seed(), _options_seed(), _paginated_seed(), Admin exam intelligence API tests (PR5)., When q is absent the query must NOT include an ilike or_ (q-search filter). (+131 more)

### Community 41 - "Community 41"
Cohesion: 0.03
Nodes (135): derive_topic_coverage(), Derive/update ``draft`` ``exam_topic_coverage`` rows for *exam_id*.      Reads, derive_topic_coverage(), Derive/update ``draft`` ``exam_topic_coverage`` rows for *exam_id*.      Reads, Derive/update ``draft`` ``exam_topic_coverage`` rows for *exam_id*.      Reads, Derive/update ``draft`` ``exam_topic_coverage`` rows for *exam_id*.      Reads, _FingerprintRaceSB, _InsertConflictSB (+127 more)

### Community 42 - "Community 42"
Cohesion: 0.08
Nodes (133): ClassificationReadiness, AttemptInputs, Read-only derivation helpers for mastery preview.  All functions are zero-writ, Read frozen shadow write decisions ordered by topic_id.      duplicate_keys is, Exact replay of shadow deltas using Decimal arithmetic throughout.      Uses t, Deterministic correction derivation — no mutable user error state.      Passes, Mutable path — reads current DB mastery and error state.      Explicitly label, Single wider SELECT from mock_attempt_responses; returns None if attempt absent. (+125 more)

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (94): ArchiveDocumentRequest, DocCompleteUploadRequest, DocUploadUrlRequest, LinkPyqPaperRequest, LinkSyllabusRequest, MixedFormatRequest, B1 admin-declared mixed-format flag (J3 Mixed-Format PDF Gate, Option     B). S, Dispatcher logic: maps exam_identity to structural_format, and structural_forma (+86 more)
...
Cohesion: 0.03
Nodes (102): AttemptQuestionAnalytics, AttemptTopicAnalytics, CorrectionEvidence, CorrectionTaskDraft, DerivationResult, DerivedAttemptAnalytics, ErrorPatternSignal, MasteryDelta (+94 more)

### Community 46 - "Community 46"
Cohesion: 0.03
Nodes (120): anthropic_client(), build_candidates(), build_prompt(), parse_response(), propose(), The microtopics this question is allowed to be tagged with.      Three conjunc, Render one batch of questions with their candidate microtopics., Parse and fully validate one batch response.      Every branch here raises. No (+112 more)

### Community 47 - "Community 47"
Cohesion: 0.03
Nodes (129): link_to_syllabus(), _now_iso(), add_role(), AddRoleRequest, _asset_scope_conflict(), _authoritative_source_ids(), _evidence_kinds(), _is_trigger_violation() (+121 more)

### Community 48 - "Community 48"
Cohesion: 0.05
Nodes (84): _client(), _commit(), _dup_label_sections(), _legacy_clean_row(), _make_csv_v2(), _make_legacy_csv(), _preflight_csv_v2(), _preflight_json_v2() (+76 more)

### Community 49 - "Community 49"
Cohesion: 0.03
Nodes (112): _bare_topic(), _four(), _mcq(), _opt(), _primary(), _q(), Unit tests for ``scripts/pyq_question_review.py``.  The script lives at the re, Two empty options are a count/content problem, not a duplicate claim. (+104 more)

### Community 50 - "Community 50"
Cohesion: 0.03
Nodes (84): MasteryClassificationNotReady, Classifications are not yet fully populated for this attempt.      Raised by p, _client_for_user(), _make_option(), _make_question(), Synchronous submit path — mastery allowlist enforcement tests.  Verifies that, Build a TestClient that authenticates as user_id., Start an attempt and call the submit API endpoint.      Returns (attempt_id, s (+76 more)

### Community 51 - "Community 51"
Cohesion: 0.03
Nodes (123): approve_question(), archive_question(), CommitImportIn, CreateQuestionIn, dedup_check(), force_status(), ForceStatusIn, get_question() (+115 more)

### Community 52 - "Community 52"
Cohesion: 0.02
Nodes (86): AdminPlans(), EMPTY, formatPrice(), paiseToRupees(), PlanCard(), AdminRBAC(), CREATE_ROLE_OPTIONS, formatDate() (+78 more)
...
Cohesion: 0.03
Nodes (112): build_parser(), build_worksheet(), Client, do_apply(), do_export(), do_sweep(), _kind_for(), load_topic_catalog() (+104 more)

### Community 56 - "Community 56"
Cohesion: 0.02
Nodes (64): actionHref(), EVIDENCE_LABEL, fmtPct(), TopicRow(), confidenceColor(), highlightText(), PageViewer(), ProposalActionBar() (+56 more)

### Community 57 - "Community 57"
Cohesion: 0.02
Nodes (75): OperationsConsole(), QUEUE_FILTERS, ReviewAndPublish(), AdminFixPanel(), QueueFixSection(), RecruitmentFixSection(), statusBadge(), renderPanel() (+67 more)

### Community 58 - "Community 58"
Cohesion: 0.04
Nodes (73): backfill_option_hashes(), Populate ``normalized_option_hash`` (and optionally     ``normalized_question_h, Populate ``normalized_option_hash`` (and optionally     ``normalized_question_h, Populate ``normalized_option_hash`` (and optionally     ``normalized_question_h, normalize_option_text(), normalize_question_text(), option_hash(), question_hash() (+65 more)

### Community 59 - "Community 59"
Cohesion: 0.03
Nodes (94): _base_report(), _effective_data(), _FakeSB, _FakeTable, _make_sb(), _R, Tests: promote_report() wires gate-PASS to promote_to_recruitments().  Concern, test_gate_blocked_does_not_call_promote() (+86 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (113): get_plan_timeline(), Compose the Exam Cycle Timeline payload for a user.      Returns the empty fal, _client(), _exam_seed(), _plan_with_tasks(), Plan Timeline service + API tests., Phases without phase_start produce date=None, status='preview'., phase_start populates the milestone date and correct past/upcoming status. (+105 more)

### Community 61 - "Community 61"
Cohesion: 0.03
Nodes (84): _MergeConflictSB, _MergeFinalizeMissesSB, MergeSB, _MergeWriteFailsSB, _PromoteFinalizeMissesSB, _PromoteVerifiedSB, Adds ``recruitments`` + ``extracted_field_evidence`` so merge-into can run., ``MergeSB`` plus an open ``recruitment_verification_conflicts`` row so the (+76 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (107): ArchiveDocumentRequest, DocCompleteUploadRequest, DocUploadUrlRequest, LinkPyqPaperRequest, LinkSyllabusRequest, MixedFormatRequest, Admin-only PDF upload for Exam Intelligence documents.  Replaces manual ``stor, Validate a requested policy, or supply the per-type default.      Raises HTTPE (+99 more)

### Community 63 - "Community 63"
Cohesion: 0.03
Nodes (95): _dom_rows(), _list_queue(), Test coverage for Sprint 2 admin scrape endpoints (PR #212):      GET  /api/ad, ``q`` translates to a PostgREST ``or_`` ILIKE filter on     source_name + sourc, ``source_type`` lives on source_registry, not scrape_queue.     The endpoint pu, The response carries ``filters`` so the UI can confirm the active     set. Test, # NOTE: The mock dispatch uses exact-match filters; ``.ilike`` isn't, _row_with_posts() (+87 more)
...
Cohesion: 0.03
Nodes (68): DeriveCoverageBody, Attach evidence to a working (draft/pending_review) competition-metric     revi, List evidence attached to a competition-metric row (OD-9: the review     surfac, Best-effort admin_audit_logs insert (mirrors admin_exam_intel_cms._audit)., List ``exam_competition_metrics`` rows for admin review.      Only ``locked``, Move an ``exam_competition_metrics`` row through its lifecycle.      Lifecycle, Clone a published (reviewed/locked) row into a new draft revision.      The pu, Attach evidence to a working (draft/pending_review) candidate-count     revisio (+60 more)

### Community 66 - "Community 66"
Cohesion: 0.02
Nodes (63): formatTime(), MockAttemptShell(), styles, formatTime(), MockAttemptShell(), styles, TcsIonAttemptShell(), BACKOFFS_MS (+55 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (61): compute_exam_workspace_readiness(), Compute full workspace readiness for exam_id (optionally scoped to cycle_id)., Compute full workspace readiness for exam_id (optionally scoped to cycle_id)., _make_sb(), verified_question_count is identical whether cycle_id is None or provided., verified_question_count is identical whether cycle_id is None or provided., Gate 3 missing (no tag) → review_pending → partial status.          verified p, Gate 3 missing (no tag) → review_pending → partial status.          verified p (+53 more)

### Community 68 - "Community 68"
Cohesion: 0.02
Nodes (61): errorTypeLabel(), DIFFICULTY_OPTIONS, { api }, SUMMARY, { api }, err, listPayload, mockNavigate (+53 more)

### Community 69 - "Community 69"
Cohesion: 0.03
Nodes (80): NormalizedRecruitment, Strip NUL and other C0 control chars (keeping tab/newline/CR).      Returns ``, Recursively ``sanitize_text`` every string in a JSON-shaped value.      dict k, sanitize_json(), sanitize_text(), _compute_final_status(), NormalizedRecruitment, Strip NUL and other C0 control chars (keeping tab/newline/CR).      Returns `` (+72 more)

### Community 70 - "Community 70"
Cohesion: 0.03
Nodes (73): reason_length(), validate_status(), _max_ge_min(), _no_explicit_null(), _nonblank(), _patch_prompt_text_nonblank(), _prompt_text_nonblank(), DatabaseError (+65 more)

### Community 71 - "Community 71"
Cohesion: 0.03
Nodes (104): _Block, _catalogue(), _catalogue_row(), _loaded(), _mapped(), _proposal(), _question(), An UNMAPPED question still needs grading: the difficulty is the whole of     wh (+96 more)

### Community 72 - "Community 72"
Cohesion: 0.04
Nodes (100): aggregator_max_items(), async_safe_select(), maybe_single(), Run a ``.maybe_single()`` query, tolerating a zero-row match.      postgrest-p, Async wrapper around safe_select for async API boundaries.      supabase-py ca, slugify(), fetch_page_html(), Public alias of the HTML→plain-text reducer used inside fetch().      Exposed (+92 more)

### Community 73 - "Community 73"
Cohesion: 0.05
Nodes (103): admin_community_flags(), admin_resolve_community_flag(), _audit(), book_mentor_session(), cancel_mentor_session(), contribute_resource(), create_channel_thread(), create_thread_reply() (+95 more)

### Community 74 - "Community 74"
Cohesion: 0.03
Nodes (69): classify_aggregator_link(), _clean_label(), discover_aggregator_detail_urls(), _host(), is_aggregator_source(), _looks_like_detail(), _matches_any(), _normalise_host() (+61 more)

### Community 75 - "Community 75"
Cohesion: 0.03
Nodes (96): canonical_counts(), correction_title(), _explicit_fallback(), normalize_error_type(), Source-neutral mock-correction CATEGORIZATION policy (§7 unification).  Single, Map a raw error type / error_patterns key to a canonical category, or None, Category-only, origin-independent correction title., Aggregate raw error counts onto canonical categories; drop unknown/≤0.      Al (+88 more)

### Community 76 - "Community 76"
Cohesion: 0.02
Nodes (47): SEVERITY_BADGE, mark, stub, useErrorLab(), LENS_ANCHOR, LENS_KEYS, LENS_LABEL, LENSES (+39 more)

### Community 77 - "Community 77"
Cohesion: 0.04
Nodes (98): run_scraping_pass(), Dry-run isolation (PR: scraper-quality-gates #1).  A dry-run (``mock=True``) s, The open-queue dedup read must filter out ``dry_run`` status so a real     run, test_dedup_read_excludes_dry_run_rows(), test_promotion_gate_blocks_dry_run_row(), Scraper quality gates (PR: scraper-org-type-gates).  P1-1  resolved-without-ho, _jobs_source(), Runner-level SerpApi adapter tests.  Covers dispatch from ``run_scraping_pass` (+90 more)

### Community 78 - "Community 78"
Cohesion: 0.04
Nodes (102): apply_corrections(), build_envelope(), Apply operator-supplied repairs for source-document damage.      A correction, Emit the v2 bulk-import envelope.      ``question_number`` and ``display_order, _dot_question(), _para(), _question(), An MCQ paper converted under --descriptive would lose its options silently. (+94 more)

### Community 79 - "Community 79"
Cohesion: 0.03
Nodes (61): AnswerEditor(), SAVE_LABEL, AnswerStructurePanel(), budgetLine(), AttemptPages(), pageCountLabel(), refreshDelayMs(), AttemptDetail() (+53 more)

### Community 80 - "Community 80"
Cohesion: 0.04
Nodes (99): detect_marker(), detect_option_style(), _index_reference_defect(), _is_complete_label_set(), Line, _load_answer_key(), main(), _match_directions() (+91 more)

### Community 81 - "Community 81"
Cohesion: 0.04
Nodes (98): admin_sources(), _audit(), build_effective_extracted_data(), _chunked_in(), correct_field(), _is_missing_rpc(), _list_sources(), mark_queue_item_duplicate() (+90 more)

### Community 82 - "Community 82"
Cohesion: 0.05
Nodes (86): analytics(), answer(), AnswerBody, _attempt_status(), enter_section_route(), EnterSectionBody, Mock Engine API — PR1 vertical slice.  Routes (all under /api/study/mocks):, read_attempt() (+78 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (96): _activate_body(), _bulk_row(), _client(), CSSBStub, Router-layer tests for Content Studio writing-prompt operations.  Covers the s, A bulk row carries no subject_id (subject is body-level, idempotency scope)., _review_body(), _seed() (+88 more)
...
Cohesion: 0.04
Nodes (81): _agg_one(), _build_app(), _client(), CountingSBStub, FailingSBStub, _paging_db(), _pyq_db(), _RaisingQuery (+73 more)
...
Cohesion: 0.05
Nodes (49): PR2: Exam Workspace readiness endpoint + compute function tests.  GET /api/adm, TestPYQEmptyMetricsKeys, TestReadyToActivate, TestUpdatesRejectedCount, compute_exam_workspace_readiness(), Compute full workspace readiness for exam_id (optionally scoped to cycle_id)., _make_sb(), verified_question_count is identical whether cycle_id is None or provided. (+41 more)
...
Cohesion: 0.06
Nodes (84): Run L1–L5 and decide ``auto_resolved`` / ``suggested`` / ``unresolved``., run_resolver_waterfall(), Tests for the PR5 canonical-edit hook.  Plan §6 ship gate:  * canonical edit, Tests for the PR7 soft-backfill driver.  Plan §2 + §9 (PR7 ship gate):  * em, Tests for the PR5 canonical-edit hook.  Plan §6 ship gate:  * canonical edit, _seed(), test_hook_does_not_fire_on_non_critical_field_edit(), test_hook_does_not_fire_when_hash_unchanged() (+76 more)
...
Cohesion: 0.04
Nodes (93): _as_bool(), _attach_tree_position(), _attempt_counts(), _attempt_questions(), _attempted_question_ids(), _chunks(), compare_attempts(), coverage() (+85 more)
...
Cohesion: 0.04
Nodes (81): fetch(), fetch_api(), fetch_api_paginated(), fetch_page_text(), fetch_pdf(), fetch_rss(), parse_json_feed(), parse_pdf_bytes() (+73 more)

### Community 95 - "Community 95"
Cohesion: 0.03
Nodes (84): _flag_enabled(), _flag_enabled(), admin_create_plan(), admin_disable_plan(), admin_list_plans(), admin_payments(), admin_subs(), admin_update_plan() (+76 more)

### Community 96 - "Community 96"
Cohesion: 0.05
Nodes (39): detect_ordinal(), Return the printed leading ordinal if text starts with one, else None., _assemble_question(), _block_bbox(), block_to_question(), cluster_by_vertical_gap(), _is_anchor(), _join_block_text() (+31 more)

### Community 97 - "Community 97"
Cohesion: 0.07
Nodes (92): _activate_body(), _bulk_row(), _client(), CSSBStub, A bulk row carries no subject_id (subject is body-level, idempotency scope)., _review_body(), _seed(), _seed_selectors() (+84 more)

### Community 98 - "Community 98"
Cohesion: 0.06
Nodes (81): POST a WriteEnvelope. Returns the created row.          The CMS wraps every wr, _app(), Seed the Phase 2 tables on top of the minimal fixture., Phase 1 had table-name typos (user_notes / revision_schedule / mock_results);, _seed_artifacts(), _seed_content(), _seed_minimal_user(), _seed_mocks() (+73 more)
...
Cohesion: 0.08
Nodes (86): _admin_psql(), _apply(), _base_payload(), _bulk(), _bulk_counts(), _create(), _create_id(), _doc() (+78 more)
...
Cohesion: 0.04
Nodes (42): propose_syllabus_mentions(), Return proposed syllabus_topic_mention objects for the given document.      Ra, Return proposed syllabus_topic_mention objects for the given document.      Ra, _client(), _make_sb(), _post(), PR3a: Syllabus mention proposer tests.  POST /api/admin/exam-intelligence/work, A slightly misspelled alias at exactly the threshold should be accepted. (+34 more)

### Community 103 - "Community 103"
Cohesion: 0.04
Nodes (76): _bucket(), _demo_db(), FakeConn, _pass(), _q(), _qid(), Planning contract for scripts/split_optional_buckets.py (PRACTICE-PAPER-01)., A re-run matches an existing split row by metadata.paper_code, so the     same (+68 more)

### Community 104 - "Community 104"
Cohesion: 0.03
Nodes (82): _descriptive_paper(), _dot_question(), _idx(), _ifsca_q5(), Unit tests for ``scripts/docx_to_pyq_json.py``.  The script lives at the repo, Without --descriptive these are just questions with no options., Turning off the option checks must not turn off the rest., Nine shapes occur across SEBI/PFRDA/IFSCA — word first and range first,     one (+74 more)
...
Cohesion: 0.05
Nodes (83): derive_attempt_evidence_corrections(), load_attempt_inputs(), load_persisted_shadow_decisions(), derive_attempt_evidence_corrections(), Deterministic correction derivation — no mutable user error state.      Passes, _analytics_for_corrections(), _analytics_with_correct_answer(), _base_db() (+75 more)

### Community 107 - "Community 107"
Cohesion: 0.04
Nodes (81): cancel(), complete(), CompleteBody, create_revision(), _is_uuid(), list_revisions(), _now_iso(), Revision Calendar API.  Read endpoints fan out a date range into a per-day map (+73 more)

### Community 108 - "Community 108"
Cohesion: 0.03
Nodes (82): start_generated(), _parse_negative_marking(), Generated-mock ATTEMPT START service (A-PR3, D4 Option-B). MUTATING.  This is, Per-question wrong-answer penalty (absolute) from an authored value.      Auth, _build_attempt_payload(), _chunks(), _load_questions(), _parse_negative_marking() (+74 more)
...
Cohesion: 0.03
Nodes (80): bucket_coverage_depth(), _build_fingerprint(), CoverageDerivationError, _delta(), _existing_coverage_rows(), _existing_fingerprint(), _paginate(), _proposed_row() (+72 more)

### Community 112 - "Community 112"
Cohesion: 0.03
Nodes (81): locked_score_snapshots(), Return one locked snapshot per topic for planner consumption.      Returns the, Return one locked snapshot per topic for planner consumption.      Returns the, Return one locked snapshot per topic for planner consumption.      Returns the, Return one locked snapshot per topic for planner consumption.      Returns the, _descriptive_corpus(), _mains_spec(), Tests for exam_topic_score_snapshots writer and reader. (+73 more)

### Community 113 - "Community 113"
Cohesion: 0.05
Nodes (38): create_question(), [author] Create a new draft question., parse_file(), Parse CSV or JSON file bytes into raw row dicts., allowed_transitions(), ConflictError, Return the list of actions available from *status*., Fingerprint collision or self-review conflict. (+30 more)
...
Cohesion: 0.04
Nodes (69): _audit_trail(), get_answer_structure(), list_answer_structures(), _map_structure_error(), _question_context(), Content Studio — answer structure review queue.  `/api/admin/content-studio/an, The queue, filterable by subject / paper / year / status.      Subject, paper, Edit any content field of a draft / in-review structure.      The patch is mer (+61 more)
...
Cohesion: 0.04
Nodes (78): _criteria_difficulty_targets(), Apportion ``total`` questions across difficulty buckets by ``mix`` fractions., PR2d selector hook; supports section ``fixed`` and ``criteria`` selectors., select_questions_for_template(), _criteria_difficulty_targets(), Apportion ``total`` questions across difficulty buckets by ``mix`` fractions., _db_with_section(), _q() (+70 more)

### Community 121 - "Community 121"
Cohesion: 0.04
Nodes (63): exam_mock_readiness(), _mock_readiness(), _data(), pre_llm_dedup_check(), Skip the Anthropic call when a recruitment already carries this exact     URL., assemble_mock_readiness_report(), _chunked(), _count_by() (+55 more)

### Community 122 - "Community 122"
Cohesion: 0.03
Nodes (78): focus_weights(), Return the planner scoring weights for a ``focus`` choice., _active_plan(), _active_plan_today_tasks(), _build_tasks(), _compute_plan(), _cycle_planner_exposed(), _generate_writing_tasks() (+70 more)

### Community 123 - "Community 123"
Cohesion: 0.05
Nodes (71): test_write_conflicts_validates_required_conflict_id(), test_write_conflicts_writes_validated_payload(), _conflict_candidates(), Persist conflict list onto a report and optionally flip lifecycle.      The co, Project the report-jsonb ``values`` array into UI ``candidates`` rows.      Th, Upsert consensus conflicts into ``recruitment_verification_conflicts``.      K, _sync_conflicts_table(), _utc_now_iso() (+63 more)

### Community 124 - "Community 124"
Cohesion: 0.04
Nodes (64): Db, P3 — handwritten answers, photographed page by page.  The Mains answer an aspi, Migration 298 compares `(storage.foldername(name))[1]` to auth.uid(),     so th, Every argument that reaches the path comes from the server: the user id     fro, The brief's storage policy test, at the row layer., And at the storage layer, which is the half a row policy cannot cover.      Bo, Two aspirants' paths differ only by a user id., An answer must not grow after it was scored. (+56 more)
...
Cohesion: 0.05
Nodes (59): build_writing_tasks(), Deterministic ``why_this_task`` for a generated writing task., Emit ``english_writing_session`` task dicts for writing-eligible topics., _why_writing(), _cov(), _db(), _global_target(), _prompt() (+51 more)

### Community 128 - "Community 128"
Cohesion: 0.04
Nodes (67): compare_cohort(), DATE, Re-export the shared in-memory Supabase stub for compare tests, with small exte, Re-export the shared in-memory Supabase stub for the compare tests.  Historica, _client(), PR 1 — API integration via the FastAPI test client., _seed_min_db(), test_compare_me_self_view_only() (+59 more)

### Community 129 - "Community 129"
Cohesion: 0.04
Nodes (74): list_partners(), AttestBody, CheckinBody, compare_titles(), ComparisonSettings, CreateGroupBody, EndSessionBody, get_settings() (+66 more)
...
Cohesion: 0.05
Nodes (75): get_plan_impact(), Return the before/after planner-ranking diff of locking a coverage row.      D, Return the before/after planner-ranking diff of locking a coverage row.      D, Return the before/after planner-ranking diff of locking a coverage row.      D, _exam_level_score(), _num(), _rank(), Phase 8 — Plan Impact: before/after diff of locking a coverage row.  ``compute (+67 more)
...
Cohesion: 0.04
Nodes (73): pyq_bulk_preflight(), Preflight: parse CSV or JSON bytes, validate rows, run dedup. NO writes., _claim_token(), commit(), _consume_token(), _load_token(), _now_iso(), _now_ts() (+65 more)
...
Cohesion: 0.07
Nodes (70): classify_paper(), exam_reachability(), Band counts plus the two exclusion signals, for one paper's questions., Band counts plus the two exclusion signals, for one paper's questions., Eligibility verdict for one paper's tally. Deterministic, no heuristics., Eligibility verdict for one paper's tally. Deterministic, no heuristics., Per-paper band counts for every ASSESSED paper of ``exam_id``.      Returns el, Per-paper band counts for every ASSESSED paper of ``exam_id``.      Returns el (+62 more)

### Community 137 - "Community 137"
Cohesion: 0.04
Nodes (70): start_subject_practice(), _canonical_scope_is_reasoning(), Require every populated scope to resolve to canonical Reasoning taxonomy., Require every populated scope to resolve to canonical Reasoning taxonomy., _emit_calculation_gym(), _emit_english_writing(), _emit_timed_practice(), _emit_topic_pyq() (+62 more)

### Community 138 - "Community 138"
Cohesion: 0.04
Nodes (70): check_classification_readiness(), Return a readiness snapshot for attempt_id without writing anything.      read, check_classification_readiness(), Return a readiness snapshot for attempt_id without writing anything.      read, _client(), _now_iso(), PR #719 — mastery classification readiness gate.  Tests:   1. check_classific, process_attempt_sync raises MasteryClassificationNotReady when classifications a (+62 more)

### Community 139 - "Community 139"
Cohesion: 0.04
Nodes (40): configure(), Register or override the limit for ``route``. Tests use this., ReminderIn, _reset_rate_limit(), _reset_rate_limit(), _future(), _past(), Q (+32 more)

### Community 140 - "Community 140"
Cohesion: 0.05
Nodes (74): _build_app(), Tests for exam_registry_actions — corrigendum review → exam lifecycle update., Assert that nothing in the scraping/runner/gateway code touches     exam_cycles, Assert that every exam_registry_actions insert sets report_id.      The NOT NU, The /api/study/plan/timeline handler must not import     registry_action_servic, recruitment_events must not appear in any timeline-related query.      Discove, A GET on the apply URL does nothing; no action row is created., If the report_id doesn't resolve to a real report, the action is rejected. (+66 more)

### Community 141 - "Community 141"
Cohesion: 0.06
Nodes (73): get_trap_drill_streak(), Return the user's drill streak for this exam.      Always returns a payload (z, Return the user's drill streak for this exam.      Always returns a payload (z, Return the user's drill streak for this exam.      Always returns a payload (z, Return the user's drill streak for this exam.      Always returns a payload (z, Return the user's drill streak for this exam.      Always returns a payload (z, _build_app(), _days_ago() (+65 more)
...
Cohesion: 0.04
Nodes (72): _discovery_summary(), _document_id_by_content_hash(), _entry_digest(), _ingest_rss_items(), ingest_source(), _ingest_whole_body(), _insert_document(), _is_due() (+64 more)

### Community 147 - "Community 147"
Cohesion: 0.03
Nodes (40): ExamJourneyCard(), fmtDate(), pickNextMilestone(), STATUS_TONE, LaunchWritingPracticeButton(), useEnglishPracticeSession(), EnglishPracticeShell(), ExamJourneyCard() (+32 more)

### Community 148 - "Community 148"
Cohesion: 0.04
Nodes (49): classify_file(), read_text(), TurnstileWidget, VALID_SIZES, main(), scan_file(), Create or resume a unified onboarding session and return its state.      ``fie, resolve() (+41 more)

### Community 149 - "Community 149"
Cohesion: 0.12
Nodes (54): Deterministic eligibility engine — Career Copilot.  Direct port of ``UI-career, Map a known category token to its canonical bucket, or ``None`` if unrecognised., Years to add to max_age for non-ex-serviceman cases., Look up the ``attempts_used`` count for a given limit row.      Returns the co, Scrape pass runner + queue→canonical promoter.  Direct port of ``UI-career-cop, Hash the rule inputs that define a post's eligibility verdict.      The post i, True only when the error means the table genuinely does not exist     in this d, Load active post criteria, falling back when criteria embeds are unavailable. (+46 more)

### Community 150 - "Community 150"
Cohesion: 0.07
Nodes (66): _audit_stats(), build_roadmap(), _chunks(), derive_roadmap(), is_revise(), is_weak(), _latest_mastery(), load_roadmap_inputs() (+58 more)
...
Cohesion: 0.04
Nodes (48): options_total and topic_tags_total must be populated, not hard-reset to 0., options_total and topic_tags_total must be populated, not hard-reset to 0., TestPYQWorkbenchPopulatedTotals, _norm_answer(), Emulate cms_review_candidate_count (migration 219): transition         matrix +, Emulate cms_review_candidate_count (migration 219): transition         matrix +, Emulate cms_reopen_candidate_count_for_edit (migration 219):         clone-to-d, Emulate cms_reopen_candidate_count_for_edit (migration 219):         clone-to-d (+40 more)
...
Cohesion: 0.06
Nodes (66): persona_bank(), Shared in-memory seed data for unified onboarding tests.  Reuses the persona_q, Three safe persona questions + one deliberately sensitive one., _cold_session(), Deterministic next-question selection tests., test_already_answered_question_is_skipped(), test_anonymous_session_skips_persona_snapshot_lookup(), test_cold_session_with_intent_returns_persona_question() (+58 more)

### Community 156 - "Community 156"
Cohesion: 0.06
Nodes (67): CorrectionPolicyInput, Normalized correction evidence — the single input both origins build., apply_correction_task(), create_mock(), dismiss_correction_task(), draft_correction_tasks(), _draft_corrections_from_mock(), get_mock() (+59 more)

### Community 157 - "Community 157"
Cohesion: 0.04
Nodes (65): _client(), _make_option(), _make_question(), _make_template(), _past_iso(), Mock Engine — acceptance criteria 2–7.  AC2: Two tabs cannot start an active a, Service layer: starting twice raises ConflictError., API layer: second POST /start returns 409. (+57 more)

### Community 158 - "Community 158"
Cohesion: 0.04
Nodes (48): VerifyOrganizationRequest, _boom(), Counts rows in eligibility_results matching .eq filters and returns     .count, _StaleSB, test_eligibility_ops_stale_counts_rules_version_mismatch(), test_eligibility_ops_stale_zero_when_all_current(), test_eligibility_ops_surfaces_stale_query_failure(), test_evaluate_readiness_ready_with_posts_and_post_rules() (+40 more)

### Community 159 - "Community 159"
Cohesion: 0.08
Nodes (45): _action_task_type(), derive_correction_tasks(), ACTION/execution style for a correction — drives estimated_minutes only., Generated correction drafts — one per canonical category per topic.      Categ, Persist corrections into the EXISTING mock_correction_tasks schema (063)., _source_questions_from_evidence(), PlatformAttemptCorrectionForbiddenError, Raised when a caller attempts to manually draft corrections for a platform_attem (+37 more)
...
Cohesion: 0.09
Nodes (68): _client(), MngSBStub, Backend tests for J2-A Manage Exam operational editors.  Covers the `exam_inte, Exam E1 covers subject s1 (via coverage on t1); s2 is NOT covered., Topic list is a read: manage OR review can load it; neither is 403., No import/upsert semantics: a duplicate (subject, NULL, slug) → 409., Rule 4: ALL canonical patches are rejected while coverage is locked., is_active=false on a locked topic must be rejected (planner-impact). (+60 more)

### Community 164 - "Community 164"
Cohesion: 0.06
Nodes (27): _microtopic_tag(), _options(), _paper(), _primary_tag(), _question(), Without an explicit order the completed set is not a readable prefix., A ``topics`` row. ``parent_topic_id=None`` is a top-level topic; a set     pare, A verified primary tag pointing at a MICROTOPIC (child of TOPIC_ID). (+19 more)

### Community 165 - "Community 165"
Cohesion: 0.06
Nodes (67): evaluate_exam_for_user(), Decide one exam against one user profile. Pure function.      ``rules`` is the, evaluate_exam_for_user(), Decide one exam against one user profile. Pure function.      ``rules`` is the, Pure-function unit tests for the exam eligibility evaluator (PR-D1)., A trimmed-down UPSC CSE rule set covering all of the evaluator's     branches:, Rule list exists but the profile carries no data the rules read.     The result, A 34-year-old OBC user fails the general age cap but passes the OBC one. (+59 more)

### Community 166 - "Community 166"
Cohesion: 0.04
Nodes (40): _parse_field_path(), _admin(), Tests for the admin Operations Console backend additions (Phases 6-11).  These, Inline RecruitmentBlockerFixForm reads organization_id, source_id,     apply_st, _resolve_body(), _SB, test_admin_recruitments_exposes_inline_editor_fields(), test_eligibility_ops_returns_zeros_when_tables_missing() (+32 more)

### Community 167 - "Community 167"
Cohesion: 0.07
Nodes (58): ExtractConflict, Raised when another process already claimed the job (or no such     queued job, claim_next_retry_job(), claim_next_text_extract_job(), Select the oldest queued admin text_extract job.      This is a FIFO SELECT, n, Select the oldest retry-eligible transient-failed admin text_extract job., Tests for text_extract_worker.py (issues #540 and #813).  Covers: - claim_nex, _doc() (+50 more)

### Community 168 - "Community 168"
Cohesion: 0.03
Nodes (24): renderExamDetail(), renderExamDetailNoCycle(), ExamDocumentsSection(), renderTeaser(), DOC_TYPE_LABELS, DOC_TYPE_ORDER, CATEGORY_COLORS, CATEGORY_LABELS (+16 more)

### Community 169 - "Community 169"
Cohesion: 0.05
Nodes (66): agreement_rate(), _as_int(), as_metadata(), assert_bucket_scope(), assign_question(), best_ocr_paper(), BucketAbort, insert_args() (+58 more)

### Community 170 - "Community 170"
Cohesion: 0.05
Nodes (53): FakeConn, _fixture_conn(), _optional_row(), _plan(), _qid(), The stamp contract for scripts/backfill_gs_assignment_method.py.  WHAT THIS RE, `tag_only` is a statement about the GS tags a year's OCR failed to     corrobor, They agreed with the OCR on 1 of 93 and 5 of 78 and split anyway, before     th (+45 more)

### Community 171 - "Community 171"
Cohesion: 0.05
Nodes (61): _client(), _detail(), Tests for management read-model endpoints (Phase 0 — backend prerequisite).  C, When year is equal and no active/open/expected, lowest UUID wins., All action queue CTAs must deep-link to /exams/:id?tab=<area>., section_readiness is advisory: a read failure yields null, not 5xx.     D02: se, management detail status must match management list status for same exam., _CYCLE_COLS must contain cycle_name, not the API-normalized 'name' column. (+53 more)

### Community 172 - "Community 172"
Cohesion: 0.07
Nodes (66): _client(), MngSBStub, Exam E1 covers subject s1 (via coverage on t1); s2 is NOT covered., Topic list is a read: manage OR review can load it; neither is 403., No import/upsert semantics: a duplicate (subject, NULL, slug) → 409., Rule 4: ALL canonical patches are rejected while coverage is locked., is_active=false on a locked topic must be rejected (planner-impact)., Moving a child to subject s2 while retaining its s1 parent → 422 (OD-15). (+58 more)
...
Cohesion: 0.08
Nodes (60): _norm(), post_extraction_dedup_queue(), post_extraction_dedup_recruitments(), Open-queue dedup. Stage-1 narrows by an indexed key WITHOUT pulling     extract, canonical_key_invalid(), Return True when ``key`` is unsafe to use for dedup matching.      Rules (all, SupabaseStub, Tests for the filter-aware Supabase stub itself (Task 1). (+52 more)
...
Cohesion: 0.03
Nodes (66): 2013 GS1 - DB #16 (GS1-Q16) vs extraction local #23 (GS1-Q23) - score 65.9, 2013 GS1 - DB #17 (GS1-Q17) vs extraction local #19 (GS1-Q19) - score 70.4, 2013 GS1 - DB #22 (GS1-Q22) vs extraction local #17 (GS1-Q17) - score 75.7, 2013 GS1 - DB #3 (GS1-Q3) vs extraction local #- (no ref) - score 83.7, 2013 GS1 - DB #4 (GS1-Q4) vs extraction local #3 (GS1-Q3) - score 73.5, 2013 GS2 - DB #27 (GS2-Q2) vs extraction local #7 (GS2-Q7) - score 62.9, 2013 GS2 - DB #46 (GS2-Q21) vs extraction local #2 (GS2-Q2) - score 60.3, 2013 GS3 - DB #63 (GS3-Q13) vs extraction local #22 (GS3-Q22) - score 61.6 (+58 more)

### Community 177 - "Community 177"
Cohesion: 0.05
Nodes (61): _as_float(), list_question_bank(), list_queue(), list_signal_events(), list_snapshots(), ProcessQueueBody, QuestionPatch, Admin-only persona controls (PR4).  Read/light-write surface for operators to (+53 more)
...
Cohesion: 0.04
Nodes (37): _audit_recompute(), _is_service_role(), Eligibility API.  Endpoints (mirrors the reference repo):     POST /api/eligi, recompute(), RecomputeBody, _get_results_supabase_client(), _is_service_role(), Eligibility API.  Endpoints (mirrors the reference repo):     POST /api/eligi (+29 more)
...
Cohesion: 0.12
Nodes (63): build_feed(), Improvement Lab — personalized learner strategy feeds (GQR-S6).  Contract: doc, Return the ranked, evidence-annotated learner strategy feed for one subject., build_feed(), Improvement Lab — personalized learner strategy feeds (GQR-S6).  Contract: doc, Return the ranked, evidence-annotated learner strategy feed for one subject., _att(), _client() (+55 more)

### Community 182 - "Community 182"
Cohesion: 0.06
Nodes (61): anchored_blocks(), assign_sections(), best_match(), Block, classify(), clean_text(), content_hash(), content_words() (+53 more)
...
Cohesion: 0.11
Nodes (28): _client(), _commit(), _dup_label_sections(), _legacy_clean_row(), _make_csv_v2(), _make_legacy_csv(), _preflight_csv_v2(), _preflight_json_v2() (+20 more)

### Community 187 - "Community 187"
Cohesion: 0.04
Nodes (34): _min_confidence_to_queue(), _reset_low_confidence_strikes(), _CountingRegistrySB, _FakeSupabaseForLowConf, _FakeTable, Tests for the scraper round-trip optimizations (Tasks 1, 4, 5, 6).  Tasks 2/3, Contract: a second host-match within the TTL does 0 source_registry     GETs un, Records source_registry updates + low_quality_extractions inserts.      ``low_ (+26 more)

### Community 188 - "Community 188"
Cohesion: 0.06
Nodes (53): Essay Builder API — ownership + verified-only contract.  Covers: - An aspiran, Essay Builder API — ownership + verified-only contract.  Covers: - An aspiran, The stem often prints a quote with no name. The attribution is recorded on, metadata also holds parent ids and worksheet row refs. Only the single     attr, Rows that cannot exist. Refuse, rather than return a plausible empty., Rows that cannot exist. Refuse, rather than return a plausible empty., SB, tags_sb() (+45 more)
...
Cohesion: 0.05
Nodes (57): admin_run_job(), _is_failure_result(), _is_noop_result(), _parse_text_extract_interval(), Parse TEXT_EXTRACT_WORKER_INTERVAL_SECONDS from the environment.      Accepts, True when a scheduled-job result reflects "nothing happened".      Idle ticks, True when a job returned a result that represents an operational failure., run_job_now() (+49 more)
...
Cohesion: 0.05
Nodes (44): _ctx(), _fences(), Unit tests for the server-owned SubjectRuntimePolicy registry (GQR-1).  Pins t, test_english_family_emits_writing_and_pyq(), test_ga_resolves_by_governed_group_alias(), test_ga_resolves_by_slug_to_the_same_policy(), test_ga_still_fenced_when_slug_changes_but_group_is_ssc_cgl(), test_general_awareness_subject_gets_no_pyq_mode_even_with_topics() (+36 more)

### Community 194 - "Community 194"
Cohesion: 0.06
Nodes (55): _as_bool(), _as_dict(), _as_str_or_none(), normalize_legacy_source(), normalize_source_registry(), Typed runtime view of ``source_registry`` rows.  Background — the original ``S, Build a :class:`ScrapeSource` from a ``source_registry`` row.      Reads every, Legacy-only adapter for the deprecated ``scrape_sources`` table.      .. depre (+47 more)
...
Cohesion: 0.11
Nodes (56): _apply_args(), _catalog(), FakeClient, A proposal worksheet arrives with a tag and a difficulty in every row.     With, The difficulty-only sheets the regulatory exams use carry no decision at     al, Re-asserting the tag a question already carries can only 409. The     worksheet, uq_pyq_question_one_primary_tag permits one primary tag and the create     rout, Thirteen papers in one year collapse into one indistinguishable batch     under (+48 more)

### Community 197 - "Community 197"
Cohesion: 0.07
Nodes (59): _doc(), _job(), Build a document_processing_jobs row. No scope field — scope lives on     docum, Jobs whose parent document has scope='personal_library' must never be     claim, Jobs whose parent document has an unrecognised scope are excluded., !inner semantics: a job with no document_assets row is excluded., The returned row includes the embedded document_assets so run_worker_pass     c, _ExtractError from run_text_extract_job (after internal _fail) → status='failed' (+51 more)
...
Cohesion: 0.06
Nodes (36): list_exams(), fake_sb(), Q, PR1 — Exams catalogue API.  Tests cover the security contract: - 401 when una, The list endpoint must be wrapped in ``Depends(get_current_user)``., Resp, SB, _stub_overlay() (+28 more)
...
Cohesion: 0.05
Nodes (56): build_task_reasoning(), build_task_reasoning_detail(), _confidence_value(), _detail_safe_copy(), _plan_signal_copy(), _policy_signal_copy(), Deterministic per-task reasoning strings (PR3).  The reasoning attached to eac, Return ``{summary, user_signal, study_policy_signal, plan_signal, evidence}``. (+48 more)

### Community 204 - "Community 204"
Cohesion: 0.06
Nodes (57): admin_create_user(), AdminCreateBody, _app_metadata(), _as_user(), _audit_rbac(), _auth_admin(), change_user_role(), _count_super_admins() (+49 more)
...
Cohesion: 0.07
Nodes (56): Return ``{topic_id: verified_primary_pyq_count}`` for ``exam_id``.      Counts, Return ``{topic_id: verified_primary_pyq_count}`` for ``exam_id``.      Counts, Return ``{topic_id: verified_primary_pyq_count}`` for ``exam_id``.      Counts, verified_pyq_topic_counts(), _paper(), _question(), Tests for primary-only PYQ frequency semantics in verified_pyq_topic_counts., Paper verified, question reviewer_status='pending', tag verified → returns {}. (+48 more)
...
Cohesion: 0.04
Nodes (57): questions_fixture(), Load the 2026 GS-I questions fixture (92 expected, 8 skipped)., CLI: extract questions from a stored PDF and dump candidates JSON.  Reads from, Serialize ExtractionResult to a dict shaped like the fixture format., _result_to_dict(), apply_corrections(), build_envelope(), detect_marker() (+49 more)

### Community 210 - "Community 210"
Cohesion: 0.08
Nodes (48): _profile_hash(), run_eligibility_for_user(), _current_hashes(), FallbackSB, SB, _seed_existing_row(), test_fallback_attaches_age_and_education_rows_to_posts(), test_first_recompute_stores_profile_hash() (+40 more)

### Community 211 - "Community 211"
Cohesion: 0.07
Nodes (53): _client(), _code(), CountingSB, _paper(), _q(), The paper-slot contract, against the shape the GS split actually left on demo., Including ESSAY, which was a 422 for as long as it travelled as 99., The tab's own label is "Essay". A client echoing it must not 400. (+45 more)

### Community 212 - "Community 212"
Cohesion: 0.05
Nodes (51): list_exams(), Active-exam catalogue for the Exam Intelligence landing page.      ``q`` filte, Active-exam catalogue for the Exam Intelligence landing page.      ``q`` filte, CappingSB, Supabase-shaped stub with a hard ``server_cap`` per read (models     ``db-max-r, Supabase-shaped stub with a hard ``server_cap`` per read (models     ``db-max-r, filter_exams_by_query(), list_active_exams() (+43 more)
...
Cohesion: 0.09
Nodes (56): _build_app(), Tests for the PR4 admin persona controls API., Mount the admin router with a stubbed Supabase + injected user., _seed_bank(), _seed_full(), test_admin_can_access_overview(), test_admin_can_filter_snapshots_by_user(), test_admin_can_inspect_one_user() (+48 more)

### Community 218 - "Community 218"
Cohesion: 0.06
Nodes (55): _age_in_years(), _aggregate_cycle_status(), _alias_expanded_match(), _boundary_match(), _cycle_band_for_exam(), _discipline_matches(), _education_rank(), _eval_atomic() (+47 more)

### Community 219 - "Community 219"
Cohesion: 0.07
Nodes (57): assemble_mock_readiness_report(), locked_coverage_count(), _not_expired(), Mirror ``valid_until IS NULL OR valid_until > now()`` as a Python guard., Per-section authored-structure completeness, scoped to one phase if given., Selectable mock-question depth for one exam, base pool vs current pool.      `, Provenance-signal counts over the SAME eligible pool as     ``selectable_mcq_de, exam_topic_coverage counts, by status and per section.      Reports the raw br (+49 more)

### Community 220 - "Community 220"
Cohesion: 0.07
Nodes (55): Pure verdict over the structure/depth/coverage signals.      Thresholds are PA, readiness_verdict(), Tests for the mock content-readiness diagnostics (pure-read).  Mirrors test_di, The shared generated-selectable constant is MCQ only. msq/integer remain     au, test_selectable_question_types_is_mcq_only(), _chain(), _iso_future(), _iso_past() (+47 more)
...
Cohesion: 0.04
Nodes (17): _cell(), _coerce(), _Exec, _NotProxy, _Query, Tiny in-memory Supabase stub shared across persona_questions tests., Proxy returned by ``_Query.not_`` to negate the next chained filter., Evaluate a single `col.op.value` condition with PostgREST NULL rules. (+9 more)
...
Cohesion: 0.06
Nodes (53): answer(), AnswerBody, _build_state(), complete(), CompleteBody, _enqueue_eligibility_recompute(), _filter_field_hints(), _load_owned_session() (+45 more)
...
Cohesion: 0.06
Nodes (54): _create_learning_session(), create_session(), _current_projection_revision(), _english_subject_id(), error_lab(), _error_lab_rows(), error_summary(), _feedback_released() (+46 more)
...
Cohesion: 0.06
Nodes (32): LanguageResult, _estimate_cost_usd(), EWP-SP1b provider-backed semantic (LLM) evaluator adapter — SHADOW ONLY.  Auth, _SemanticIssue, _SemanticVerdict, test_bad_issue_type_raises(), test_extra_forbid_rejection(), test_span_end_before_start_raises() (+24 more)

### Community 232 - "Community 232"
Cohesion: 0.08
Nodes (53): _dates(), _ids_on(), PLAN-UI-01 — the seven-day planner board and its three mutations.  The test th, The other half of the contract, and what the UI has to communicate.      Prote, Dragging IS choosing. Without the stamp the 03:00 sweep undoes the move., The planner's evidence sentence when it exists; a template when it doesn't., PLAN-UI-02 changed this contract deliberately.      Scheduled topics used to b, Two moves of the same card land one row, at the last requested slot. (+45 more)

### Community 233 - "Community 233"
Cohesion: 0.05
Nodes (47): POST(), _client(), Production Mocks surface — service-layer + API tests with the in-memory Supabas, draft_correction_tasks must raise PlatformAttemptCorrectionForbiddenError     f, manual_log mocks can go through the rule-based correction path., imported_result mocks are also allowed through the manual path., POST /mocks/{id}/correction-tasks must return 409 for platform_attempt mocks., A mock owned by a different user returns 404, not 403. (+39 more)
...
Cohesion: 0.06
Nodes (50): _active_plan_id(), _build_nudges(), _cache_lookup(), _cache_store(), _cached_competition_context(), _cached_days_remaining(), _cached_exam_family_name(), _cached_exam_intelligence_status() (+42 more)

### Community 237 - "Community 237"
Cohesion: 0.05
Nodes (46): mission_control(), build_mission_control_async(), _CachedQuery, _engine_trace(), _focus_summary_from_sessions(), _focus_week_breakdown(), _iso_days_ago(), _metrics() (+38 more)

### Community 238 - "Community 238"
Cohesion: 0.05
Nodes (49): get_scrape_run_detail(), Return one scrape_runs row plus a per-source breakdown.      The frontend "Rec, Return one scrape_runs row plus a per-source breakdown.      The frontend "Rec, admin_jobs(), download_report(), _gen_mock_analytics(), _gen_report_card(), _gen_study_log() (+41 more)
...
Cohesion: 0.04
Nodes (23): AdminPersona(), TABS, AdminPersona(), derivePersonaSafetyWarnings(), INTERNAL_LABELS, PersonaEvidenceDrawer(), POLICY_HINT, TONE_TEXT (+15 more)
...
Cohesion: 0.05
Nodes (42): _blocked_reason(), _check_question_eligibility(), compute_content_hash(), _fetch_all_verified_tags(), _fetch_existing_projection(), _fetch_options_for_question(), _fetch_paper(), _fetch_paper_questions() (+34 more)

### Community 243 - "Community 243"
Cohesion: 0.06
Nodes (43): _argv(), _catalogue_file(), _cli_inputs(), _paper(), _q(), Unit tests for ``scripts/ssc_cgl_readiness.py``.  The script lives at the repo r, correct_option_id and pyq_options.is_correct are independent sources.     Either, A stem repeating between two shifts is normal; the same stem twice     inside on (+35 more)

### Community 244 - "Community 244"
Cohesion: 0.05
Nodes (27): _FakeSupabase, _fixture(), _Query, EWP-3 resume-contract behavioural test for the enriched session read.  Exercis, Minimal chainable stand-in for the Supabase query builder., _Res, _SingleExec, test_resume_payload_exam_future_release_still_gates() (+19 more)
...
Cohesion: 0.06
Nodes (52): Tests for ``app.scraping.verification_report_schemas``.  Pydantic gate for the, test_conflict_missing_id_is_rejected(), test_conflict_status_must_be_known_value(), test_conflict_value_confidence_out_of_range_rejected(), test_conflict_with_no_values_rejected(), test_empty_evidence_summary_is_valid(), test_empty_risk_flags_is_valid(), test_evidence_summary_backfills_key_from_mapping() (+44 more)

### Community 248 - "Community 248"
Cohesion: 0.07
Nodes (51): acknowledge_batch(), compute_valid_until(), FreshScrape, on_recruitment_critical_field_edit(), Staleness watcher + canonical-edit hook (PR plan §6).  Two entry points:  *, Fire staleness when an admin edits a critical recruitment field.      Only tri, Aggregate outcome of one watch pass., One queue/source observation passed into the watch driver. (+43 more)
...
Cohesion: 0.09
Nodes (52): heuristics_for_question(), Compatibility wrapper over the batched verified-only authority., Transition a heuristic's reviewer_status via the audited lifecycle RPC.      T, review_heuristic(), _heuristic(), _link(), GQR-Q7 — quant heuristic authority: verified-only reads + review lifecycle.  T, End-to-end readiness invariant via the governed path: author (pending) →     ve (+44 more)

### Community 251 - "Community 251"
Cohesion: 0.08
Nodes (48): Structured return shape for aggregator listing discovery.      Replaces the pr, _host(), _iter_anchors(), _looks_official(), _path_depth(), Official-source resolver for aggregator-discovered detail pages.  The scraping, WordPress-style aggregators (Free Job Alert, Sarkari Result clones)     almost, Walk the resolver chain and return the first match.      Tests can pass a cust (+40 more)
...
Cohesion: 0.08
Nodes (50): _envelope(), Unit tests for ``scripts/pyq_cms_body.py``.  The script exists because the gen, The post-reshape gate, exercised directly against rows as they'd be sent., The message has to say WHY, or the next person relaxes the check., Build a descriptive envelope. ``patch`` and ``drop`` are keyed by 1-based     q, The whole point: question_number explicit on every row, 1..N., source_kind is whitelisted and 'bulk_import' passes the migration-149 CHECK., _reshape() (+42 more)
...
Cohesion: 0.04
Nodes (51): _cohort_weight(), compute_exam_topic_scores(), Compute and write draft score snapshots for every topic in *exam_id*.      Ret, How much of the score the cohort-relative axis owns, in ``[0, 1]``.      ``1 -, How much of the score the cohort-relative axis owns, in ``[0, 1]``.      ``1 -, How much of the score the cohort-relative axis owns, in ``[0, 1]``.      ``1 -, Compute and write draft score snapshots for every topic in *exam_id*.      Ret, Compute and write draft score snapshots for every topic in *exam_id*.      Ret (+43 more)

### Community 260 - "Community 260"
Cohesion: 0.07
Nodes (50): _answer_mode(), _as_int(), attempt_detail(), _attempt_pages(), attempt_payload(), delete_attempt_page(), DescriptiveError, list_attempt_pages() (+42 more)
...
Cohesion: 0.04
Nodes (50): AIChat, AnswerWriting, AttemptShellRouter, CalculationGymShell, CommunityScreen, CoursePlayer, CurrentAffairsAttemptShell, DashShell (+42 more)

### Community 263 - "Community 263"
Cohesion: 0.04
Nodes (37): CmsRefField(), ExamIntelDocuments(), refCycle(), refPhase(), renderDocs(), { api }, client, CYCLE_FIELD (+29 more)

### Community 264 - "Community 264"
Cohesion: 0.05
Nodes (42): _client(), _count_question_answered(), _EmptyUpdateQuery, _EmptyUpdateSBStub, _RaisingQuery, _RaisingResponseSBStub, PR-fix-10a — answer persistence correctness invariant tests.  Three invariants, save_answer must raise AnswerPersistenceError when update affects 0 rows. (+34 more)
...
Cohesion: 0.07
Nodes (47): _color_for(), list_plan_by_subject(), _monday_of(), Study OS — Plan by Subject service.  Derives per-subject allocation for the cu, Return per-subject allocation for the user's planning week.      Output shape:, _resolve_subject_label(), _safe(), _week_bounds() (+39 more)

### Community 268 - "Community 268"
Cohesion: 0.07
Nodes (49): utc_now_iso(), execute_or_default(), Execute a DB operation and return default when failure is safe., classify_aggregator_link(), Return a lifecycle event type for a discovered aggregator link.      Returns `, fetch_page_html(), Return the raw HTML body. Used by the aggregator listing discoverer., Return the raw HTML body. Used by the aggregator listing discoverer. (+41 more)
...
Cohesion: 0.06
Nodes (22): _hash(), _norm(), Tests for the PYQ paper workspace backend endpoints (PR4).  Tests:   - GET /p, metadata field is in _QUESTION_FIELDS so the caller controls it fully., Mirror of normalize_for_content_hash in idempotency.py., The JS normalize function in PyqPaperWorkspace.jsx must match this., TestNormalizeParity, TestPatchPreservesDupDismissals (+14 more)

### Community 271 - "Community 271"
Cohesion: 0.07
Nodes (31): _attempt(), DB, Answer structures — schema, generator and the learner side.  The contract thes, A ModelCall that plays back a list of replies (or exceptions)., _reply(), Scripted, _structure(), Table (+23 more)

### Community 272 - "Community 272"
Cohesion: 0.08
Nodes (43): _cases(), _full_scores(), _ids(), Descriptive answer-writing practice — catalogue, questions, attempts.  The cor, Two real papers, one thematic paper, one retired bucket., ~87% of the corpus. Absent marks is the common case, not an error., `True` is `1` in Python. It is not a rubric judgement., _sb() (+35 more)
...
Cohesion: 0.09
Nodes (32): _adapter(), _baseline(), _Block, _canonical_for(), _cfg(), _claim(), _Exec, _FakeClient (+24 more)

### Community 275 - "Community 275"
Cohesion: 0.04
Nodes (46): _FakeSDKClient, _live(), _Messages, _rate_limit_error(), Replays a scripted sequence: an exception is raised, anything else returned., Replays a scripted sequence: an exception is raised, anything else returned., A real anthropic.RateLimitError, so the transient classifier is tested     agai, A real anthropic.RateLimitError, so the transient classifier is tested     agai (+38 more)
...
Cohesion: 0.04
Nodes (49): _chunks(), get_exam_csat_composition(), get_exam_pyq_summary(), get_exam_reachability(), get_pyq_paper_composition(), get_trap_drill(), list_exam_pyqs(), _paginate_all() (+41 more)

### Community 280 - "Community 280"
Cohesion: 0.07
Nodes (48): _load_locked_coverage(), load_scoped_coverage(), Locked ``exam_topic_coverage`` rows enriched with topic/subject names.      On, Locked ``exam_topic_coverage`` rows enriched with topic/subject names.      On, Graceful view of :func:`_load_locked_coverage_checked` — rows only., Graceful view of :func:`_load_locked_coverage_checked` — rows only., Locked coverage filtered to what THIS user actually studies.      The learner-, Locked coverage filtered to what THIS user actually studies.      The learner- (+40 more)

### Community 281 - "Community 281"
Cohesion: 0.06
Nodes (48): get_topics(), Locked-only topic intelligence — drives the Subjects topic tree., Locked-only topic intelligence — drives the Subjects topic tree., Locked-only topic intelligence — drives the Subjects topic tree., Locked-only topic intelligence — drives the Subjects topic tree., _paginate(), Resolve one exam by slug. ``None`` when no such row exists.      Raises :class, Resolve one exam by slug. ``None`` when no such row exists.      Raises :class (+40 more)

### Community 282 - "Community 282"
Cohesion: 0.08
Nodes (47): get_plan_prefs(), Return the user's Study OS plan preferences (defaults if none saved)., Return the user's Study OS plan preferences (defaults if none saved)., Return the user's Study OS plan preferences (defaults if none saved)., Return the user's Study OS plan preferences (defaults if none saved)., get_plan_preferences(), _normalise(), Merge a stored row over the defaults, dropping unknown keys. (+39 more)
...
Cohesion: 0.06
Nodes (44): burstConfetti(), DailyPlan(), EligibilityDemo(), Exams(), FAQ(), guestSafe(), Hero(), HowItHelps() (+36 more)
...
Cohesion: 0.08
Nodes (43): list_sources(), source_registry rows for the evidence source picker, each with the D05 authority, source_registry rows for the evidence source picker, each with the D05 authority, _identity(), PageWalk, paginate(), One range-paginated read, for every PostgREST bulk read in the backend.  WHY T, The result of one paginated read.      ``complete`` is False when a page read (+35 more)
...
Cohesion: 0.06
Nodes (48): test_real_feed_is_hindi_and_carries_no_pubdate(), test_seeded_feed_format_matches_the_committed_fixture(), fetch_sitemap(), fetch_sitemap_recursive(), parse_sitemap(), Network fetch boundary for the scraper.  Phase 4 of the scraper audit pulled t, Parse a sitemap.xml (urlset) or sitemapindex into entries.      For ``sitemapi, Fetch a sitemap, recursing into child sitemaps up to ``max_depth``.      Retur (+40 more)
...
Cohesion: 0.06
Nodes (46): _existing_row(), _mastery_band(), _next_revision(), _num(), Phase 6 — deterministic user-topic mastery + error-pattern derivation.  Reads, Recompute ``user_topic_mastery`` + ``user_topic_error_patterns``.      Aggrega, Find one row matching every key in ``match`` (``None`` matched as IS NULL)., recompute_topic_mastery() (+38 more)

### Community 293 - "Community 293"
Cohesion: 0.06
Nodes (47): _chunked_in(), list_scrape_queue(), List scrape queue items with server-side filter/search/sort.      The previous, List scrape queue items with server-side filter/search/sort.      The previous, Derive the lightweight summary for the queue table view.      Stays server-sid, Derive the lightweight summary for the queue table view.      Stays server-sid, _summarize_extracted(), classify_item() (+39 more)
...
Cohesion: 0.07
Nodes (32): aggregate_session_outcome(), Deterministic session-level outcome over required units (§9.1a).      Returns, Session status by the locked priority order (§4.3b), first match wins.      Th, roll_up_session_status(), Unit tests for the EWP-2 deterministic engine, content hash, and session rollup., test_outcome_deterministic_only(), test_outcome_fully_evaluated(), test_outcome_none_while_nonterminal() (+24 more)

### Community 296 - "Community 296"
Cohesion: 0.06
Nodes (47): AnswerModeBody, AttemptCreate, AttemptPatch, AttemptSubmit, compare_question_attempts(), CoverageBody, create_attempt(), create_page_upload() (+39 more)
...
Cohesion: 0.06
Nodes (47): BlockCreate, BlockPatch, _chunks(), _coord(), create_block(), delete_block(), get_block(), _is_uuid() (+39 more)

### Community 300 - "Community 300"
Cohesion: 0.11
Nodes (45): _assert_causal(), _blocked_pending_db(), _build_app(), _causal_base(), _client(), _detail(), FailingSBStub, _full_seed() (+37 more)
...
Cohesion: 0.07
Nodes (38): _competition(), _days_ago(), _doc_pages_strict(), _documents(), load_doc_extraction_counts(), load_first_failing_doc_strict(), _now_iso(), Exam Workspace readiness compute (PR2).  compute_exam_workspace_readiness(sb, (+30 more)

### Community 313 - "Community 313"
Cohesion: 0.07
Nodes (31): _attempt(), Db, _question(), P5 — weekly analytics, computed from the attempts that already exist.  No new, ~87% of the corpus has no marks, so no target — an average "vs target"     over, Two equally weak dimensions are two findings, not one picked by     dictionary, It is Tuesday for everyone at some point. A streak that resets every     Monday, Two answers is a mood; three is the smallest number a direction can be     read (+23 more)

### Community 314 - "Community 314"
Cohesion: 0.07
Nodes (43): _ids(), _labels(), _paper(), _q(), The catalogue against the shape the demo database actually holds.  WHY THESE E, Every theme in the nested paper → section → theme tree., The 140. `trust_status='pending'` is the split script's normal output,     not, The regression as seen: twelve year chips under "Sat papers, in question     or (+35 more)

### Community 315 - "Community 315"
Cohesion: 0.12
Nodes (35): assertNotProdSupabase(), required(), assertNotProdSupabase(), E2EEnv, readEnv(), required(), globalSetup(), ACCEPTED_OUTCOMES (+27 more)

### Community 316 - "Community 316"
Cohesion: 0.05
Nodes (26): DateField(), formatDDMMYYYY(), EligibilityTrackerPage(), FILTER_CHIPS, STATUS_TO_BUCKET, STATUSES, EligibilityTrackerPage(), formatDDMMYYYY() (+18 more)
...
Cohesion: 0.1
Nodes (40): _db(), _DocInsertRaises, _ok(), GQR-G2 — current-affairs ingestion primitive (whole-body adapters).  ``ingest_, SBStub whose document-insert raises a given exception (dedup select still works), SBStub whose document-insert raises a given exception (dedup select still works), _source(), test_dedup_same_content_hash() (+32 more)

### Community 323 - "Community 323"
Cohesion: 0.08
Nodes (45): _all_papers_practiceable(), _build_app(), Tests for the learner PYQ summary endpoint + /pyqs phase/subject enrichment (PR, Make every seeded bank row actively projected.      `papers[]` now lists only, An active, snapshot-ready projected bank row on a PENDING paper must not     in, An active projection whose frozen snapshot lacks options/correct answer     mus, An active, snapshot-ready projected bank row on a PENDING paper must not     in, Verified questions with no primary-subject mapping fall into an explicit     'U (+37 more)
...
Cohesion: 0.04
Nodes (35): renderEmbedded(), renderPr3(), renderWorkspace(), { api }, LINKS, OPTIONS, PAPER, PAPER_B (+27 more)
...
Cohesion: 0.13
Nodes (16): commit_accept(), preview_accept(), Dry-run: classify proposals without writing anything., Dry-run: classify proposals without writing anything., Write accepted proposals to syllabus_topic_mentions with reviewer_status=pending, Write accepted proposals to syllabus_topic_mentions with reviewer_status=pending, _make_proposal(), Rejected mention should not block re-proposal. (+8 more)
...
Cohesion: 0.09
Nodes (32): Capped, _CappedQuery, _CappedSB, _grep(), _ns(), Every migrated bulk read, driven at a server cap it does not know about.  `tes, The fail-closed half of the contract survived the migration., A partial read is more dangerous than a failed one, so no count means     no ro (+24 more)
...
Cohesion: 0.06
Nodes (40): _apply_lineage(), _check_span(), compute_source_comparison(), _is_source_dependent(), MockLanguageEvaluator, _normalize_for_compare(), Stage-2 language evaluator (architecture §5.1, §5.3) — DETERMINISTIC MOCK.  Pu, Locate ``substring`` in ``text`` and return its (start, end) UTF-16 offsets. (+32 more)

### Community 336 - "Community 336"
Cohesion: 0.07
Nodes (44): _job_plan_regen(), _active_plan(), _calibration_blocks_regen(), Refresh every active plan that hasn't been regenerated today.      Intended fo, Safety-net onboarding-calibration guard for scheduled/signal regen.      The c, Regenerate the user's plan in response to a runtime signal.      No-ops (retur, regenerate_on_signal(), regenerate_stale_plans() (+36 more)
...
Cohesion: 0.07
Nodes (15): Ordinal detection and stripping for question text.  Ported from tools/extracti, Return text with the leading ordinal and its separator removed., strip_ordinal(), build_question(), Build an ExtractedQuestion from an ordinal and its stem lines., Unit tests for ordinal.py — detect_ordinal and strip_ordinal., TestStripOrdinal, detect_ordinal() (+7 more)
...
Cohesion: 0.08
Nodes (19): _build_app(), _make_actor(), _make_options(), Pytest suite for PR2 — Admin Question Bank: Workflow & RBAC.  Covers:   - Sta, draft → in_review → verified → published via sequential transitions., Author and reviewer are the same person → ConflictError (→ 409)., Verify that permission guards return 403 to unauthorised callers., Dedup is mounted at /questions/{id}/dedup-check, not /{id}/dedup-check. (+11 more)

### Community 342 - "Community 342"
Cohesion: 0.07
Nodes (41): _get_results_supabase_client(), Prefer async Supabase client; fall back to sync client for compatibility., results_me(), results_me_all(), format_error_context(), log_warning_with_context(), Emit a consistent warning log for recoverable pipeline failures., Build a compact operation/context string for logs. (+33 more)
...
Cohesion: 0.05
Nodes (43): 2024 GS2 local Q10 — best 71.4 (closest DOCX Q11), 2024 GS2 local Q11 — best 74.1 (closest DOCX Q6), 2024 GS2 local Q12 — best 56.4 (closest DOCX Q17), 2024 GS2 local Q13 — best 65.7 (closest DOCX Q7), 2024 GS2 local Q14 — best 59.8 (closest DOCX Q16), 2024 GS2 local Q15 — best 59.9 (closest DOCX Q18), 2024 GS2 local Q16 — best 62.7 (closest DOCX Q8), 2024 GS2 local Q17 — best 58.7 (closest DOCX Q20) (+35 more)
...
Cohesion: 0.11
Nodes (43): _client(), Endpoint tests for the Subject Practice Hub launch orchestrator.  Focus: serve, The base seed plus two optional papers, one chosen and one not., The gate must refuse Anthropology for a PSIR aspirant.      Every other surfac, No elective row = compulsory-only, so BOTH optionals are out of scope., Scoping must not cost a compulsory subject its launch., _seed(), _seed_with_electives() (+35 more)

### Community 352 - "Community 352"
Cohesion: 0.09
Nodes (43): _as_date(), evaluate_cycle_eligibility(), Cutoff-aware, cycle-scoped verdict for one (cycle, stream) rule set.      Kept, The official date age is measured on for a cycle-scoped age rule.      * ``fix, _resolve_cutoff_date(), _aggregate_cycle_status(), _cycle_band_for_exam(), evaluate_cycle_eligibility() (+35 more)
...
Cohesion: 0.12
Nodes (27): loaded_repo(), MemoryRepo, Loader contract for ``scripts/load_gs_inserts.py``.  Runs the real load path a, records(), review_csv(), review_row(), run(), stage() (+19 more)
...
Cohesion: 0.1
Nodes (28): amain(), apply_tags(), as_meta(), build_records(), gs_paper_value(), idempotency_key(), load_paper(), load_staging() (+20 more)

### Community 361 - "Community 361"
Cohesion: 0.1
Nodes (40): _client(), _force_engine(), PR3 — OCR job wiring tests.  Covers the OCR control surface (schema + state ma, A `skipped` (terminal) job does NOT block a fresh `retry` request.      The pa, Authenticated non-owner sees zero rows — the API filters by     user_id, equiva, Settings is constructed once and cached via lru_cache; flip the     cached inst, `Settings.LIBRARY_OCR_ENGINE` is a class-level default evaluated     at module, reset_settings_cache() (+32 more)
...
Cohesion: 0.08
Nodes (41): _adbg(), _auth_debug_enabled(), _cache_get(), _cache_set(), _flight_lock_for(), get_current_user(), get_current_user_required_anonymous(), get_current_user_required_permanent() (+33 more)
...
Cohesion: 0.06
Nodes (23): _attempt(), Db, _q(), P4 — coverage: what has been written, and what is still waiting.  The number a, Coverage must not go up by opening questions and closing the tab., 0 would read as "everything they wrote scored zero"., An aspirant deciding what to write next needs the whole corpus, not the     wel, and 340 more" is information; a silently shortened list is not. (+15 more)

### Community 369 - "Community 369"
Cohesion: 0.07
Nodes (27): _new(), _overrides_csv(), _qid(), Assignment and abort contract for scripts/split_gs_buckets.py.  The GS year-bu, Whole-paper partial_ratio is generous. A question whose wording clears the, Twelve of the thirteen years have no essay page at all., A typo in an override is a human decision that did not happen., A stale sheet from a previous run is worse than an empty one. (+19 more)
...
Cohesion: 0.14
Nodes (11): compute_content_hash(), Return the lowercase SHA-256 hex digest of ``answer_text`` (UTF-8)., TestContentHash, _options(), _question(), The joined hash input must not contain a NUL byte.          The SQL mirror (pr, Empty and NULL language must both hash identically to 'en'., Whitespace-only language must normalize to 'en', not to empty string. (+3 more)

### Community 376 - "Community 376"
Cohesion: 0.1
Nodes (21): Call ``project_pyq_question_to_mock_bank`` for eligible questions.      When `, Call ``project_pyq_question_to_mock_bank`` for eligible questions.      When `, sync_paper_projection(), _author_actor(), _make_app(), _publisher_actor(), Tests for PYQ → Mock Bank projection service (migration 183).  Covers:   - co, The RBI 2024 Q95 symptom: a backslash the ::bytea cast cannot parse. (+13 more)

### Community 377 - "Community 377"
Cohesion: 0.09
Nodes (40): _client(), Subjects (progress) service + API tests., Base seed + a launchable English writing prompt (subject s2) and an     activel, `_seed_with_practice` + a verified, actively-projected row on t2 that has     N, Base seed + a servable published+verified GLOBAL weekly current-affairs bundle., _seed(), _seed_practice_unready_pyq(), _seed_with_ca_bundle() (+32 more)

### Community 378 - "Community 378"
Cohesion: 0.1
Nodes (37): replay_from_persisted_baseline(), _weighted_delta(), derive_error_pattern_signals(), derive_mastery_deltas(), _difficulty_weight(), expected_accuracy_for_mastery(), _pyq_recency_weight(), _source_weight() (+29 more)

### Community 379 - "Community 379"
Cohesion: 0.14
Nodes (40): _base_db(), _eval(), _evi(), _pyq(), Unit tests for the D05 evidence-policy evaluator (document_policy)., D05 §6: a closed/completed/cancelled cycle is not an activation target., Checkpost P1: a classified phase with NO seeded blocking policy must NOT be vacu, Evidence-role-match predicate: a doc registered under a different role must not (+32 more)

### Community 380 - "Community 380"
Cohesion: 0.07
Nodes (37): _execute_with_retry(), ReviewBody, _surface_transient_as_503(), F(), _FlakyOnce, R, Stand-in for postgrest's APIError on a 42703 (column does not exist).     Carri, Regression: KeyError must NEVER be transient — it would mask real     dict-acce (+29 more)

### Community 381 - "Community 381"
Cohesion: 0.07
Nodes (37): console_exams(), Console work-queue list: base-filtered candidate set, classified into one     p, aggregate(), _batch_paged(), build_classified_rows(), build_rows(), _chunked(), classify_exam() (+29 more)

### Community 382 - "Community 382"
Cohesion: 0.05
Nodes (29): _links_table_body(), Static contract for migration 291's merged content-card authority.  Live apply, CASCADE would silently drop a dependant this migration did not account     for., Mirrors migration 226: blockers are COLLECTED (no short-circuit) and a     bloc, CAS is a HARD error, never a blocker — 226's rule., writing_prompt_targets is prompt-specific and content_cards has no     applicab, The CREATE TABLE block only — no `--` prose, no `comment on` statements., The whole argument for this shape: PostgreSQL cannot foreign-key one     column (+21 more)

### Community 383 - "Community 383"
Cohesion: 0.05
Nodes (8): Migration 249 contract (GQR-G4a) — text-assertion style. Behavioural validation, Migration 207 contract: atomic EWP-2 runtime RPCs.  Text-assertion style (matc, Migration 249 contract (GQR-G4a) — text-assertion style. Behavioural validation, test_both_rpcs_audit(), test_security_definer_search_path(), Migration 207 contract: atomic EWP-2 runtime RPCs.  Text-assertion style (matc, test_in_transaction_rollup_on_write_paths(), test_service_role_only_grants()
...
Cohesion: 0.06
Nodes (40): _apply_plan_envelope(), _calibration_gate_response(), generate_study_plan(), get_plan_draft(), post_plan_apply(), post_plan_draft(), _raise_for_plan_failure(), Backend half of the onboarding-calibration gate (must not be UI-only).      Re (+32 more)

### Community 390 - "Community 390"
Cohesion: 0.14
Nodes (13): Writer. Translates ExtractionResult into pyq_questions rows.  ALL writes via a, _make_options(), _make_question(), _make_result(), _make_sb(), TestBuildRowPayload, _build_row_payload(), _create_pyq_question() (+5 more)

### Community 391 - "Community 391"
Cohesion: 0.09
Nodes (39): derive_rates(), ratio_denominator(), Return ``(denominator_value, denominator_label, source_row)``.      ``denomina, Return ``(selection_rate, candidates_per_vacancy)``.      ``selection_rate`` =, Tests for J3 PR2 applied-vs-appeared ratio helpers (candidate_counts.py) and th, Regression: OD-5 forbids this PR from touching     competition_pressure_score i, _series_db(), test_competition_context_pressure_reason_reflects_denominator() (+31 more)

### Community 392 - "Community 392"
Cohesion: 0.06
Nodes (37): Resolve the user's target exam to a full ``exams`` row (or None)., Resolve the user's target exam to a full ``exams`` row (or None)., Resolve the user's target exam to a full ``exams`` row (or None)., Resolve the user's target exam to a full ``exams`` row (or None)., :func:`_resolve_target_exam` for read surfaces that degrade to "no exam"., :func:`_resolve_target_exam` for read surfaces that degrade to "no exam"., :func:`_resolve_target_exam` for read surfaces that degrade to "no exam"., _resolve_target_exam() (+29 more)

### Community 393 - "Community 393"
Cohesion: 0.06
Nodes (25): VerifyOrganizationRequest, _bare_rec(), _FanoutSB, Q, R, Publish must enqueue one recompute row per onboarded user; without this     the, Stub for verify_organization: tracks org update and audit insert., Empty fan-out must succeed (no users to enqueue) and the publish should     sti (+17 more)

### Community 394 - "Community 394"
Cohesion: 0.07
Nodes (25): AssertionError, test_batched_empty_input_no_reads(), test_batched_empty_input_performs_no_reads(), FakeDb, Papers and questions as rows, mutated exactly as the live path does., Papers and questions as rows, mutated exactly as the live path does., test_unsubmitted_422(), Profile completion fan-out must parallelise the optional reads.  `profile_comp (+17 more)

### Community 395 - "Community 395"
Cohesion: 0.13
Nodes (26): _client(), _learner(), _learner_seed(), _patch(), _Q, Router tests for the answer-structure review queue and the learner routes.  Th, _row(), Sb (+18 more)
...
Cohesion: 0.08
Nodes (24): _FakeSupabase, _patch(), EWP-4 Error Lab endpoint-shaping tests.  The owner-scoping, feedback-release g, Fake service-role client whose only surface the endpoints use is rpc()., What ewp_error_lab returns: current-state, effective-decision-resolved     issu, _Res, _rows(), _RpcCall (+16 more)

### Community 405 - "Community 405"
Cohesion: 0.12
Nodes (37): classify_persona(), Pure function: signals -> persona dict. Safe with empty or partial input., PR2: tiny-question answers feed into the persona classifier + study policy., _signals(), test_budget_sensitive_still_only_from_explicit_flag_with_answers(), test_mock_avoid_answer_sets_mock_avoider(), test_mock_skip_analysis_sets_high_mock_low_review(), test_phone_distraction_raises_execution_risk_to_medium() (+29 more)

### Community 406 - "Community 406"
Cohesion: 0.13
Nodes (30): _db(), _Exec, _feed(), _first_item_feed(), _hindu_source(), _Net, _pib_net(), _pib_source() (+22 more)

### Community 407 - "Community 407"
Cohesion: 0.09
Nodes (38): test_auto_enqueue_creates_skipped_job_with_engine_none(), test_rerun_text_extract_does_not_duplicate_active_job(), _app(), _patch_parser(), Concurrent enqueue may race past the read-check and only one     INSERT wins (p, _claim_job must accept status='failed' so the retry worker can claim     transi, Simulates a PR1-era upload (doc exists, no job row). Calling     process-text s, Verify that run_text_extract_job calls finalize_document_extraction with     th (+30 more)
...
Cohesion: 0.07
Nodes (18): _CountingSupabase, _CountingTable, Reference-data TTL caches.  Three admin-mutable but read-heavy tables (``exams, test_invalidate_eligibility_rules_cache_forces_refetch(), test_load_rules_by_exam_caches_within_ttl(), test_load_rules_by_exam_distinct_exam_sets_share_no_cache(), _CountingSupabase, _CountingTable (+10 more)

### Community 410 - "Community 410"
Cohesion: 0.07
Nodes (37): calibration_required_payload(), CalibrationUnavailable, Shared onboarding-calibration gate logic.  Single source of truth for the cali, Calibration state could not be determined due to a read failure.      Callers, Stable shape returned by plan entrypoints when calibration is required., Run a read; return ``(value, ok)``. ``ok`` is False on any exception., _read(), report_confidence_from_attempts() (+29 more)
...
Cohesion: 0.08
Nodes (35): parse_pdf_pages(), Like ``parse_pdf_bytes`` but returns one stripped string per page.      Empty, _build_page_rows(), _claim_job(), _count_pdf_pages(), _download_object(), enqueue_text_extract_job(), _extract_with_deadline() (+27 more)

### Community 413 - "Community 413"
Cohesion: 0.1
Nodes (37): _admin_storage_path(), _bucket(), create_document_upload_url(), _extension(), _max_bytes(), _normalise_signed(), _resolve_processing_policy(), _safe_filename_fragment() (+29 more)
...
Cohesion: 0.12
Nodes (37): _build_phase_bands(), _build_risk_flags(), _build_series(), _build_subjects(), _pct(), Study OS — Exam Cycle Timeline service.  Composes the data behind the Study Pl, Weekly cumulative planned vs actual percentages.      A weekly resolution keep, _task_minutes() (+29 more)

### Community 416 - "Community 416"
Cohesion: 0.09
Nodes (26): _FakeSB, _FakeTable, _make_sb(), _R, Tests: RejectRequest.reason is required (8–500 chars).  Written BEFORE the tig, test_reject_endpoint_succeeds_with_valid_reason(), test_reject_request_accepts_exactly_500_chars(), test_reject_request_accepts_exactly_8_chars() (+18 more)

### Community 417 - "Community 417"
Cohesion: 0.07
Nodes (20): _FingerprintRaceQuery, _InsertConflictQuery, _RaceQuery, Wraps the stub's update-path to simulate a reviewer moving the row     from dra, Wraps the stub's update-path to simulate a reviewer moving the row     from dra, Simulates a concurrent derivation run that already won the INSERT     race for, Simulates a concurrent derivation run that already won the INSERT     race for, A competing derivation run (computed from a DIFFERENT locked     snapshot, henc (+12 more)
...
Cohesion: 0.09
Nodes (37): eligibility_summary(), Exam-level eligibility summary (PR-D1).  Single user-facing endpoint:    ``G, Four-bucket exam eligibility summary for the current user.      See ``app.exam, _chunks(), invalidate_eligibility_rules_cache(), _load_cycle_rules_by_stream(), _load_rules_by_exam(), _load_streams_by_exam() (+29 more)
...
Cohesion: 0.07
Nodes (36): Admin CRUD for ``exam_eligibility_rules`` (PR-D2).  Endpoint group (all requir, RuleCreate, RuleReview, RuleUpdate, _audit(), create_rule(), delete_rule(), list_exams_with_rule_counts() (+28 more)
...
Cohesion: 0.08
Nodes (35): Current-affairs bundles (GQR-G5a) — server-owned selection + eligibility.  A b, Resolve the eligible weekly bundle, freeze its still-eligible questions + the §1, start_weekly_current_affairs_attempt(), bundle_question_ids(), eligible_bundle_question_ids(), load_question_provenance(), _now(), _provenance_complete_ids() (+27 more)

### Community 432 - "Community 432"
Cohesion: 0.11
Nodes (22): _Exec, FakeSupabase, Unit tests for the EWP-2B mastery-outbox drain (run_outbox_pass).  Uses the sa, _terminal(), test_done_emits_per_issue_projection_rows(), test_done_writes_evidence_and_shadow(), test_failure_path(), test_idle_when_no_claim() (+14 more)

### Community 433 - "Community 433"
Cohesion: 0.07
Nodes (36): draft_sources_from_queue_item(), Auto-create draft ``source_registry`` rows for every official-URL     host on t, Auto-create draft ``source_registry`` rows for every official-URL     host on t, _draft_payload(), _existing_by_host(), _existing_by_official_url(), extract_candidate_hosts(), _host_of() (+28 more)
...
Cohesion: 0.09
Nodes (21): mocks_mastery_preview(), Read-only mastery/correction preview for a platform mock.  Zero writes.      R, _answered_question_count(), get_mastery_write_flag(), MasteryWriter, Recovery entry point: re-derive and (idempotently) draft corrections         fo, Drop deltas backed by fewer than MIN_ANSWERED_QUESTIONS_PER_TOPIC answers., Recovery entry point: re-derive and (idempotently) draft corrections         fo (+13 more)

### Community 439 - "Community 439"
Cohesion: 0.11
Nodes (22): LanguageIssueOut, LanguageResult, One structured language finding (§5.3), persisted to writing_issue_events., Structured Stage-2 result (persisted as writing_evaluations.language_result)., build_semantic_evaluator(), _CircuitBreaker, _is_timeout(), _is_transient() (+14 more)
...
Cohesion: 0.09
Nodes (35): _coerce_number(), competition_series(), cutoff_direction(), cutoff_series(), Return verified competition metrics, newest cycle last.      A (cycle, phase), Flatten cutoff data across cycles into per-category points.      Prefers the l, Derive a qualitative direction ("rising"/"flat"/"falling") at READ TIME     ONL, Build vacancy-by-year series.      Returns::          {           "total": (+27 more)

### Community 443 - "Community 443"
Cohesion: 0.11
Nodes (32): apply_is_correct(), collect(), diagnose(), emit_sql(), expected_keys(), fetch_options(), fetch_questions(), gather() (+24 more)
...
Cohesion: 0.09
Nodes (22): _check(), Per-exam action console read (Wave 4.6I-BE) — read-only.  Backs GET /api/admin, _severity_for(), _build_action_queue(), build_console_detail(), _check(), _competition(), _family_name() (+14 more)
...
Cohesion: 0.11
Nodes (34): check_gateway_promotion(), PR2 stub gateway promotion gate.      Behaviour:      * Tier A — blocks if n, check_gateway_promotion(), PR2 stub gateway promotion gate.      Behaviour:      * Tier A — blocks if n, Tests for the bulk gate evaluation surface (PR6 dry-run logic).  The actual HT, test_blocker_shape_carries_reason_code_and_level(), test_no_blocker_when_all_gates_pass(), Tests for the PR2 gateway promotion gate stub.  Plan §3 acceptance:  * Tier (+26 more)
...
Cohesion: 0.07
Nodes (35): _learner_row(), Quant heuristic authority — verified-only reads + review wrapper (GQR-Q7).  Co, Run a read either fail-soft (default, mock-review consumer) or strict (the, Defense-in-depth allowlist for the batched learner authority., _read(), _safe(), _canonical_scope_is_quant(), _display_key() (+27 more)
...
Cohesion: 0.06
Nodes (10): IconCalendarFlip(), IconChat(), IconScan(), MiniBook(), MiniBulb(), MiniPaper(), SceneGroup(), SceneMentor() (+2 more)
...
Cohesion: 0.09
Nodes (12): _build_action_queue(), _deep_link(), _first_evidence_by_kinds(), Return first evidence_ref whose kind is in the given set, or None., Return (cta_label, cta_route) per the locked I8-B deep-link contract (design §7., Build the ordered action queue using kind-specific evidence selection., Tests for console_detail CTA deep-link shapes and evidence-kind selection (I8-B), DB error in _resolve_pyq_paper_id must not leak a tag/option row_id as a questio (+4 more)

### Community 462 - "Community 462"
Cohesion: 0.09
Nodes (30): build_snapshot_payload(), compute_persona_snapshot(), get_latest_persona_snapshot(), _hash_signals(), _now_iso(), Persona snapshot persistence and lookup.  Snapshots are immutable rows in `pub, End-to-end: collect signals, classify, derive policy, save row.      Always wr, Pure helper: build the snapshot row payload from a signals dict. (+22 more)
...
Cohesion: 0.11
Nodes (35): live_audit_compare(), _live_row(), _make_match_decisions(), _make_real_inputs(), _make_sr_pass_data(), _run_real(), _shadow_row(), test_lac_delta_mismatch_causes_fail() (+27 more)
...
Cohesion: 0.1
Nodes (32): _band_of(), _chunks(), _is_subject_paper(), _paginate_all(), paper_composition(), _phase_names(), _primary_tag_topics(), Per-paper reachability bands, and per-paper topic composition.  Two reads, del (+24 more)

### Community 479 - "Community 479"
Cohesion: 0.13
Nodes (33): _build_reference_corrections(), _check_attempt_derivation(), _check_invariants(), compute_telemetry_quality(), correction_parity(), _emit_result(), _fetch_by_attempt_ids(), _fetch_paginated() (+25 more)

### Community 480 - "Community 480"
Cohesion: 0.12
Nodes (27): commit_import(), dry_run(), _now_iso(), parse_file(), Parse CSV or JSON file bytes into raw row dicts., Parse file and return per-row preview without writing anything.      Returns:, Commit a previously dry-run import. Idempotent: duplicate/invalid rows are skipp, _actor() (+19 more)

### Community 481 - "Community 481"
Cohesion: 0.17
Nodes (33): _cms_client(), _payload(), CMS create / curate contract for PYQ question explanations (migration 230).  M, reviewed_by/reviewed_at are review-queue-owned and not in the create     allowl, ``formula_used`` is jsonb NOT NULL DEFAULT '[]'. Postgres would accept a     ba, ``option_rationales`` is jsonb NOT NULL DEFAULT '{}' — an object., Mirrors the same-question integrity trigger so the operator gets a named     42, ``unique (question_id, explanation_source_type)`` is deliberate: one     explan (+25 more)

### Community 482 - "Community 482"
Cohesion: 0.09
Nodes (18): _corpus(), _drafts(), PagingSB, _Q, _R, ``compute_exam_topic_scores`` must be idempotent under repeat calls.  SNAP-DUP, One verified paper, one verified question per topic, one primary tag     each —, The live failure: identical inputs, repeated calls, duplicate drafts.     The c (+10 more)

### Community 483 - "Community 483"
Cohesion: 0.14
Nodes (32): _phase_row(), A cycle phase inherits its template's evidence — for READS only.  THE PROBLEM, The template phase a cycle phase should inherit evidence from, or None.      R, resolve_template_phase_id(), _corpus_on(), _db(), _mention(), _phase() (+24 more)

### Community 484 - "Community 484"
Cohesion: 0.1
Nodes (34): _bucket(), 2024's GS4 has no raw DOCX, so 19 of its 79 rows are `unverifiable`. An     abs, 2013 agreed on 1 of 93 and 2014 on 5 of 78. Both split anyway, stamped     `tag, The bar is `< 50%`, so a year that splits evenly is verified. Stated     becaus, One rule for all years, whichever signal the year has. A verdict year     that, Only `tag` becomes `tag_only`. An override is still a human decision and     an, 2015 GS4, 2024 and 2025 have no OCR. One signal is not enough to give a     pos, The row says how it was decided rather than implying the signals     agreed. (+26 more)
...
Cohesion: 0.07
Nodes (29): test_page_date_is_never_invented(), test_strip_html_decodes_named_and_numeric_entities(), test_strip_html_still_drops_scripts_styles_and_tags(), fetch(), fetch_api(), _fetch_html(), fetch_rss(), fetch_sitemap() (+21 more)

### Community 488 - "Community 488"
Cohesion: 0.1
Nodes (33): allocate_sample(), best_fit(), build_report(), catalogue_fit(), _cell(), corpus_duplicate_stems(), csv_rows(), has_non_ascii() (+25 more)

### Community 489 - "Community 489"
Cohesion: 0.07
Nodes (33): 10. Feedback, retry, and mastery bypass, 11. Bundles, 12. Admin placement, 1. Operating model, 2. Source authority (do NOT reuse `source_registry`), 3. Evidence and event model (separate factual vs editorial lifecycles), 4.1 RSS sources are split per item (CA-RSS-01, migration 294), 4.2 Per-source identity (+25 more)
...
Cohesion: 0.09
Nodes (31): _attempt_question(), PYQ v2 PR-5/6 — projected-PYQ render fidelity in the mock attempt path.  Migra, Render fidelity must come from the frozen snapshot, not the live bank —     edi, Printed-order fidelity: when the projected display_order disagrees with     opt, SBStub whose mock_question_stimuli read raises, to exercise fail-closed., A projected PYQ must NOT start (and freeze stimuli:[]) if the passage read, An authored-only template (no PYQ questions) must start normally even     thoug, One template whose first question is a projected PYQ with a section, a     shar (+23 more)

### Community 495 - "Community 495"
Cohesion: 0.15
Nodes (33): _app(), _patch_parser(), PR2 — Document Text Extraction tests.  Builds on the in-memory stub style from, Concurrent enqueue may race past the read-check and only one     INSERT wins (p, Simulates a PR1-era upload (doc exists, no job row). Calling     process-text s, Verify that run_text_extract_job calls finalize_document_extraction with     th, Regression: if the document is archived *between* extraction starting and     f, Regression for F3 (gate): when the document is archived *after* all     early-g (+25 more)
...
Cohesion: 0.08
Nodes (19): invalidate_bank_cache(), Drop the in-process question-bank cache.      Call this from admin write paths, invalidate_bank_cache(), list_active_questions(), Drop the in-process question-bank cache.      Call this from admin write paths, _Counter, Cache hit/miss tests for the persona-question-bank TTL cache., Minimal Supabase stub that counts executes against the bank table. (+11 more)
...
Cohesion: 0.1
Nodes (21): CappedDb, CappedTable, The read that made 1,351 questions look like 19.  Every bulk read in `study_os, Enough rows that any realistic cap truncates, if nothing paginates., The whole bug in one assertion. 6 papers × 40 = 240 questions; with a     cap o, Four real papers, not the two that happened to be in the first page., No themes" on demo was the thematic PAPERS never surviving the papers     read,, A full page must be followed by another read; a short page must end it.     Get (+13 more)
...
Cohesion: 0.08
Nodes (30): claim_pending_recomputes(), drain_recompute_queue(), drain_recompute_queue_async(), _finalise_failure(), _now(), Eligibility recompute worker — drains ``eligibility_recompute_queue``.  The qu, Process up to ``limit`` queued recompute rows. Returns a summary dict., Atomically claim pending recomputes via the claim_eligibility_queue RPC. (+22 more)
...
Cohesion: 0.07
Nodes (26): Service-level regressions for GQR-G6 monthly hardening., test_start_uses_guarded_rpc_and_passes_frozen_rows(), _app(), HTTP contract for ``GET /api/exams/eligibility-summary`` (PR-D1)., The endpoint must never 500 a brand-new user. Per-call DB failures     are swal, test_summary_endpoint_returns_four_buckets(), test_summary_endpoint_swallows_db_errors_returns_empty_buckets(), object (+18 more)

### Community 505 - "Community 505"
Cohesion: 0.11
Nodes (33): classify_persona(), Pure function: signals -> persona dict. Safe with empty or partial input., _base_signals(), _signals(), test_budget_sensitive_still_only_from_explicit_flag_with_answers(), test_mock_avoid_answer_sets_mock_avoider(), test_mock_skip_analysis_sets_high_mock_low_review(), test_phone_distraction_raises_execution_risk_to_medium() (+25 more)
...
Cohesion: 0.08
Nodes (20): RECURRENCE_LABEL, buildTree(), firstNode(), GROUPS, positionOf(), sameNode(), searchTopics(), items (+12 more)
...
Cohesion: 0.19
Nodes (23): _db(), _feed(), _Net, _page(), CA-RSS-02 — SEBI path allow-list, embedded-PDF body, entities, pubDate.  The C, Injected fetch serving a feed, item pages, and PDFs.      ``pages`` maps an it, _sebi_source(), test_body_thresholds_are_configurable_per_source() (+15 more)
...
Cohesion: 0.09
Nodes (23): _count_analytics_jobs(), _count_mastery_jobs(), _make_auto_submit_db(), Per-user mastery live allowlist and pinned-mode regression tests.  Covers: 1., auto_submit_attempt must enqueue analytics_retry, not mastery_retry., D2 fix: non-allowlisted users also get NO eager mastery_retry at auto-submit., FF=off: analytics_retry is enqueued; mastery_retry is still deferred., D2 (revised): auto_submit_attempt enqueues only analytics_retry.     Mastery mo (+15 more)
...
Cohesion: 0.11
Nodes (31): get_review_queue(), list_questions(), Admin mock question service — state machine, CRUD, dedup, bilingual linking., Return paginated question list filtered by actor visibility.      Authors see, Return questions in `in_review` status, newest first., _build_diff(), compute_fingerprint(), create_question() (+23 more)
...
Cohesion: 0.12
Nodes (30): attest_mock(), _decide_tier(), Study OS — mock score verification flow (PR 5 + PR 9 + PR 10).  The verificati, _safe(), PR 5 / PR 9 — mock verification tier rules., _sb(), test_mentor_attestation_is_tier_1(), test_partner_must_not_be_self_collusion_risk() (+22 more)
...
Cohesion: 0.1
Nodes (22): _FakeSB, _FakeTable, _make_sb(), _R, Tests: rejection_notes persistence + bulk_reject reason enforcement.  Written, The old no_action overwrite must be gone — recommended_action is read-only here., bulk_promote has no reason requirement., bulk_apply with bulk_reject and no reason must raise 422 before any DB call. (+14 more)

### Community 521 - "Community 521"
Cohesion: 0.08
Nodes (29): band_for(), measure(), Predictability — a difficulty axis that works for descriptive papers.  ``pyq_q, Band one topic from its rank within its subject-paper, then floor it up., Measure and band every topic of ONE subject-paper.      The span is derived fr, Score one topic's recurrence over its subject-paper's span.      *years* is th, score_paper(), _fixture() (+21 more)

### Community 522 - "Community 522"
Cohesion: 0.09
Nodes (31): chunks(), ``items`` split into lists of at most ``size`` — for chunking IN() filters., test_chunks_splits_for_the_url_length_ceiling_not_for_a_row_cap(), _chunks(), difficulty_heatmap(), _normalize_difficulty(), _paginate(), Subject × difficulty count grid built from verified PYQ questions.      Return (+23 more)

### Community 523 - "Community 523"
Cohesion: 0.12
Nodes (31): _paper(), _q(), Themes arranged the way the syllabus is arranged.  A flat chip list of 1,493 t, Section 1 before section 2, whichever has more questions. The order is     the, Determinism over heuristics: a theme with no syllabus metadata and no     exact, A Paper I tab that left Paper II sittings on screen is a filter that     only h, Seen on demo: paper_id 9b2371d8…, 2023, 80 questions, listed under     Politica, The leak was here: with no subject chosen the scope was every question,     so (+23 more)

### Community 524 - "Community 524"
Cohesion: 0.1
Nodes (32): _corpus(), _q(), Where both exist the verdict wins, because it read the official DOCX and     th, Counts come from the questions, never from a number range: GS1 gets three     q, Tag and OCR can both be satisfied and the sitting still be impossible:     the, CORRECTED RULE. The check assumed a bucket's `question_number` runs in     prin, The two are separated on purpose: one is an assumption about printing     order, (year, paper) -> OCR text. Each paper's page contains only its own text. (+24 more)

### Community 525 - "Community 525"
Cohesion: 0.07
Nodes (13): ACReports(), ACCOUNTABILITY, ADMIN_COMM, CHANNEL_RULES, COMMUNITY_USERS, FLAIRS, MENTOR_EARNINGS, MENTOR_SESSIONS (+5 more)
...
Cohesion: 0.19
Nodes (26): _db(), _feed(), _Net, CA-RSS-01 — item-level RSS ingestion.  An RSS source must snapshot one documen, RSS 2.0 feed from ``(title, link, pubDate)`` triples., Injected fetch: serves the feed for the feed URL and an item page for     anyth, _sebi_source(), _SebiNet (+18 more)
...
Cohesion: 0.11
Nodes (31): AnswerValidationError, _coerce_boolean(), _coerce_date(), _coerce_number(), _coerce_percentage(), _option_values(), Deterministic, allowlisted answer parsing for the unified engine.  Sprint-1 ru, Raised when an answer cannot be deterministically validated. (+23 more)

### Community 532 - "Community 532"
Cohesion: 0.1
Nodes (30): Entry resolution for the unified onboarding engine.  Two entry modes resolve h, _shape_post(), _shape_recruitment(), load_field_registry(), load_verified_recruitment_questions(), normalize_intent(), Entry resolution for the unified onboarding engine.  Two entry modes resolve h, Resolve a post within a recruitment.      ``posts`` has no slug column, so we (+22 more)
...
Cohesion: 0.1
Nodes (30): declined_elective_subject_ids(), in_scope_subject(), Subjects the user is NOT studying because they chose a different optional., Whether a task-derived subject bucket belongs on a scoped surface.      Only a, _call_exams(), _elective_seed(), _exam_seed(), PLAN-BUG-02 — the backend halves of the six plan-page surface faults.  F2 (the (+22 more)

### Community 536 - "Community 536"
Cohesion: 0.11
Nodes (29): attach_comparable_priority(), comparable_priorities(), Make ``exam_priority_score`` comparable across ``source_basis``.  THE DEFECT T, Attach :data:`COMPARABLE_KEY` to every row, in place, and return them.      Pa, Mid-rank percentile (0-100) of each row within its own ``source_basis``., _score(), RANK-SCALE-01 — `exam_priority_score` carried two incompatible unit systems., The only honest answer when there is nothing to rank against — and it     keeps (+21 more)
...
Cohesion: 0.1
Nodes (29): _canonical_coverage_rows(), One coverage row per topic — COV-PHASE-01's canonicity rule.      ``exam_topic, One coverage row per topic — COV-PHASE-01's canonicity rule.      ``exam_topic, _by_topic(), _clear_exam_cache(), _cov(), _NoPhases, COV-PHASE-01 — one coverage row per topic, and which phase's row it is.  Live (+21 more)

### Community 540 - "Community 540"
Cohesion: 0.09
Nodes (31): attempt_history_row(), breadcrumb_for(), is_gs_paper(), is_thematic(), is_thematic_question(), _meta(), paper_kind(), paper_question_labels() (+23 more)
...
Cohesion: 0.1
Nodes (30): classify_rows(), compute_signals(), confidence(), content_artefact_needed(), decide(), evidence(), _hits(), _legible() (+22 more)

### Community 545 - "Community 545"
Cohesion: 0.11
Nodes (30): as_metadata(), assert_bucket_scope(), BucketAbort, insert_args(), is_bucket_code(), is_in_scope(), main(), plan_bucket() (+22 more)

### Community 546 - "Community 546"
Cohesion: 0.17
Nodes (30): _answer_and_submit(), _integer_question(), Integer / numerical answer runtime contract (PYQ PR-11 / gate G11).  Covers th, An integer question frozen without a valid numeric_answer spec must never     b, MCQ questions must not carry a numeric_answer spec in the snapshot., _seed(), test_api_answer_accepts_numeric_answer(), test_exact_numeric_match_is_correct() (+22 more)

### Community 547 - "Community 547"
Cohesion: 0.15
Nodes (30): check_gateway_publish(), Publish-readiness gate (PR4).      Stricter than :func:`check_gateway_promotio, check_gateway_publish(), Publish-readiness gate (PR4).      Stricter than :func:`check_gateway_promotio, test_missing_report_blocks_both_gates_at_promotion_level(), test_publish_blocker_distinct_from_promotion_blocker(), _flag(), PR4 promotion + publish gate tests.  Plan §5 ship gate:  * promotion gate re (+22 more)

### Community 548 - "Community 548"
Cohesion: 0.12
Nodes (22): _client(), _seed_channel_db(), test_admin_hide_thread_flips_target_status_in_same_action(), test_channel_thread_reply_vote_report_are_db_backed(), test_reply_vote_is_db_backed_and_atomic(), test_resource_contribute_vote_report_and_admin_resolve_are_db_backed(), test_thread_reply_count_uses_atomic_increment(), _client() (+14 more)
...
Cohesion: 0.07
Nodes (30): _backlog_trigger(), build_regen_triggers(), _cached_next_cycle(), _days_remaining(), _deadline_trigger(), _missed_days_streak(), _mock_drift_trigger(), Count consecutive days (ending yesterday) where every planned task     was miss (+22 more)
...
Cohesion: 0.14
Nodes (25): _doc(), IngestSB, ca:ingest pass tests (GQR-G5b): cadence gate + enqueue-on-snapshot + aggregation, _src(), test_enqueue_failure_is_counted_and_partial(), test_is_due(), test_non_dict_crawl_schedule_is_tolerated(), test_pass_covers_more_than_one_page() (+17 more)

### Community 555 - "Community 555"
Cohesion: 0.13
Nodes (29): _advisory_readiness_summary(), _format_cycle(), _format_phase(), get_management_exam_detail(), _group_by_key(), list_management_exams(), _load_cycles_for_exams(), _load_family_names() (+21 more)

### Community 556 - "Community 556"
Cohesion: 0.07
Nodes (20): DayColumn(), CANDIDATES, cards, DAYS, gap, gaps, handle, initial (+12 more)

### Community 557 - "Community 557"
Cohesion: 0.07
Nodes (14): CONFIDENCE_TONE(), Eyebrow(), MiniBar(), SectionHeader(), StudyConfidencePill(), Tabs(), TrustStamp(), Chip() (+6 more)
...
Cohesion: 0.14
Nodes (29): calibration_required(), evaluate_calibration(), has_existing_plan(), Return ``(exists, ok)`` — whether the user already has any plan for this exam., Health-aware single source of truth for the gate.      Returns a dict::, True when the user must calibrate before a FIRST plan can be generated.      R, FakeSB, _healthy_tables() (+21 more)
...
Cohesion: 0.09
Nodes (28): execute_or_raise(), Execute a DB operation and raise DatabaseError on failure., _build_promotion_rpc_payload(), _compensate_promotion(), compute_promotion_slug(), _derive_status(), _map_education_level(), _persist_post_age_relaxation() (+20 more)
...
Cohesion: 0.1
Nodes (29): _build_diff(), compute_fingerprint(), ConflictError, create_question(), dedup_check(), _fetch_log(), _fetch_options(), _fetch_question() (+21 more)
...
Cohesion: 0.24
Nodes (28): _apply(), _as(), _draft(), _fresh_question(), _ok(), Behavioural integration test for migration 303 (answer_structures).  Applies 3, _review(), _row() (+20 more)

### Community 576 - "Community 576"
Cohesion: 0.1
Nodes (26): _q(), Question labels, breadcrumbs, and placement from the real tree shape.  `questi, A breadcrumb with a hole invites the reader to wonder what is missing., marks not recorded" was a sentence about the database., Confirmed shape: the tag points at a microtopic, its parent is the     numbered, `upsc-mains-gs1` and friends carry no tree. Guessing that they mean GS1     wou, A name the index knows, under a subject that disagrees, follows the     subject, 101..108 is one subject block. The aspirant sees Q1..Q4 with sub-parts,     whi (+18 more)
...
Cohesion: 0.12
Nodes (21): answerSection(), resetAttempts(), seedSubmittedAttempts(), PYQ_PRACTICE, ensureSeededUser(), gotoProtectedPage(), loginViaUi(), loginViaUiWithPhone() (+13 more)

### Community 580 - "Community 580"
Cohesion: 0.12
Nodes (28): ascii_only(), best_against(), build_raw_corpus(), chunk_raw(), _dict_hit(), english_word_count(), extract_raw_text(), iter_json_questions() (+20 more)
...
Cohesion: 0.07
Nodes (29): _drill(), fetch_api_paginated(), _first_field(), parse_json_feed(), Walk a dotted path through a JSON object. Returns ``None`` when     any interme, Return the first non-empty string value among ``candidates`` keys     on ``entr, Parse a decoded JSON payload into a flat list of entries.      ``adapter_confi, Walk a dotted path through a JSON object. Returns ``None`` when     any interme (+21 more)

### Community 583 - "Community 583"
Cohesion: 0.17
Nodes (26): _fixture(), _Net, CA-SRC-01 — wave-1b discovery_only feeds: format detection + the ADR 0007 guard., Serves the feed for the feed URL and 404s everything else — an item-page     fe, _source(), test_a_filename_never_decides_the_format(), test_a_mostly_pointer_only_feed_is_ingested_without_summaries(), test_a_plain_sitemap_without_the_news_namespace_is_not_a_news_feed() (+18 more)
...
Cohesion: 0.1
Nodes (20): _apportion_order(), Section-wise question SELECTION + relaxation ladder for generated mocks (A-PR2)., Order ``rows`` so a ``mix`` over ``key`` is front-loaded, then backfilled., Run the relaxation ladder over one section's eligible pool.      Returns ``(qu, _select_section(), _apportion_order(), _exam_base_pool(), Section-wise question SELECTION + relaxation ladder for generated mocks (A-PR2). (+12 more)
...
Cohesion: 0.09
Nodes (20): Scale a capped mastery delta by the source trust weight., _weighted_delta(), _make_analytics(), Mock trust model — PR-fix-8 acceptance criteria.  AC2: Existing platform-attem, Verify the metadata key used for backfill matches what mock_engine writes., Same accuracy → platform delta is exactly 1/0.3 ≈ 3.33x larger., test_backfill_detection_logic(), test_correction_task_manual_log_no_canonical_ids() (+12 more)

### Community 597 - "Community 597"
Cohesion: 0.08
Nodes (28): monotonic_outcome(), overall_status_is_terminal(), Pure session/unit rollup logic for finalize_writing_session (§4.3b, §9.1a).  T, Session-level completion conditions (§4.6c)., Return the outcome to persist: never downgrade (§9.1a conditional write)., A unit's rollup-relevant state., Per-unit outcome for a terminal evaluation, else None (§4.6a-1)., session_complete_gate() (+20 more)
...
Cohesion: 0.1
Nodes (27): my_mark_read(), _allowed_for_user(), dispatch_pending_alerts(), _looks_like_missing_email_sent(), Notification dispatcher — render + send unread alerts.  Channel adapters:, Send via Resend if configured, otherwise log and return a mock id., Pick up unread + email-not-yet-sent alerts and send them.      Returns ``{chec, _render_email() (+19 more)

### Community 601 - "Community 601"
Cohesion: 0.11
Nodes (26): _cycle_year(), Competition Intelligence read helpers (Phase 12).  Reads ``exam_competition_me, The shared current-row selector (OD-10): rows disposed with a     metric_kind u, _select_current(), _coerce_number(), competition_series(), cutoff_series(), _load_cycles() (+18 more)

### Community 602 - "Community 602"
Cohesion: 0.1
Nodes (27): _full_client(), _make_option(), _make_question(), _make_template(), PR2b Attempt Events — acceptance criteria tests.  AC4 : Posting the same batch, Client with both mock_engine and mock_attempt_events routers mounted., record_server_event with ATTEMPT_STARTED writes one server row., test_start_attempt_emits_started_event() (+19 more)
...
Cohesion: 0.18
Nodes (26): _audit_topics(), _base_db(), _classification(), MASTERY-GATE-01 — refuse mastery writes from attempts with too little signal., ``df35b2a8``'s shape: one correct answer, 74 untouched → +14.40 db today., 7 answered > the attempt floor of 5, but each topic has exactly 1 answer., ``4e866434``'s shape (9 questions, mostly correct), spread over 5 topics., One topic with 5 answers, one with 1: the first writes, unchanged. (+18 more)

### Community 605 - "Community 605"
Cohesion: 0.1
Nodes (19): True cross-consumer parity: work_queue.aggregate() and compute_exam_workspace_re, True cross-consumer parity: work_queue.aggregate() and compute_exam_workspace_re, Run work_queue.aggregate() via SBStub; return verified_pyq_count., Run work_queue.aggregate() via SBStub; return verified_pyq_count., Run compute_exam_workspace_readiness() via _make_sb; return verified_question_co, Run compute_exam_workspace_readiness() via _make_sb; return verified_question_co, All three gates pass — both consumers return identical count., All three gates pass — both consumers return identical count. (+11 more)

### Community 606 - "Community 606"
Cohesion: 0.07
Nodes (18): countLabel(), CATALOG, gs, labels, NO_FILTERS, { onFilterChange }, { onLensChange }, { onSelect } (+10 more)

### Community 607 - "Community 607"
Cohesion: 0.08
Nodes (12): ErrorBoundaryInner, ErrorBoundaryInner, App(), useHash(), App(), App(), GROUP_LABELS, NAV_GLYPHS (+4 more)
...
Cohesion: 0.08
Nodes (28): _content_length(), fetch_pdf(), parse_pdf_bytes(), parse_pdf_pages(), Extract text from a PDF byte string using pypdf.      Returns an empty string, Like ``parse_pdf_bytes`` but returns one stripped string per page.      Empty, ``Content-Length`` as an int, or ``None`` when absent/unparseable., Extract text from a PDF byte string using pypdf.      Returns an empty string (+20 more)

### Community 610 - "Community 610"
Cohesion: 0.07
Nodes (8): Drawer(), PageHeader(), Pill(), ProvenanceChips(), StatusDot(), VerifiedSeal(), Chip(), LayerGlyph()
...
Cohesion: 0.08
Nodes (25): evidence_coverage(), Resolved D05 required-phase completeness for the selected cycle (what is still u, Resolved D05 required-phase completeness for the selected cycle (what is still u, _condition_applies(), _effective_requirements(), evaluate_required_phases_complete(), _EvidenceIndex, _fetch_paged() (+17 more)
...
Cohesion: 0.17
Nodes (26): _backlog_count(), compute_weekly_review(), _derive_items(), get_weekly_review(), _isofmt(), _mock_trend_history(), _mocks_in_week(), _monday_of() (+18 more)
...
Cohesion: 0.12
Nodes (24): _build_app(), _FakeUser, Per-token single-flight in app.core.auth.  Without the lock, N concurrent firs, A 401 path must drop the per-token lock so the next retry runs cleanly., After the cache warms, subsequent requests must not even acquire the lock., Three parallel requests, same bearer ⇒ exactly one Supabase call., 5 distinct bearers ⇒ 5 distinct Supabase calls (the lock keys per-token)., _reset_state() (+16 more)

### Community 621 - "Community 621"
Cohesion: 0.12
Nodes (17): _db(), _Q, Paper-practice eligibility and the specific empty-pool 409 (PRACTICE-PAPER-01)., A paper with any non-descriptive verified question is not a descriptive     pap, Only verified questions count: the launcher would never select a pending     ro, A section or topic target is not a paper, so there is nothing structural     to, A diagnosis is a nicety. It must never turn a correct 409 into a 500., _Res (+9 more)

### Community 622 - "Community 622"
Cohesion: 0.09
Nodes (23): _demo_db(), FakeDb, _pass(), Papers and questions as rows, mutated exactly as the live path does., Papers and questions as rows, mutated exactly as the live path does., One run over the whole scope, mirroring run()'s body., Migration 223's trg_pyq_questions_revalidate_paper_move refuses a     pyq_paper, One run over the whole scope, mirroring run()'s body. (+15 more)

### Community 623 - "Community 623"
Cohesion: 0.13
Nodes (26): compare_me(), Study OS — daily behavior snapshot aggregation (PR 1).  Aggregates `study_sess, _clamp(), compute_behavior_snapshot(), _day_bounds(), _focus_minutes(), _ratio(), Study OS — daily behavior snapshot aggregation (PR 1).  Aggregates `study_sess (+18 more)
...
Cohesion: 0.07
Nodes (26): 1. What each route renders, 2. `essay_brainstorm_blocks` — every read and write path, 3. `linked_gs_topic_id`, 4. Seeding, 5. `essay_themes`, 6. `essay_pyq_tags` — what reads it, 7. Routing — links between the two surfaces, and nav, A user's path into each surface (+18 more)

### Community 629 - "Community 629"
Cohesion: 0.07
Nodes (25): 1. Writers and readers, 2. Where the two-row design comes from, 3. Is `planner.py:678-683` deliberate?, 4. If the scoped row is retired — everything keys global, 4 vs 5, stated plainly, 5. If the global row is retired instead — everything keys scoped, 6. Re-review supersession (gap 4), 7. Has anything ever written the exam-scoped row? (+17 more)
...
Cohesion: 0.08
Nodes (6): _FakeStorage, _FakeStorageObject, _Q, _R, Per-bucket facade. Captures uploads so `download` can return them., _SB
...
Cohesion: 0.19
Nodes (26): _build_app(), Trust invariant for the Exam-Intelligence CMS (data import/seed pipeline).  Th, _seeded_exam(), test_bulk_import_pyq_papers_forces_pending_trust(), test_bulk_import_rejects_unknown_entity(), test_bulk_import_topic_coverage_forces_pending_review_over_caller_status(), test_create_competition_metric_is_forced_draft(), test_create_pyq_paper_is_forced_pending_even_if_caller_sends_verified() (+18 more)

### Community 636 - "Community 636"
Cohesion: 0.07
Nodes (26): The question-bank TTL cache (cachetools, 10min) lives at module scope.      St, The exam-lookup TTL cache (cachetools, 10min) lives at module scope., The eligibility-rules TTL cache (cachetools, 10min) lives at module scope., The planner's days-remaining TTL cache lives at module scope., Item 5's per-exam intelligence TTL cache lives at module scope.      Without a, _reset_eligibility_rules_cache(), _reset_exam_lookup_cache(), _reset_per_exam_intelligence_cache() (+18 more)

### Community 637 - "Community 637"
Cohesion: 0.08
Nodes (25): _check_duplicate(), Stateless syllabus mention proposer + accept helpers (PR3a/PR3b).  propose_syl, Return error reason string or None if valid., Return error reason string or None if valid., Return existing mention id if a non-rejected duplicate exists, else None., Return existing mention id if a non-rejected duplicate exists, else None., Scan page_norm for the best fuzzy match of alias_norm.      Returns (best_rati, Scan page_norm for the best fuzzy match of alias_norm.      Returns (best_rati (+17 more)
...
Cohesion: 0.11
Nodes (24): _condition_applies(), _effective_requirements(), evaluate_required_phases_complete(), _EvidenceIndex, _now(), _parse_ts(), D05 evidence-policy evaluator (D12 v1, PR-2).  Resolves the D05 evidence requi, Most-specific base requirement per evidence_kind for (exam_type, phase_kind, sco (+16 more)

### Community 645 - "Community 645"
Cohesion: 0.13
Nodes (20): extract(), Extraction + routing contract for ``scripts/extract_gs_missing.py``.  Fixtures, What the snapshot would contribute: the English words of real DB rows., test_bilingual_paper_keeps_english_only(), test_clean_paper_extracts_every_question_in_order(), test_count_mismatch_flags_numbering_for_review(), test_essay_topics_sections_and_printed_marks(), test_extraction_is_deterministic() (+12 more)
...
Cohesion: 0.15
Nodes (22): _admin(), _apply(), _psql_file(), Migration 240 — session `submitted_at` written by the rollup (cleared-parallel)., _swap_db(), _admin(), _apply(), _create() (+14 more)

### Community 648 - "Community 648"
Cohesion: 0.08
Nodes (10): renderNav(), unobserve(), chip, compEl, eligEl, first, last, middle (+2 more)

### Community 649 - "Community 649"
Cohesion: 0.14
Nodes (20): CmsClient, create_mention(), load_mention_index(), load_topic_index(), POST a WriteEnvelope. Returns the created row.          The CMS wraps every wr, POST a WriteEnvelope. Returns the created row.          The CMS wraps every wr, POST a WriteEnvelope. Returns the created row.          The CMS wraps every wr, Page a CMS list route. Returns (rows, server_total).          ``server_total`` (+12 more)

### Community 650 - "Community 650"
Cohesion: 0.08
Nodes (18): renderCms(), { api }, calls, el, examA, f, fakeItems, filter (+10 more)
...
Cohesion: 0.21
Nodes (24): _make_db(), _make_signal(), _apply_error_patterns schema-compatibility regression tests.  Asserts that Mas, test_does_not_write_microtopic_id_as_top_level_column(), test_empty_signals_list_does_not_insert(), test_multiple_signals_each_insert_a_row(), test_null_microtopic_id_stored_in_evidence(), test_stores_evidence_question_ids_in_evidence() (+16 more)
...
Cohesion: 0.14
Nodes (26): invalidate_eligibility_rules_cache(), Return the four-bucket summary for the dashboard / onboarding card.      Outpu, Drop the verified-rules cache. Call after admin writes., summarize_user_eligibility(), _load_eligibility_summary(), Item 6: assemble the four-bucket eligibility summary for Today.      Mirrors `, Two streams under the same verified cycle, each with its OWN fixed-date age, _sebi_band() (+18 more)
...
Cohesion: 0.19
Nodes (23): build_fixture(), git(), Invoke Bash with validated literal controls for Windows/MSYS compatibility., run(), run_verifier(), test_verifier_passes_lf_and_crlf_checkouts(), test_verifier_rejects_committed_stale_attestation(), test_verifier_rejects_staged_fingerprinted_drift() (+15 more)

### Community 664 - "Community 664"
Cohesion: 0.08
Nodes (26): code:jsx ({MENTOR_SESSIONS.filter((s) => s.mentorId === mentor.id).map), code:js ({[ {u: "u_aarav", join: "Mar 11", hrs: 38.5, founder: true},), code:jsx (async function report(id, reason) { try { await api.post(`/a), code:js (const [exam, setExam] = useState("UPSC CSE");), code:js (api.get(`/api/community/channels/${cid}/threads?sort=hot`)), code:js (useEffect(() => {), F-P1-10. `CommunityScreen` URL sync writes on every render, F-P1-11. Sorting state isn't lifted into the URL (+18 more)
...
Cohesion: 0.12
Nodes (24): _as_str(), evaluate_targets(), is_prompt_applicable(), _match_band(), EWP writing-prompt applicability resolver (migration 214 content-scoping).  Ca, Whether ``prompt_id`` is applicable for the authoritative exam context.      F, The subset of ``prompt_ids`` applicable for the exam context.      The mandato, Which precedence band this target row occupies for the given context.      Ret (+16 more)
...
Cohesion: 0.18
Nodes (24): AnswerOutcome, apiCall(), AttemptQuestion, AttemptSnapshot, env(), getAttempt(), getAttemptSnapshots(), getPersistedResponses() (+16 more)

### Community 679 - "Community 679"
Cohesion: 0.14
Nodes (23): checkboxStats(), clickThroughSection(), getBody(), getChangedFiles(), getLabels(), main(), touchesUserFacing(), checkboxStats() (+15 more)
...
Cohesion: 0.15
Nodes (19): classify(), content_tokens(), derive(), _dist(), flat(), Idf, local_no(), main() (+11 more)
...
Cohesion: 0.14
Nodes (23): apply_code_suffix(), best_elsewhere(), cached_cover(), cached_ocr(), classify(), _counts_table(), _dist(), _hindi_paper_votes() (+15 more)

### Community 690 - "Community 690"
Cohesion: 0.19
Nodes (23): _active(), _client(), _exam(), _plans(), D5 — switching target exam must not leave the user with zero active plans.  ``, A second active row would make the nightly sweep nondeterministic.      ``rege, The fix must not rewrite the old plan onto the new exam., New exam has no locked coverage → planner refuses; switch still succeeds. (+15 more)

### Community 691 - "Community 691"
Cohesion: 0.12
Nodes (13): _derive(), Unit tests for the pure EWP-2B evidence deriver (§4.12, §8.2, §10.1).  The mod, test_derived_key_stable_and_changes_with_exercise_type(), test_derived_row_fields_and_key(), test_non_terminal_status_returns_none(), test_recognition_never_emitted_by_writing_path(), test_source_type_derived_from_exercise(), test_terminal_partial_yields_evidence() (+5 more)
...
Cohesion: 0.13
Nodes (18): _draft(), _Enforcing063SB, _FlakyCorrectionSB, MasteryWriter correction-task write-back is schema-compatible with migration 06, SBStub that enforces the migration-063 mock_correction_tasks contract on     in, SBStub that enforces the migration-063 mock_correction_tasks contract on     in, SBStub whose FIRST ensure_mock_correction_draft RPC call raises a     transient, SBStub whose FIRST ensure_mock_correction_draft RPC call raises a     transient (+10 more)

### Community 699 - "Community 699"
Cohesion: 0.14
Nodes (23): _export_args(), _export_fixture(), ExportClient, Serves only the routes `do_export` calls, recording how it called them., Serves only the routes `do_export` calls, recording how it called them., The routes allow nothing else: /pyq-stimuli filters by paper only, and     /pyq, The routes allow nothing else: /pyq-stimuli filters by paper only, and     /pyq, A stimulus shared with an out-of-scope question must not leak that id. (+15 more)
...
Cohesion: 0.1
Nodes (10): useCalibrationPriors(), formatMinutes(), isAutoRefreshedToday(), planHeaderSub(), planHeading(), PlannerBoard, PlanTimelineTab, STATUS_TONE (+2 more)
...
Cohesion: 0.08
Nodes (23): Agent instruction, AI / agent instruction, Canonical entity model, Canonical mapping, code:txt (027_user_events_and_form_submissions.sql), code:sql (public.exams), code:sql (recruitment_id uuid references public.recruitments(id)), code:txt (Database = recruitment) (+15 more)
...
Cohesion: 0.08
Nodes (23): 1. Preflight, 2. The GA strategy of record, 3.1 The product decision, 3.2 The enforcing mechanism in code, 3.3 Growth signal recorded in the contract, 3. How GA is kept separate from GK, 4.1 Two passes exist over the same 320 questions, 4.2 The 12 disagreements, located (+15 more)

### Community 712 - "Community 712"
Cohesion: 0.18
Nodes (21): _adapter(), _baseline(), _Block, _cfg(), _claim(), _FakeClient, Minimal stand-in exposing .messages.create., _run_with_adapter() (+13 more)
...
Cohesion: 0.13
Nodes (12): normalizeToken(), tokenize(), tokenizeWords(), usedRequiredWords(), wordCount(), input, onSubmit, { container } (+4 more)

### Community 718 - "Community 718"
Cohesion: 0.13
Nodes (18): WritingPromptBulkRow, _load(), Validate the committed writing-prompt bank seed (Content Studio bulk-import)., build_seed.py is the source of truth — regenerating must reproduce the     comm, build_seed.py is the source of truth — regenerating must reproduce the     comm, test_committed_files_are_row_arrays_totalling_270(), test_every_row_matches_the_backend_contract(), test_external_keys_are_namespaced() (+10 more)
...
Cohesion: 0.1
Nodes (23): One theme carrying both surfaces' blocks, as a real aspirant's would., One theme carrying both surfaces' blocks, as a real aspirant's would., THE regression. A lens-null Spine block must never reach the canvas., The reverse. The Spine's slots must not receive canvas content., Neither scope drops a row, and no row appears in both., THE regression. A lens-null Spine block must never reach the canvas., The one block_type both surfaces write, so lens is the only separator., The reverse. The Spine's slots must not receive canvas content. (+15 more)
...
Cohesion: 0.13
Nodes (14): _build_app(), _FakeAdmin, _FakeAuth, _FakeUser, Regression test for the per-request auth memoisation in core.auth.  `get_curre, test_separate_requests_with_different_tokens_each_validate(), test_single_request_hits_supabase_get_user_once(), _build_app() (+6 more)
...
Cohesion: 0.11
Nodes (13): _FilterSpySB, _FilterSpyTable, _R, Tests: bulk_dry_run() filters by selected_ids at DB level.  Concern 2 of fix/g, Query builder that records whether .in_() was called before .execute()., Fake Supabase that enforces a DB-side .in_() filter for bulk_dry_run., _report(), test_db_query_filtered_by_selected_ids() (+5 more)

### Community 727 - "Community 727"
Cohesion: 0.11
Nodes (14): BulkRequest, _FilterSpySB, _FilterSpyTable, _R, Query builder that records whether .in_() was called before .execute()., Fake Supabase that enforces a DB-side .in_() filter for bulk_dry_run., bulk_dry_run must pass selected_ids as a DB-side filter, not scan all rows., bulk_promote has no reason requirement. (+6 more)
...
Cohesion: 0.11
Nodes (16): CycleEntry(), formatDate(), GROUPS, MONTHS, STATUS_LABEL, STATUS_TONE, streamKey(), streamLabel() (+8 more)

### Community 732 - "Community 732"
Cohesion: 0.1
Nodes (11): hasAnyEvidence(), Sparkline(), STATE_META, SyllabusRoadmapView(), y, chips, { container }, empty (+3 more)

### Community 733 - "Community 733"
Cohesion: 0.09
Nodes (3): PrototypeGroups(), CHECKINS, MEMBERS
...
Cohesion: 0.09
Nodes (22): 1. SHA + search scope, 2.1 Identity, streams, eligibility, 2.2 Subject catalogue / taxonomy, 2.3 PYQ corpus and intelligence, 2.4 Corpus repair / QA migrations (regulatory-specific), 2.5 Study OS runtime, 2.6 Current affairs (regulator sources), 2.7 Scripts and tooling (+14 more)

### Community 741 - "Community 741"
Cohesion: 0.09
Nodes (22): 1.1 DISPUTED — the keyed answer is, in my judgement, wrong, 1.2 AMBIGUOUS — more than one option is defensible, or the data is inconsistent, 1.3 UNANSWERABLE, 1. Key verdicts, 2020 Q3 · economics · `a4bb3bb7-3374-4f76-9a75-6fbb917b77b8`, 2020 Q8 · economics · `cd6c36b0-bb36-4b57-a583-b7918c915425`, 2022 Q1 · costing · `8408867a-f42c-4b07-b7ab-0b60f313af95`, 2024 Q10 · companies-act · `cab8bf24-a2dc-47cb-a1ef-7152fa49fa56` (+14 more)
...
Cohesion: 0.15
Nodes (14): _plan_last_refresh(), ``{trigger, at}`` for the plan's newest version row, or None.      ``trigger``, PLAN-UX-01 — ``GET /api/study/plan``'s ``plan.last_refresh``.  The nightly swe, Minimal supabase stub: records the query and returns canned rows., A user apply, a mock-triggered regen and a null reason are all 'manual'     for, A plan predating version rows is a real state. None, never a guess from     the, _Rows, test_a_failed_read_yields_none_rather_than_a_wrong_trigger() (+6 more)

### Community 749 - "Community 749"
Cohesion: 0.13
Nodes (21): build_unit_views(), finalize_writing_session(), _now_iso(), finalize_writing_session — pure reference rollup for session/unit status (§9)., Recompute and persist session status + evaluation_outcome. Idempotent., UTC completion stamp. Mirrors the SQL rollup's now() (migration 238);     the S, A failed unit is recoverable while a job for its evaluation can retry.      NO, Read units + their latest version's latest evaluation into UnitViews. (+13 more)

### Community 750 - "Community 750"
Cohesion: 0.2
Nodes (21): _cms_client(), CMS create / bulk-import contract for PYQ topic tags (migration 032).  Tags ar, _review_client(), _seed(), test_bulk_import_1000_tags_mixed_valid_invalid(), test_bulk_import_tags_allows_more_than_default_cap_but_subjects_do_not(), test_create_pyq_source_lands_pending(), test_create_tag_forces_pending_even_if_caller_sends_verified() (+13 more)

### Community 751 - "Community 751"
Cohesion: 0.12
Nodes (20): CaAnswerBody, get_ca_attempt(), Current-affairs learner attempt API (GQR-G5a).  Server-owned CA attempt runtim, save_ca_answer(), submit_ca_attempt(), Current-affairs learner attempt runtime (GQR-G5a) — OWN tables, no mastery.  A, get_current_affairs_attempt(), _learner_question_view() (+12 more)

### Community 752 - "Community 752"
Cohesion: 0.1
Nodes (22): _learner_row(), _normalise_stimulus_scopes(), Fail closed unless every populated strategy scope dimension matches.      When, Fail closed unless every populated strategy scope dimension matches.      When, Return verified active reasoning strategies for every requested question id., Return verified active reasoning strategies for every requested question id., Return ``(all_requested, valid_for_read)`` stimulus scope mappings.      Set d, Return ``(all_requested, valid_for_read)`` stimulus scope mappings.      Set d (+14 more)
...
Cohesion: 0.18
Nodes (21): _centroid_inside(), _iou(), _is_match(), main(), _normalize(), _percentile(), CLI: grade extraction candidates against a fixture or smoke-check an unlabeled r, run_eval() (+13 more)
...
Cohesion: 0.13
Nodes (21): has_unresolved_conflict(), Return True if any conflict on the report still has ``status='open'``., collect_observations(), has_unresolved_conflict(), _host_of(), Build the flat observation list from one queue item + peers.      The primary, Return True if any conflict on the report still has ``status='open'``., Tests for ``app.scraping.consensus_engine``.  Plan §4 acceptance:  * officia (+13 more)
...
Cohesion: 0.09
Nodes (4): AdminApprovals(), AdminMarketOverview(), AdminPayouts(), ADMIN_MARKET_TABS
...
Cohesion: 0.18
Nodes (20): _build_eligibility_overlay(), _decode_cursor(), eligibility_me(), _encode_cursor(), get_exam_by_slug(), list_exams(), Exams catalogue (PR1).  Lists user-facing exams with per-caller eligibility ov, Map exam slug -> {state, missing}. ``state`` collapses the 4-bucket     summary (+12 more)
...
Cohesion: 0.12
Nodes (21): _chunks(), locked_topic_coverage(), locked_topic_coverage_summary(), _paginate(), _paginate_in(), Read every row where ``key`` is in ``values``, chunked and paginated.      The, Return locked topic-coverage rows for ``exam_id`` joined with topic + subject me, Return locked topic-coverage rows for ``exam_id`` joined with topic + subject me (+13 more)

### Community 786 - "Community 786"
Cohesion: 0.14
Nodes (20): _coverage_corpus(), _frequency_corpus(), Coverage reads must be ordered, complete, and never silently partial.  Two def, Was `.limit(1000)`; 1 497 rows exist., Was `.limit(2000)`, which the server serves as 1 000., Drops one row from `table`'s reads while still reporting the true exact     cou, The whole point: a partial frequency map is worse than no map, because     ever, The corpora above only exercise the multi-page path while `_PAGE` is at     or (+12 more)

### Community 787 - "Community 787"
Cohesion: 0.13
Nodes (20): _na_step(), _now_iso(), Cycle activation checklist — nine-step readiness derivation (I9).  ``compute_c, _step(), compute_cycle_readiness(), _get_exam_doc_ids(), _latest_jobs_by_doc(), _na_step() (+12 more)
...
Cohesion: 0.19
Nodes (12): _documents(), load_doc_extraction_counts(), Return extraction counts for admin_exam_intelligence docs owned by exam_id., _doc_asset(), Build a document_assets row with exam ownership in metadata., Build a document_processing_jobs row for a text_extract job., load_doc_extraction_counts uses document_processing_jobs, not trust_status., trust_status='verified' on syllabus_documents is orthogonal to extraction. (+4 more)

### Community 790 - "Community 790"
Cohesion: 0.18
Nodes (19): _attempt(), _executable_sql(), Elapsed time and pasted characters: two monotonic, client-reported counters., The last autosave can be ten seconds stale, and submit is the one moment     th, 0 and null mean different things. A fresh attempt measured nothing     pasted;, The statements actually run — prose in the header is not a grant., Revoking too much would lock the aspirant out of their own answers., _seed() (+11 more)
...
Cohesion: 0.1
Nodes (21): _active_dismissals(), build_progress(), is_sensitive_question(), _persona_answered_keys(), Persona questions an auth'd user has dismissed ("not now")., One-line 'why we ask' — prefer registered help_text, else a safe fallback., Return the next question dict, or ``None`` when the session is done.      The, Session progress for the '3 of 7' UI. (+13 more)
...
Cohesion: 0.1
Nodes (21): _chunked(), _count_by(), _fetch_all(), list_exam_phases(), Page through a PostgREST select so corpus totals are never silently     capped, Split an id list into chunks so a large ``in_(...)`` filter does not     exceed, Return a raw {distinct value → count} map for ``key`` over ``rows``.      NULL, Discover the ACTUAL status vocabulary before anything downstream gates.      R (+13 more)

### Community 806 - "Community 806"
Cohesion: 0.2
Nodes (21): _app(), _call(), _client(), _failing_read_sb(), SBStub whose ``<failing_table>`` raises on ``execute()`` (read failure)., Exam with two locked subjects and NO validated mastery → both required.      W, _seed(), test_generate_no_target_user_returns_422_not_a_plan() (+13 more)

### Community 807 - "Community 807"
Cohesion: 0.19
Nodes (16): clearDraft(), clearOutline(), draftKey(), loadDraft(), loadOutline(), outlineKey(), saveDraft(), saveOutline() (+8 more)
...
Cohesion: 0.17
Nodes (19): create_reminder(), _decode_cursor(), delete_reminder(), _encode_cursor(), list_reminders(), _load_owned(), Reminders API (PR4).  User-owned reminders with CRUD. ``source='system'`` rows, Return the reminder row when owned by ``user_id``; 404 otherwise.      Combini (+11 more)
...
Cohesion: 0.14
Nodes (19): _dedup(), Drop both entries when the same question_number appears more than once., Counter(), _collect_routes(), Phase 5 regression guard — fail CI if any (path, method) is registered by more, Importing server.py loads every router. Every (path, method) pair     under ``/, App-wide variant of the Phase 5 guard — extended by the Phase 5     follow-up c, Specific guard for the 5 paths Phase 5 consolidated.      These were the canon (+11 more)
...
Cohesion: 0.11
Nodes (7): D10: any required-read failure must set pyq_readiness.state='failed', not fabric, D10: any required-read failure must set pyq_readiness.state='failed', not fabric, Flexible supabase stub. Configure per-table return data via constructor., table_data: {table_name: list_of_rows | callable(filters) -> list}, _SBStub, _TableStub, TestPYQWorkbenchReadFailure
...
Cohesion: 0.12
Nodes (8): EligibleExamsCard(), humanFieldList(), EXAM_STATUS_LABEL, ExamRow(), hasStreamLevelOpportunity(), specificStreams(), streamNote(), streamOpportunity()

### Community 820 - "Community 820"
Cohesion: 0.17
Nodes (15): applyMove(), cloneBoard(), describePlacement(), findTask(), insertCard(), nextKeyboardPlacement(), removeTask(), sameArrangement() (+7 more)
...
Cohesion: 0.14
Nodes (19): assert_every_row_numbered(), main(), _numbering_problems(), question_number must be a contiguous 1..N run of integers.      The CMS endpoi, Last gate before anything is written. Raises ValueError if any row would     re, Build the CMS bulk-import body from a descriptive converter envelope.      Rai, reshape(), assert_every_row_numbered() (+11 more)
...
Cohesion: 0.12
Nodes (18): _cycle_aggregate(), _load_counts(), _phase_appeared(), Applied-vs-Appeared candidate-count read helpers (J3 PR 2).  Reads ``exam_cand, Shared current-row selector (mirrors competition.py's OD-10 pattern):     only, The explicitly-labelled cycle-level aggregate row of ``count_type``     (``scop, The appeared count for one specific phase (``scope_kind='phase'`` and     match, _safe() (+10 more)

### Community 835 - "Community 835"
Cohesion: 0.16
Nodes (19): ratio_denominator(), Return ``(denominator_value, denominator_label, source_row)``.      ``denomina, _db(), checkpost P0-2: a cycle-level denominator (target_phase_id=None) must     use O, checkpost P0-2: a Mains row must never read a Prelims appeared count.     Each, A phase with no appeared count falls back to the cycle applied     aggregate (a, checkpost P0-2 regression: a two-phase series must attach each phase's     OWN, Cycle-less callers (e.g. legacy reviewed/locked competition metrics     preserv (+11 more)
...
Cohesion: 0.15
Nodes (18): _clean(), _fetch_id_map(), _parse_bool(), _parse_row(), _parse_valid_until(), Admin mock question bulk import — CSV/JSON parse, fingerprint dedup, idempotent, Whether a raw CSV/JSON row opts into canary-safe mapped import mode., Parse one CSV/JSON row into a canonical question dict. Returns (parsed, errors). (+10 more)

### Community 840 - "Community 840"
Cohesion: 0.21
Nodes (13): _args(), _collect(), Model, scripts/generate_answer_structures.py — the batch loop's safety rails.  No net, Counts calls; answers from the fixture responses by the question in the prompt., test_call_model_mode_never_writes(), test_cost_cap_stops_the_run(), test_default_mode_is_dry_run_and_calls_nothing() (+5 more)

### Community 841 - "Community 841"
Cohesion: 0.18
Nodes (18): _build_app(), _coverage_row(), _db(), _expected_ids(), _get(), ``GET /admin/exam-intelligence/topic-coverage`` must page past ``db-max-rows``., `items` + `count` keep their existing meaning for a first page:     `count` is, Old behaviour (absent truncation) was `len(rows)` over a     `limit + offset` r (+10 more)

### Community 842 - "Community 842"
Cohesion: 0.16
Nodes (18): coverage_pct(), learner_payload(), point_ids(), What an aspirant sees. Provenance, generation metadata and review notes     nev, Share of the structure's body points the aspirant ticked, 0..100, one     decim, attempt_coverage(), point_ids_by_version(), Answer structures on the learner side: read after submit, tick covered points. (+10 more)

### Community 843 - "Community 843"
Cohesion: 0.11
Nodes (14): The compiled syllabus index, and what it is allowed to be.  `syllabus_index.js, The ingest stamps paper_id and macro_topic on every microtopic. That is     aut, A theme name under two papers is not a match. No scoring, no tie-break:     an, A build artefact must not be able to take down the answer-writing     surface., The one way this can rot: a syllabus file is edited and nobody     regenerates., It holds paper, section, part and two sort keys. It does NOT hold topic     ids, M10-rev3: a syllabus's named parts are metadata, never topic rows and     never, test_a_missing_index_degrades_to_flat_rather_than_raising() (+6 more)
...
Cohesion: 0.11
Nodes (16): counter, draft(), err, input, long, mockGet, mockPatch, mockPost (+8 more)

### Community 849 - "Community 849"
Cohesion: 0.12
Nodes (6): SCREENS, Eyebrow(), FooterStrip(), PrototypePage(), PrototypeResources(), TYPE_ICONS
...
Cohesion: 0.11
Nodes (18): 1. Signal distributions across all 29 rows, 2. Where the populations separate - and where they do not, 3. Calibration against the hand-classified rows, 4. Every eligible row, 5. Rows by verdict, with the reason, 6. What this does not settle, apply - 5 rows, Best-alternative margin (+10 more)

### Community 865 - "Community 865"
Cohesion: 0.13
Nodes (13): _now(), NotifToggle, Phase-1 placeholder router — ISOLATED / deferred to v2.  This module once back, _mastery_lease_until(), _now(), _practice_aware_time_remaining_sec(), Countdown surfaced to the attempt shell.      The countdown reads the SAME ``e, _time_remaining_sec() (+5 more)

### Community 866 - "Community 866"
Cohesion: 0.19
Nodes (19): One candidate URL produced by an L-stage.      The candidate's ``method`` matc, Aggregated outcome across all L-stages for one report., ResolverCandidate, ResolverResult, GatewayResult, Orchestrator for the Recruitment Verification Gateway (PR plan §0.2).  Owns th, Run the resolver waterfall for an existing report and persist state.      ``qu, Write the resolver outcome onto the report + audit table. (+11 more)

### Community 867 - "Community 867"
Cohesion: 0.11
Nodes (6): LanguageEvaluator, Adapter boundary for Stage-2 language evaluation., Protocol, Repo, LanguageEvaluator, Adapter boundary for Stage-2 language evaluation.
...
Cohesion: 0.13
Nodes (15): eligibility_queue(), Two-pane KPI view consumed by ``EligibilityQueue.jsx``:      * ``pending`` — s, Two-pane KPI view consumed by ``EligibilityQueue.jsx``:      * ``pending`` — s, group_by(), index_by(), normalize_token(), index_by(), normalize_token() (+7 more)
...
Cohesion: 0.11
Nodes (17): _project_quant(), _project_reasoning(), Solution Strategies — learner-safe question and stimulus strategy projection., Map a governed ``quant_heuristics`` row → the normalized learner DTO.      Ren, Map a governed ``reasoning_strategies`` row → the normalized learner DTO., _project_quant(), _project_reasoning(), Solution Strategies — learner-safe question and stimulus strategy projection. (+9 more)

### Community 875 - "Community 875"
Cohesion: 0.2
Nodes (17): Project verified Reasoning set strategies into the shared learner DTO.      Ca, strategies_for_stimuli(), _link(), GQR-S7 hardening for set/stimulus-aware Reasoning strategy delivery., _strategy(), _subject(), test_malformed_or_empty_set_scope_fails_closed_without_shortening(), test_shared_projection_normalizes_uuid_stimulus_ids() (+9 more)
...
Cohesion: 0.13
Nodes (17): _enqueue_legacy_python(), _legacy_payload(), _looks_like_rpc_missing(), _looks_like_schema_cache_miss(), _now_iso(), Thin Python wrapper around the `enqueue_eligibility_recompute` RPC.  The atomi, Pre-migration fallback. Known limitations vs the RPC:       * Dedupes only agai, Distinguish "RPC not deployed" from real DB errors.      `PGRST202` is PostgRE (+9 more)

### Community 883 - "Community 883"
Cohesion: 0.14
Nodes (15): pdf_bytes_2025(), pdf_bytes_2026(), questions_fixture(), _require_integration_env(), stub_fetch_doc_row_for_fixtures(), pdf_bytes_2025(), pdf_bytes_2026(), Test fixtures for the extraction package.  Unit tests use synthetic Word lists (+7 more)

### Community 884 - "Community 884"
Cohesion: 0.14
Nodes (18): follow_pib_english(), FollowedItem, page_html(), pib_english_prid(), pib_english_url(), pib_full_page_url(), pib_prid(), pib_release_body() (+10 more)

### Community 885 - "Community 885"
Cohesion: 0.11
Nodes (15): Why was this task scheduled? Splits reasoning into persona / exam /     progres, Why was this task scheduled? Splits reasoning into persona / exam /     progres, Why was this task scheduled? Splits reasoning into persona / exam /     progres, Why was this task scheduled? Splits reasoning into persona / exam /     progres, task_reasoning(), build_task_reasoning_response(), _load_persona_snapshot(), Compose the GET /api/study/task-reasoning/:task_id response.      Returns ``No (+7 more)

### Community 886 - "Community 886"
Cohesion: 0.15
Nodes (17): compute_evidence_key(), derive_issue_evidence(), derive_review_correction_evidence(), derive_unit_evidence(), EvidenceRow, EWP-2B mastery evidence derivation (architecture §4.12, §8.2, §10.1).  Pure mo, One derived mastery evidence unit.      Fields are the union of columns the ma, Derive ONE unit-level evidence row for an evaluation (pure decision).      Thi (+9 more)
...
Cohesion: 0.24
Nodes (17): _body(), _client(), The activate authority split for content cards (CONTENT-01, migration 291).  T, A blocked activation is a NORMAL answer (migration 226's rule). The router, The whole point of the third authority: authoring a card must not let the     a, Verifying is not publishing. A reviewer with content_studio.review — and     no, Holding both of the lower authorities must not add up to the third one., test_activate_authority_can_activate() (+9 more)

### Community 889 - "Community 889"
Cohesion: 0.16
Nodes (17): CappingSB, Supabase-shaped stub with a hard ``server_cap`` per read (models     ``db-max-r, A known exam sorting alphabetically past position 100 — and past a full     ser, Callers still pass ``limit`` (endpoint=100/200, evaluator=500) as a     legacy, Within the TTL window two calls return identical, complete results; after     i, _heatmap_db(), The true verified count exceeds one server page, so a single unordered     ``.l, One verified paper with ``n_a`` questions primary-tagged to subject A,     ``n_ (+9 more)
...
Cohesion: 0.15
Nodes (15): PR — Bug 2 fix: schema-drift reads must not persist a zero snapshot.  Before t, `study_sessions.duration_minutes` does not exist (migration 017     defines onl, test_source_does_not_select_nonexistent_duration_minutes(), _FailingSB, _make_sb(), PR — Bug 2 fix: schema-drift reads must not persist a zero snapshot.  Before t, No sessions today is real, observed state — the daily snapshot     must still b, If `_read_session_minutes` returns READ_FAILED, the compute layer     sets `_re (+7 more)
...
Cohesion: 0.14
Nodes (10): emitAttemptEvent(), getGlobalBus(), emit(), useServerCountdown(), SectionTimer(), attemptEventBus, emitAttemptEvent(), getGlobalBus() (+2 more)
...
Cohesion: 0.18
Nodes (17): baseline_rows(), db_questions(), derive_floor(), essay_reference(), load_papers(), main(), metrics(), _named() (+9 more)
...
Cohesion: 0.2
Nodes (18): GET ``serpapi.com/search`` and return the parsed JSON payload.      SerpApi ha, Run an ``engine=google_jobs`` search and return typed job leads.      For corp, Run an ``engine=google`` search and return typed organic web leads.      For g, _request(), _require_api_key(), search_google_jobs(), search_google_web(), _load() (+10 more)
...
Cohesion: 0.14
Nodes (17): allocation_targets(), _base(), _num(), Regulatory shared-core overlap — the substrate for the combined multi-exam Stud, Split ``total`` task slots into shared_core / target_delta / current_affairs, _base(), _num(), Regulatory shared-core overlap — the substrate for the combined multi-exam Stud (+9 more)
...
Cohesion: 0.15
Nodes (16): _cached_policy_update_context(), _load_policy_update_context(), Return the ``policy_update_context`` block.      Verified official updates may, Return the ``policy_update_context`` block.      Verified official updates may, test_policy_update_context_empty_without_exam(), test_policy_update_context_splits_official_and_discovery(), _discovery_payload(), empty_policy_update_context() (+8 more)

### Community 917 - "Community 917"
Cohesion: 0.14
Nodes (6): Migrations 299 + 300 contract (CA-RSS-03).  Text-assertion style (matching the, _seed_block(), test_every_seed_has_the_contracted_shape(), test_migration_numbers_are_unused_by_any_other_file(), test_seeds_are_idempotent_on_rss_url(), test_the_hindu_is_discovery_only()

### Community 918 - "Community 918"
Cohesion: 0.16
Nodes (15): _handle_english_writing(), _handle_timed_practice(), _handle_topic_pyq(), _handle_weekly_current_affairs(), _launch_english(), _launch_topic_pyq(), Subject Practice Hub — server-owned practice launch orchestrator.  POST /api/s, StartSubjectPracticeRequest (+7 more)

### Community 919 - "Community 919"
Cohesion: 0.15
Nodes (17): _chunked(), _exam_phase_rows(), _in_scope_section_ids(), _load_locked_coverage_checked(), load_scoped_coverage_checked(), _num(), _paginate_all(), Read every row for *build_query* by range pagination.      Replaces the fixed (+9 more)

### Community 921 - "Community 921"
Cohesion: 0.2
Nodes (16): _build_app(), _get(), _question(), Regression tests for the PYQ Explorer's `phase` filter.  Root cause (found liv, Filtering UPSC CSE by phase=mains returns UPSC's questions, not zero.      Wit, The converse: the other exam's paper must not leak into this result., Three 'mains' phases on one exam -> all three papers are in scope.      Pickin, A slug that matches nothing on this exam must return no rows.      Falling thr (+8 more)

### Community 922 - "Community 922"
Cohesion: 0.15
Nodes (17): has_non_ascii(), question_flags(), Deterministic checks — each produces a NAMED FLAG, never a verdict.      A que, _year_key(), _q(), Identical text in DIFFERENT papers must NOT flag as duplicate., The one option-level signal available offline — MCQ rows only., Mains rows have no options; the flag must not fire on them. (+9 more)

### Community 923 - "Community 923"
Cohesion: 0.15
Nodes (14): PagingStub, A ``Client`` with only ``get`` — enough to exercise ``all_items``.      Built, The bug app/common/pagination.py exists to name: ask for 200, get the     serve, The server's own count ends the walk the moment every row has arrived —     an, A range page over a non-total order can repeat rows. Dedupe on id is     what m, A prefix presented as the data is worse than an error: every caller can     rec, /pyq-options is le=50. Paging it at 200 would 422 before any     termination ru, test_a_backend_that_never_advances_raises_rather_than_returning_a_prefix() (+6 more)

### Community 924 - "Community 924"
Cohesion: 0.21
Nodes (16): _build_app(), _FakeUser, get_optional_user must distinguish missing-header (anon) from invalid-token (401, A present-but-bad token must NOT silently become anonymous (200, None user)., _reset_cache(), test_invalid_token_raises_401_not_anon(), test_no_header_returns_anonymous(), test_valid_token_returns_user() (+8 more)
...
Cohesion: 0.12
Nodes (10): _FailingSB, _make_sb(), _RaisingQuery, No sessions today is real, observed state — the daily snapshot     must still b, If `_read_session_minutes` returns READ_FAILED, the compute layer     sets `_re, Supabase stub whose `study_sessions` table raises like PostgREST     would on a, _session(), test_compute_returns_read_failed_sentinel_propagation() (+2 more)
...
Cohesion: 0.26
Nodes (12): CmsClient, create_mention(), load_mention_index(), load_topic_index(), main(), Pre-load every topic for a subject so lookups don't hit the API per row., resolve_document(), resolve_subject() (+4 more)

### Community 930 - "Community 930"
Cohesion: 0.23
Nodes (16): align(), items_of(), load_db(), load_extract(), load_json(), load_tagged_ids(), main(), near_duplicates() (+8 more)
...
Cohesion: 0.12
Nodes (16): 0. Credentials and scope, 1. Export (read-only), 2. Catalogue (read-only; `--apply` writes the file), 3. P1 — readiness report, BEFORE any generation, 4. P2 — tag and difficulty proposals, 5. Review, 6. P3 — apply (dry run by default), code:bash (export CCP_API_BASE=https://<host>) (+8 more)

### Community 950 - "Community 950"
Cohesion: 0.2
Nodes (16): _enqueue_recompute(), Attach anonymous onboarding progress to a freshly authenticated user.  Pre-log, Same path used by ``PUT /api/profile/me`` and unified onboarding complete., _claim_rows(), _enqueue_recompute(), _existing_onboarding_answer_keys(), _existing_persona_keys(), _fan_out_answers() (+8 more)
...
Cohesion: 0.12
Nodes (5): _client(), PR3b: Syllabus accept (preview + commit) tests.  POST /api/admin/exam-intellig, _TblStub, _client(), PR3b: Syllabus accept (preview + commit) tests.  POST /api/admin/exam-intellig

### Community 954 - "Community 954"
Cohesion: 0.18
Nodes (12): _fake(), FakeSupabase, _import_create_session(), _prompt_row(), _Rpc, test_create_session_allows_applicable_prompt(), test_create_session_no_task_allows_global_prompt(), test_create_session_no_task_denies_scoped_prompt() (+4 more)
...
Cohesion: 0.23
Nodes (15): apply_registry_action(), Apply a verified corrigendum / lifecycle event to the exam registry.      This, apply_cycle_date_update(), apply_phase_date_update(), apply_policy_update_create(), apply_policy_update_edit(), _audit(), _now_iso() (+7 more)

### Community 962 - "Community 962"
Cohesion: 0.24
Nodes (15): index(), _meta(), paper_id_from_subject_slug(), paper_label(), paper_number(), paper_sort(), _papers_by_id(), place() (+7 more)

### Community 963 - "Community 963"
Cohesion: 0.15
Nodes (14): compute_evidence_key(), derive_issue_evidence(), derive_review_correction_evidence(), derive_unit_evidence(), EvidenceRow, One derived mastery evidence unit.      Fields are the union of columns the ma, Column dict for ``user_topic_mastery_evidence`` (§4.12).          Includes ``e, Column dict for ``writing_mastery_shadow`` (§10.1a).          Includes ``delta (+6 more)
...
Cohesion: 0.13
Nodes (7): _FakeSB, _FakeTable, _make_sb(), _R, The old no_action overwrite must be gone — recommended_action is read-only here., test_reject_does_not_overwrite_recommended_action(), test_reject_persists_reason_to_rejection_notes()

### Community 967 - "Community 967"
Cohesion: 0.27
Nodes (14): _client(), _post(), CMS write contract for `essay_pyq_tags.format` (migration 304).  `essay_pyq_ta, The RBI English worksheet is essay 16 / precis 4 / comprehension 4.      One p, The G4 regression: a precis has no essay type, and must not acquire one., _seed(), test_comprehension_row_is_written_without_essay_type(), test_essay_format_requires_an_essay_type() (+6 more)

### Community 968 - "Community 968"
Cohesion: 0.21
Nodes (14): catalogue_from_export(), catalogue_from_syllabus(), egm_staging(), essay_catalogue(), main(), merge_human(), propose(), rank() (+6 more)

### Community 969 - "Community 969"
Cohesion: 0.23
Nodes (13): CappingSB, _CapQuery, _build_app(), _CeilingCappingSB, _CeilingCapQuery, Pagination + IN()-batching regression for admin_exam_intelligence.list_items., CappingSB query that also rejects an oversized IN(), like the live proxy     re, One exam/paper with `n` questions, each carrying one pending essay tag.     n i (+5 more)

### Community 970 - "Community 970"
Cohesion: 0.13
Nodes (6): CountingSBStub, _RaisingQuery, _RangeQuery, Counts table() calls, to prove reads don't scale per-exam., A _Query that honours .range() by slicing ordered results., A query whose builder methods are no-ops and whose execute() raises.
...
Cohesion: 0.12
Nodes (7): seedRing(), eventBus, bus, { events }, marker, p, sizes
...
Cohesion: 0.12
Nodes (15): Acceptance cases, Atomic audit requirement, Backend authority and classifier integration, code:text (cycle_details), code:text (source_format_unprocessable), code:text (pending), code:text (waiver row or lifecycle transition), code:text (planner_effect = none) (+7 more)
...
Cohesion: 0.12
Nodes (15): 1. `docs/status/2026-09-12-mains-optionals-strategy-rev4.md`, 2. `docs/status/2026-09-12-thematic-corpus-defects.md`, 3. Update `docs/status/2026-09-12-optionals-publication-defects.md`, CONSTRAINTS, DOC-THEMATIC-01 — write up the thematic corpus session, OUTPUT, PRIMING, The gap nobody had named (+7 more)

### Community 983 - "Community 983"
Cohesion: 0.12
Nodes (6): _CSQuery, _CSRpc, Adds ilike / range / count='exact' on the read path (like _MngQuery)., Records the call and returns a canned success dict, or raises a canned     exce, test_rubrics_feed_bounded_to_limit(), test_topics_feed_bounded_to_limit()

### Community 984 - "Community 984"
Cohesion: 0.33
Nodes (14): Read-only shared-core overlap for the user's active regulatory target     exams, summarize_regulatory_overlap(), _cov(), Tests for the regulatory shared-core overlap model (Lane R R2, increment 1)., _SB, _tables(), test_canonical_sources_and_shared_core_and_scope(), test_coverage_read_failure_is_unavailable_not_partial() (+6 more)
...
Cohesion: 0.13
Nodes (15): _improvement_lab_feed(), improvement_lab_quant(), improvement_lab_reasoning(), Owner-scoped, bounded, verified-only strategy feed for one subject (GQR-S6)., Owner-scoped, bounded, verified-only strategy feed for one subject (GQR-S6)., Methods & Shortcuts — personalized, verified-only Quant strategy feed (GQR-S6)., Methods & Shortcuts — personalized, verified-only Quant strategy feed (GQR-S6)., Approaches & Patterns — personalized, verified-only Reasoning strategy feed (GQR (+7 more)

### Community 990 - "Community 990"
Cohesion: 0.13
Nodes (15): get_plan_changelog(), put_plan_prefs(), Update the user's plan preferences — the weighting focus, plan-shape     overri, Update the user's plan preferences — the weighting focus, plan-shape     overri, Update the user's plan preferences — the weighting focus, plan-shape     overri, Update the user's plan preferences — the weighting focus, plan-shape     overri, Recent study_adaptation_events for the user's active plan., Recent study_adaptation_events for the user's active plan. (+7 more)
...
Cohesion: 0.16
Nodes (8): order_pro(), End-to-end backend tests for Razorpay subscription / payment flow.  Hits the p, admin_token(), normal_user(), End-to-end backend tests for Razorpay subscription / payment flow.  Hits the p, Create a fresh non-admin user and return (token, email, user_id)., _supabase_admin_create_user(), _supabase_signin()

### Community 1000 - "Community 1000"
Cohesion: 0.22
Nodes (14): _corpus(), PRED-01 — predictability as computed and written by the snapshot job.  The mea, Same three asks in both papers; sociology's shorter span makes them     count f, Predictability is a separate axis, not a term in the ranking. The     published, G4. Without this, the first recompute after this change would match every     e, A topic carried by locked coverage alone has no years behind it. NULL is     th, Two subject-papers with DIFFERENT evidence spans, so the per-paper Y is     act, _snapshots() (+6 more)
...
Cohesion: 0.29
Nodes (15): readEnv(), globalSetup(), makeApi(), ensureProjectedPyqPool(), ensureSeededUser(), getAccessToken(), ensureAdminProfileRow(), ensureAdminUser() (+7 more)

### Community 1004 - "Community 1004"
Cohesion: 0.14
Nodes (13): countdown, detail, mockDel, mockGet, mockPost, mockPut, notes, panel (+5 more)
...
Cohesion: 0.13
Nodes (14): 1. Plain dry run (default mode), 2. Replay dry run (canned model output through the real validator + lint), Answer structures — sample dry-run output, code:block1 (python scripts/generate_answer_structures.py \), code:block2 (Question:), code:block3 (Question:), code:block4 (Question:), code:block5 (python scripts/generate_answer_structures.py \) (+6 more)
...
Cohesion: 0.13
Nodes (14): code:block1 (public.user_exam_electives), code:block2 (alter table public.exam_phase_sections), Explorer card count — worse than the brief assumed, OPT-CHOICE-01 — the chosen optional, answered, Q1 — Where does the choice live?, Q2 — Can it change mid-preparation, and what happens to progress?, Q3 — Do the other optionals disappear, or stay browsable?, Q4 — Does GS stay unfiltered while optionals are filtered? (+6 more)
...
Cohesion: 0.13
Nodes (14): 1. Parents (4) — one per paper, all `question_number = 1`, 2. Child numbering — per paper, 301–304, 3. Child field values, 4. Parent update (4 rows), 5. Prompt text source, 6. POST route, 7. Known failure modes (from the 2022 UPSC Essay load), 8. Verification after load (+6 more)

### Community 1021 - "Community 1021"
Cohesion: 0.13
Nodes (14): 1. Stimulus groups, 2. DEFECT rows, 3. Low-confidence rows, with reasons, 4.1 Atal Vayo — locked routing not followed, 4.2 PMSBY — the locked routing costs precision, 4. Two decisions a reviewer should look at, 5.1 The six new microtopics are not resolvable, 5.2 ESI topics carry no level (+6 more)
...
Cohesion: 0.14
Nodes (11): Health, Career Copilot backend (Phase 1.5).  Authentication is delegated to Supabase A, # NOTE: community_people_router was removed — every route under that prefix, # NOTE: community_people_router was removed — every route under that prefix, # NOTE: community_people_router was removed — every route under that prefix, DbHealth, Health, _load_required_router() (+3 more)

### Community 1029 - "Community 1029"
Cohesion: 0.27
Nodes (13): Study OS — leaderboard build (PR 4 + PR 11).  Builds opt-in leaderboard rows., build_group_leaderboard(), build_leaderboard(), _percentile_rank(), _rank_band(), Study OS — leaderboard build (PR 4 + PR 11).  Builds opt-in leaderboard rows., Build leaderboard rows for one cohort/metric window. Returns counts., Read the latest leaderboard rows the caller is allowed to see.      RLS does t (+5 more)
...
Cohesion: 0.16
Nodes (13): list_score_snapshots(), Versioned exam-topic score snapshot writer and reader.  Computes draft ``exam_, _build_fingerprint(), _chunks(), list_exam_score_snapshots(), _paginate(), Versioned exam-topic score snapshot writer and reader.  Computes draft ``exam_, Split *lst* into chunks of at most *n* items each. (+5 more)

### Community 1032 - "Community 1032"
Cohesion: 0.19
Nodes (12): language_mismatch(), _parse_common_formats(), _parse_iso8601(), _parse_offset(), parse_published_at(), _parse_rfc2822(), Current-affairs source adapters + document pre-filter.  The source rows live i, Per-source User-Agent override from ``adapter_config.user_agent``.      ``None (+4 more)
...
Cohesion: 0.22
Nodes (10): TemplateValidationError, _validate_selector(), TemplateValidationError, _validate_selector(), test_validate_selector_criteria_mix_invalid_sum(), test_validate_selector_criteria_mix_sum(), test_validate_selector_fixed_count_must_match(), test_validate_selector_criteria_mix_invalid_sum() (+2 more)

### Community 1037 - "Community 1037"
Cohesion: 0.19
Nodes (8): _draft(), D1 fix: when one (category, topic) already exists, the other keys         still, Non-null-topic duplicate triggers ON CONFLICT DO NOTHING; no new row inserted., D5 fix: an unrelated RPC error must propagate, not be swallowed., D1 fix: N drafts produce ONE RPC call, not N separate calls., D2 fix: ensure_mock_correction_drafts rejects a wrong user_id., RPC path persists every unique (category, topic) key from the draft list., _seed_generated()

### Community 1038 - "Community 1038"
Cohesion: 0.21
Nodes (13): Deterministic English-writing task generation for the planner (EWP-5, §11).  T, build_writing_tasks(), _english_subject_id(), Deterministic English-writing task generation for the planner (EWP-5, §11).  T, Deterministic ``why_this_task`` for a generated writing task., Emit ``english_writing_session`` task dicts for writing-eligible topics., The ``english-language`` subject id (migration 205 seed), or None.      Writin, Runtime-ready exercise types. DB function authoritative; constant fallback. (+5 more)

### Community 1039 - "Community 1039"
Cohesion: 0.15
Nodes (14): exam_matches_query(), exam_search_haystack(), _normalize_search_text(), Lowercase, flatten ``-``/``_`` to spaces, collapse runs of whitespace., Searchable text for one exam row.      Mirrors ``examSearchHaystack`` in, Whether *exam* matches the free-text *query*.      The QUERY is normalized the, Lowercase, flatten ``-``/``_`` to spaces, collapse runs of whitespace., Lowercase, flatten ``-``/``_`` to spaces, collapse runs of whitespace. (+6 more)
...
Cohesion: 0.15
Nodes (14): analytics(), _empty_analytics(), _mean(), Advisory writing time for a question, or ``None`` when marks are unknown., Advisory writing time for a question, or ``None`` when marks are unknown., The Monday of the ISO week this timestamp falls in, as YYYY-MM-DD., The average, or None over nothing. Never 0 for an empty list., Mean score per rubric criterion, over the attempts that scored it. (+6 more)

### Community 1045 - "Community 1045"
Cohesion: 0.23
Nodes (11): The sort_order backfill's planning, which is where it can be wrong.  The order, More than one position for the same name is an ambiguity, not a tie., Idempotent: a row already carrying the right sort_order is not touched., _row(), _slug_for(), test_a_microtopic_gets_its_position_within_its_section(), test_a_name_that_appears_twice_in_one_paper_is_skipped(), test_a_section_gets_the_order_the_syllabus_states() (+3 more)

### Community 1046 - "Community 1046"
Cohesion: 0.22
Nodes (7): formatOptionLabel(), positionalLabel(), resolveOptionLabel(), label, formatOptionLabel(), positionalLabel(), resolveOptionLabel()

### Community 1047 - "Community 1047"
Cohesion: 0.14
Nodes (7): statuses, onCancel, onExpire, onViolation, qs, t0, t1
...
Cohesion: 0.14
Nodes (13): Bands, because a number is not advice, code:block1 (breadth      = distinct_years_asked / Y), Decay is rare — so recency should carry little weight, Open, Predictability: a difficulty axis that works for descriptive papers, Recurrence is broadly distributed — so it discriminates, Regularity is a separate, real property, Sequence (+5 more)
...
Cohesion: 0.14
Nodes (13): Document registration — what the flow actually requires, Findings about the data, Live bugs found, No retry endpoint, despite the error saying otherwise, Operational notes, Optionals corpus — publication session, defects and findings (2026-09-11/12), Review gates — what each one actually is, Six PDFs against sixteen papers (+5 more)
...
Cohesion: 0.14
Nodes (13): Artefacts, Cannot be resolved without sourcing, Downstream — everything below was computed over this corpus, Finding, Hypotheses tested and rejected, Known limitation — the confidence gate, Method, and why the verdicts are trustworthy, Next steps (+5 more)

### Community 1069 - "Community 1069"
Cohesion: 0.14
Nodes (13): 1. Extraction quality per paper, 2026 counts by paper, 2. DB source rows vs the now-available official papers, 3. UnlockIAS extraction vs the same official papers (trust test), 4. 2026 - UnlockIAS only (the DB holds no 2026 Mains paper), 5. repair_worklist.csv update, Counts by year, Counts by year and paper (+5 more)
...
Cohesion: 0.24
Nodes (13): Claim + fan out anonymous progress for ``user_id``; idempotent., stitch_anonymous_sessions(), Anonymous → authenticated session stitching tests., test_stitch_attaches_sessions_to_user_id(), test_stitch_does_not_duplicate_existing_persona_answers(), test_stitch_fans_persona_answers_into_persona_table(), test_stitch_is_noop_without_anonymous_id(), _world() (+5 more)
...
Cohesion: 0.15
Nodes (13): _enrich_snapshot_topics(), list_score_snapshots(), Attach topic_name, topic_path, subject_name and subject_group to each     snaps, Attach topic_name, topic_path, subject_name and subject_group to each     snaps, List ``exam_topic_score_snapshots`` rows for an exam, ordered by computed_at DES, List ``exam_topic_score_snapshots`` rows for an exam, ordered by computed_at DES, Attach topic_name, topic_path, subject_name and subject_group to each     snaps, List ``exam_topic_score_snapshots`` rows for an exam, ordered by computed_at DES (+5 more)

### Community 1079 - "Community 1079"
Cohesion: 0.31
Nodes (12): _build_app(), Verify the CMS write path auto-fills normalized_*_hash columns.  The full CMS, _seed(), test_create_pyq_option_autofills_hash_when_omitted(), test_create_pyq_option_respects_caller_supplied_hash(), test_create_pyq_question_autofills_question_and_option_hashes(), _build_app(), Verify the CMS write path auto-fills normalized_*_hash columns.  The full CMS (+4 more)
...
Cohesion: 0.15
Nodes (3): _RaisingQuery, _RangeQuery, _Seed
...
Cohesion: 0.23
Nodes (9): AntiCheatProvider(), useCopyPasteSuppression(), useFullscreen(), useVisibility(), AntiCheatContext, AntiCheatProvider(), useCopyPasteSuppression(), useFullscreen() (+1 more)
...
Cohesion: 0.15
Nodes (12): code:python (# app/backend/app/exam_intelligence/coverage_derivation.py:6), code:python (# app/backend/app/exam_intelligence/coverage_derivation.py:1), code:sql (select t.id,), code:python (# app/backend/app/exam_intelligence/score_snapshots.py:513), code:sql (select s.slug,), COV-GAP-01 — PSIR Paper-I's 27 unscored coverage rows, G1 — Identify the 27 topics; are they macro topics?, G2 — Does each half of the pipeline behave as the gap requires? (+4 more)
...
Cohesion: 0.15
Nodes (12): Agriculture — `ask_record` (high), Applied Ethics and Case Studies — `ask_record` (high), Environment, Ecology and Bio-diversity — `frequency_chart` (medium), Human Values — Contributions of Moral Thinkers and Administrative Thinkers — `ask_record` (medium), Indian Culture — `frequency_chart` (low), Indian Society — `ask_record` (high), International Relations — `ask_record` (high), Medieval India — `roadmap` (low) (+4 more)

### Community 1116 - "Community 1116"
Cohesion: 0.15
Nodes (12): code:block1 (breadth    = distinct_years_asked / Y), code:block2 (percentile < 0.10  -> near_certain), DECISIONS, ALREADY MADE — implement, do not relitigate, GOTCHAS, each already paid for, OUT OF SCOPE, OUTPUT, PRED-01 — implement predictability on score snapshots and coverage, PREFLIGHT — STOP gates (+4 more)

### Community 1117 - "Community 1117"
Cohesion: 0.15
Nodes (12): BLAST RADIUS, Candidate directions, not prescriptions, code:block1 ({"evidence_quality": 1, "coverage_component": 0, "frequency_), Decisions, locked, OUT OF SCOPE, OUTPUT / PUBLICATION, PREFLIGHT — STOP gates, PRIMING (+4 more)
...
Cohesion: 0.36
Nodes (12): Read-only shared-core overlap for the user's active regulatory target     exams, summarize_regulatory_overlap(), _cov(), _SB, _tables(), test_canonical_sources_and_shared_core_and_scope(), test_coverage_read_failure_is_unavailable_not_partial(), test_fewer_than_two_regulatory_exams_is_insufficient_zero_allocation() (+4 more)
...
Cohesion: 0.21
Nodes (11): get_option_insights(), Aspirant-facing trap-awareness + elimination-heuristic tips.      Reads the ma, Aspirant-facing trap-awareness + elimination-heuristic tips.      Reads the ma, _distractor_tip(), _elimination_tip(), option_insights(), Aspirant-facing reader for option-level analytics rollups.  Reads from the mat, Return the aspirant-shaped option-insights payload for one exam.      Reads on (+3 more)
...
Cohesion: 0.29
Nodes (10): build_parser(), _emitter(), main(), mode_of(), A ModelCall that returns the canned structure for the current question.     No, The loop, with every side effect injected. Returns a summary., read_done(), read_questions_file() (+2 more)
...
Cohesion: 0.17
Nodes (11): (a) Chunk-port: same matcher, unchanged — UNRELIABLE on OCR, (b) Full-text OCR scoring — distribution by text-layer ground truth, Does 85 separate long-form as cleanly as short-form?, Full per-question comparison, Full-text OCR outcome vs text-layer outcome, Length-stratified full-text scores (short vs long), Long-form orphan population — 2013 GS4 fabricated case studies, OCR extraction inventory (+3 more)
...
Cohesion: 0.17
Nodes (11): 1. Format axis (primary), 2. E1 split convention (essay rows only), 3. How precis/comprehension theming differs from essay theming, 4. Theme distribution, 5. Codes used / never fired, 6. Where the catalogue strains for RBI (drives the 5 low-confidence rows), 7.1 Resolution (added after this section was written), 7. Gap between this scheme and live `essay_pyq_tags` (+3 more)
...
Cohesion: 0.17
Nodes (9): _blueprint_row(), Tests for the multi-exam-coverage subcommand of shadow_analysis.py., Build a mock_generated_blueprints row., DB failure on mock_mastery_shadow table → ERROR., TestMultiExamCoverageNoData, _blueprint_row(), _Exec, Tests for the multi-exam-coverage subcommand of shadow_analysis.py. (+1 more)
...
Cohesion: 0.18
Nodes (11): _derive(), test_derived_key_stable_and_changes_with_exercise_type(), test_derived_row_fields_and_key(), test_non_terminal_status_returns_none(), test_recognition_never_emitted_by_writing_path(), test_source_type_derived_from_exercise(), test_terminal_partial_yields_evidence(), test_tier_correction() (+3 more)
...
Cohesion: 0.27
Nodes (4): PermissionError, Actor lacks the required permission for this action., Supabase Storage, with the bucket policy actually applied.      The real polic, Storage
...
Cohesion: 0.25
Nodes (6): q(), Proposal contract for ``scripts/propose_gs_insert_tags.py``: offline, determini, test_essay_without_a_theme_export_is_unmapped(), test_no_overlap_is_unmapped(), test_proposal_row_is_a_proposal_only(), test_rerun_keeps_reviewer_columns()

### Community 1178 - "Community 1178"
Cohesion: 0.35
Nodes (11): _create(), _drive_to_completed(), _psql(), active -> (all units submitted) evaluation_pending sets submitted_at., past-drafting -> active (learning-mode reopen) clears submitted_at back to NULL., past-drafting -> past-drafting preserves the existing submitted_at     (monoton, _scalar(), _submit() (+3 more)
...
Cohesion: 0.18
Nodes (8): chip, mockDel, mockGet, mockPost, mockPut, notReady, primary, secondary
...
Cohesion: 0.35
Nodes (10): classify_full(), fuzz_full(), get_ocr_text(), _hist(), main(), _num(), ocr_paper(), _pct() (+2 more)
...
Cohesion: 0.18
Nodes (10): How this was measured, Least examined — 25 topics, Least examined — 6 topics, Paper I, Paper II, Strong second tier — 16 topics, Strong second tier — 29 topics, The 12 topics you cannot skip (+2 more)

### Community 1198 - "Community 1198"
Cohesion: 0.18
Nodes (10): How this was measured, Least examined — 18 topics, Least examined — 20 topics, Paper I, Paper II, Strong second tier — 20 topics, Strong second tier — 20 topics, The 8 topics you cannot skip (+2 more)

### Community 1199 - "Community 1199"
Cohesion: 0.18
Nodes (10): How this was measured, Least examined — 26 topics, Least examined — 31 topics, Paper I, Paper II, Strong second tier — 27 topics, Strong second tier — 32 topics, The 11 topics you cannot skip (+2 more)

### Community 1200 - "Community 1200"
Cohesion: 0.18
Nodes (10): How this was measured, Least examined — 15 topics, Least examined — 20 topics, Paper I, Paper II, Strong second tier — 23 topics, Strong second tier — 25 topics, The 11 topics you cannot skip (+2 more)

### Community 1201 - "Community 1201"
Cohesion: 0.18
Nodes (10): How this was measured, Least examined — 15 topics, Least examined — 9 topics, Paper I, Paper II, Strong second tier — 18 topics, Strong second tier — 19 topics, The 8 topics you cannot skip (+2 more)

### Community 1202 - "Community 1202"
Cohesion: 0.18
Nodes (10): How this was measured, Least examined — 2 topics, Least examined — 8 topics, Paper I, Paper II, Strong second tier — 12 topics, Strong second tier — 15 topics, The 5 topics you cannot skip (+2 more)
...
Cohesion: 0.18
Nodes (10): Artefact type follows topic SHAPE, not subject, Bring to the session, Handoff — study artefacts for aspirants, Platform state this session left behind, The framing that makes this tractable, The honest constraint, Useful context, briefly, What you are starting from (+2 more)
...
Cohesion: 0.18
Nodes (10): 1. Why a rule was needed before any more classifying, 2. The rule, 3. The reading adopted: perishable is narrow, 4. Known gap — flagged, not solved, 5. Scope boundaries, 6. Not covered by this document, GA perishability boundary rule — v1, T1 — Is the answer a specific dated event or announcement? (+2 more)

### Community 1219 - "Community 1219"
Cohesion: 0.18
Nodes (10): 1. Where does the choice live?, 2. Can it change mid-preparation, and what happens to progress?, 3. Do the other eleven disappear, or stay browsable?, 4. Does GS stay unfiltered while optionals are filtered?, OPT-CHOICE-01 — "my optional": the missing product concept, THE FOUR QUESTIONS, THE SITUATION, WHAT IS ALREADY IN PLACE (+2 more)
...
Cohesion: 0.27
Nodes (5): compute_proposal_key(), Deterministic identity hash for a proposal.      sha256(syllabus_document_id|t, Deterministic identity hash for a proposal.      sha256(syllabus_document_id|t, Pin the exact SHA-256 output to catch any Python↔JS divergence., TestProposalKey
...
Cohesion: 0.2
Nodes (10): _bootstrap_mock_publishers(), lifespan(), Grant mock_questions:publish permission to emails in MOCK_PUBLISHER_BOOTSTRAP_EM, Grant mock_questions:publish permission to emails in MOCK_PUBLISHER_BOOTSTRAP_EM, Grant mock_questions:publish permission to emails in MOCK_PUBLISHER_BOOTSTRAP_EM, ``ENABLE_SCHEDULER`` gates the in-process APScheduler.      Default ``false``, ``ENABLE_SCHEDULER`` gates the in-process APScheduler.      Default ``false``, ``ENABLE_SCHEDULER`` gates the in-process APScheduler.      Default ``false`` (+2 more)

### Community 1229 - "Community 1229"
Cohesion: 0.38
Nodes (9): _now_iso(), _already_exists_today(), _candidate_from_recommendation(), _day_bucket(), _dedupe_key(), generate_next_actions_for_user(), _load_preferences(), _now_iso() (+1 more)

### Community 1230 - "Community 1230"
Cohesion: 0.24
Nodes (9): MergeClaimConsumeBody, Anonymous → permanent profile merge claims.  The v2 onboarding flow writes a g, consume_merge_claim(), create_merge_claim(), _hash_token(), MergeClaimConsumeBody, Anonymous → permanent profile merge claims.  The v2 onboarding flow writes a g, Mint a single-use merge token for the calling anonymous profile. (+1 more)
...
Cohesion: 0.2
Nodes (10): _paginate(), Call *call()*, return *default* on any exception, logging the error., Call *call()*, return *default* on any exception, logging the error., Call *call()*, return *default* on any exception, logging the error., Call *call()*, return *default* on any exception, logging the error., Fetch all rows using range-based pagination.      *build_query(from_n, to_n)*, Fetch every row of a read using ordered, verified range pagination.      ``bui, Fetch every row of a read using ordered, verified range pagination.      ``bui (+2 more)
...
Cohesion: 0.24
Nodes (6): MCQSingle(), resolveCorrectOption(), MCQSingle(), resolveCorrectOption(), el, OPTIONS
...
Cohesion: 0.36
Nodes (9): answer_orphans(), _dist(), get_ocr_text(), main(), ocr_paper(), Orphans in 2018-2025: phase-2 OCR years in range + text-layer 2022/2024/2025., (year,paper) -> full raw path, filename-classified, for the nine years., raw_map() (+1 more)
...
Cohesion: 0.2
Nodes (9): 1. RBI-GA-DURABLE-tags-v3.csv (203 rows), 2. RBI-P2-DESCRIPTIVE-TOPICAL-tags-v2.csv (48 rows), 3. GK section count, 4. Validation, Macro assignments (10 rows at subject level; all 10 assigned), Normalised matches, Subject moves (2), Topic-id resolution report (+1 more)
...
Cohesion: 0.22
Nodes (8): jsonResponse(), a, b, fetchMock, Safety net for any endpoint that didn't wrap a Supabase transport     disconnec, transient_transport_handler(), unhandled_exception_handler(), test_server_transient_handler_returns_503()
...
Cohesion: 0.31
Nodes (7): parseValue(), enrich(), gs4_section(), main(), parse(), Add GS4 section A/B, paper-local numbering, refs, global numbers., GS-IV has Section A (theory) and Section B (case studies).      Two numbering
...
Cohesion: 0.44
Nodes (7): _build_app(), Essay-PYQ-tag review via the generic exam-intelligence review surface.  `essay, _seed(), test_invalid_status_is_rejected_like_the_topic_tag_analog(), test_list_pending_essay_pyq_tags_returns_real_rows_scoped_to_exam(), test_review_blocked_for_non_admin(), test_review_promotes_pending_tag_to_verified_and_read_reflects_it()

### Community 1283 - "Community 1283"
Cohesion: 0.25
Nodes (6): _attempt(), Db, _paper(), The P0.5 rule, on this surface: 320 attempts against a 19-row cap., test_a_history_longer_than_the_server_cap_is_still_complete(), test_an_attempt_predating_answer_mode_reads_typed()
...
Cohesion: 0.22
Nodes (7): { container }, MOCK_TREND, mockDel, mockGet, mockPost, mockPut, title

### Community 1288 - "Community 1288"
Cohesion: 0.22
Nodes (5): mockDel, mockGet, mockPost, mockPut, now
...
Cohesion: 0.22
Nodes (8): code:block1 (POST {CCP_API_BASE}/api/admin/exam-intelligence/exams/{exam_), code:block2 (POST {CCP_API_BASE}/api/admin/exam-intelligence/exams/{exam_), Out of scope, Preconditions, Rollback, Runbook: consolidate UPSC Mains coverage onto the plannable phase (COV-PHASE-01), Steps, Why
...
Cohesion: 0.22
Nodes (8): Counts by year and verdict (GS in scope), Essay questions (parsed, counted, not in CSV), Excluded from GS scope, GS coverage of readable+classified raw, GS source reconciliation — summary, Raw-file inventory (year / paper identification + readability), Source JSON files not parseable / unrecognised, Years appearing in source JSONs with NO readable+classified raw (all such questions are `unverifiable`)
...
Cohesion: 0.29
Nodes (7): close_pool(), close_pool(), get_pool(), stop_scheduler(), lifespan(), ``ENABLE_SCHEDULER`` gates the in-process APScheduler.      Default ``false``, _scheduler_enabled()

### Community 1340 - "Community 1340"
Cohesion: 0.46
Nodes (7): Study OS — per-exam daily snapshot aggregation (PR 2).  Where `study_behavior_, _accumulate(), compute_exam_snapshots(), _exam_weights(), Study OS — per-exam daily snapshot aggregation (PR 2).  Where `study_behavior_, _safe(), upsert_exam_snapshots()
...
Cohesion: 0.5
Nodes (8): _compute_commercial(), _compute_outcome(), _compute_quality(), _compute_trust(), recompute(), _safe_count(), _safe_count_range(), _upsert()
...
Cohesion: 0.29
Nodes (8): _looks_like_pdf(), path_allowed(), path_excluded_reason(), _path_of(), path_section(), The first two path segments of ``canonical_url`` (``/a/b``).      Used as the, Whether this item's path is inside the publisher's allow-list.      A publishe, The ``publisher_path_excluded:<section>`` reason, or ``None`` when allowed.
...
Cohesion: 0.25
Nodes (8): _large_pyq_db(), One verified paper carrying ``n`` verified questions, each primary-tagged     t, The exam's true verified-question total exceeds one server page. A single     u, The bug was three endpoints reporting three different verified counts for     o, The exam's true verified-question total exceeds one server page. A single     u, The bug was three endpoints reporting three different verified counts for     o, test_all_three_sources_agree_on_verified_count(), test_pyq_summary_totals_survive_server_row_cap()
...
Cohesion: 0.39
Nodes (7): main(), method_for(), plan_stamps(), How this question's paper was decided, or None when nothing explains it., (writes, unexplained) — the stamp each moved row should carry.      A row alre, run(), summarise()

### Community 1352 - "Community 1352"
Cohesion: 0.39
Nodes (7): build(), main(), paper_label(), paper_sort_key(), GS_1" -> "GS1"; "opt-anthropology-p1" -> "P1".      The label a chip carries., {papers: [...], themes: {theme name -> placement}} from the source files., serialise()
...
Cohesion: 0.25
Nodes (7): Answer structures, API, Data (migration 303), Generation rules, Justification for an AI-drafted write path, Surfaces, Why
...
Cohesion: 0.25
Nodes (7): Carried forward (182), Catalogues used for id resolution, Counts, Newly tagged (21), RBI GA durable worksheet — v1 → v2 delta, The 12 formerly disputed rows, decided by v2, Withdrawn (9): now PERISHABLE under v2, T1 in every case
...
Cohesion: 0.33
Nodes (6): _chunks(), _paginate(), Verified-only coverage / PYQ aggregates.  Reads ``exam_topic_coverage`` joined, Fetch all rows using range-based pagination.      Stops at the first page that, _safe(), Locked-only coverage / PYQ aggregates.  Reads ``exam_topic_coverage`` joined w

### Community 1413 - "Community 1413"
Cohesion: 0.38
Nodes (6): Question registry helpers.  `persona_question_bank` is the source of truth for, get_question(), latest_question_answers(), Question registry helpers.  `persona_question_bank` is the source of truth for, Return a {question_key: latest_answer_row} map for ``user_id``.      The perso, _safe()
...
Cohesion: 0.29
Nodes (7): _fetch_recent_study_sessions(), _focus_summary(), _iso_days_ago(), Read the user's last 7 days of study sessions.      Single source of truth for, Read the user's last 7 days of study sessions.      Single source of truth for, Legacy sync entrypoint — fetch + shape., Legacy sync entrypoint — fetch + shape.

### Community 1416 - "Community 1416"
Cohesion: 0.43
Nodes (6): late_papers(), main(), (year, paper) -> cached-OCR metrics, for papers the re-gate admitted., (year, paper) -> cached-OCR metrics, for the late-classified papers., relaxed_papers(), report()

### Community 1417 - "Community 1417"
Cohesion: 0.48
Nodes (6): effective(), main(), phase2_scored_papers(), (year, paper) -> cached-OCR metrics, for the papers phase 2 scored.      Groun, First non-empty verdict along a precedence chain, with its source column., report()
...
Cohesion: 0.29
Nodes (7): _attempt_facets(), _attempt_matches(), list_attempts(), This user's attempt history, newest first., Whether one enriched history row survives the surface's filters.      Applied, The filter values that actually occur in this history.      Built from the asp, This user's answer history, newest first, with the filters applied.      EVERY
...
Cohesion: 0.29
Nodes (4): humanFieldList(), ExamRow(), FIELD_LABELS, streamNote()

### Community 1428 - "Community 1428"
Cohesion: 0.29
Nodes (4): mockDel, mockGet, mockPost, mockPut
...
Cohesion: 0.48
Nodes (6): ascii_only(), extract_docx_questions(), load_unlockias(), main(), Return [(qno, raw_ascii, norm)] or None if the DOCX cannot be parsed., write_md()
...
Cohesion: 0.29
Nodes (6): CMS write path, Governance invariants, Importing third-party (e.g. coaching) explanation reference material, Model, PYQ Question Explanations, Why a separate table
...
Cohesion: 0.29
Nodes (6): OCR extraction inventory + confidence, OCR reconciliation — Phase 2 (nine scan-only years), Orphans in 2018-2025, Overall score distribution (scored rows), Verdict counts by year (all papers), Verdict counts by year and paper

### Community 1461 - "Community 1461"
Cohesion: 0.29
Nodes (6): 1. Why the raw-token gate was the wrong measure, 2. Deriving the new floor, 3. Gate status per paper, 4. DB rows re-scored under the relaxed gate, 5. Per-year totals, with and without the relaxed rows, OCR re-gate - post-strip English word floor
...
Cohesion: 0.29
Nodes (7): _clean_set(), mastery_reuse(), partition_topics(), Split the union of the exams' COMMON locked topics into shared-core vs     per-, Shared-core topics the user has mastered GLOBALLY — reuse instead of     re-pla, test_mastery_reuse_only_shared_and_global(), test_partition_shared_vs_delta()
...
Cohesion: 0.33
Nodes (6): Safety net for any endpoint that didn't wrap a Supabase transport     disconnec, Safety net for any endpoint that didn't wrap a Supabase transport     disconnec, Safety net for any endpoint that didn't wrap a Supabase transport     disconnec, transient_transport_handler(), unhandled_exception_handler(), jsonResponse()

### Community 1472 - "Community 1472"
Cohesion: 0.33
Nodes (6): derive_rates(), Return ``(selection_rate, candidates_per_vacancy)``.      ``selection_rate`` =, test_derive_rates_computes_both_directions(), test_derive_rates_null_on_zero_or_negative(), test_derive_rates_null_when_denominator_missing(), test_derive_rates_null_when_vacancy_missing()
...
Cohesion: 0.33
Nodes (6): _clamp(), compute_behavior_snapshot(), _focus_minutes(), _ratio(), Apply the spec's focus rule: a session is focus-credited when it is     >= 25 m, Compute (do not persist) a behavior snapshot for the given day.      Any of th
...
Cohesion: 0.53
Nodes (5): main(), _paper_of(), _plan(), (id, sort_order) pairs to write, and the rows that could not be placed., run()
...
Cohesion: 0.33
Nodes (5): 2024 & 2025 GS reconciliation vs raw DOCX, Files judged OUT OF SCOPE (not scored), Files used (one authoritative file per year+paper), Verdict counts by year, Verdict counts by year and paper

### Community 1512 - "Community 1512"
Cohesion: 0.33
Nodes (5): Conclusion, Legacy-font run filter — detection, removal, and re-score, Per-paper text removed, Re-score 2015 GS1 — WITH vs WITHOUT filter, Re-score 2015 GS2 — WITH vs WITHOUT filter

### Community 1513 - "Community 1513"
Cohesion: 0.33
Nodes (5): Near-duplicate scan (score >= 95, within one side of a group), Per year, Retagging load, Source defects carried through, not fixed, UPSC GS Mains corpus repair worklist - summary

### Community 1514 - "Community 1514"
Cohesion: 0.33
Nodes (5): Confidence, Effect on the v1 durable worksheet (not changed here), RBI GA re-classification v2 — under `workbench/docs/GA-BOUNDARY-RULE.md`, Result, Rulings used where the rule text needed applying
...
Cohesion: 0.4
Nodes (5): denylisted_title(), prefilter_document(), Return the matched deny-list pattern for ``title``, or ``None``.      Case-ins, Structural pre-filter: decide whether a fetched body is worth snapshotting, Structural pre-filter: decide whether a fetched body is worth snapshotting

### Community 1526 - "Community 1526"
Cohesion: 0.4
Nodes (5): adapter_defaults(), publisher_of(), The ``adapter_config.publisher`` marker for a source, or ``None``., Return the publisher defaults for ``source`` or ``None`` when unknown.      Un, Return the publisher defaults for ``source`` or ``None`` when unknown.      Un
...
Cohesion: 0.4
Nodes (5): Map a ``writing_prompts.exercise_type`` to an evidence ``source_type``.      S, source_type_for_exercise(), test_source_type_paragraph_exercises(), test_source_type_sentence_exercises(), test_source_type_unknown_falls_back()
...
Cohesion: 0.4
Nodes (5): _build_fingerprint(), SHA-256 fingerprint over all inputs that affect score computation.      Includ, SHA-256 fingerprint over all inputs that affect score computation.      Includ, SHA-256 fingerprint over all inputs that affect score computation.      Includ, SHA-256 fingerprint over all inputs that affect score computation.      Includ

### Community 1535 - "Community 1535"
Cohesion: 0.4
Nodes (5): _chunks(), Split *lst* into chunks of at most *n* items each., Split *lst* into chunks of at most *n* items each., Split *lst* into chunks of at most *n* items each., Split *lst* into chunks of at most *n* items each.

### Community 1538 - "Community 1538"
Cohesion: 0.7
Nodes (4): mockTrendLabel(), pct(), WeekTruth(), weekTruthLines()

### Community 1541 - "Community 1541"
Cohesion: 0.7
Nodes (4): build(), main(), verdict(), write_report()

### Community 1542 - "Community 1542"
Cohesion: 0.7
Nodes (4): _dist(), docx_fulltext(), main(), write_report()
...
Cohesion: 0.4
Nodes (4): Flipping rows (all 29; the first 10 are the requested examples), Method, RBI GA durable worksheet: boundary-rule spot-check, What this tells the reviewer
...
Cohesion: 0.5
Nodes (4): _load_required_router(), Load a required APIRouter with an explicit runtime error message., Load a required APIRouter with an explicit runtime error message., Load a required APIRouter with an explicit runtime error message.

### Community 1586 - "Community 1586"
Cohesion: 0.5
Nodes (4): _num(), Sort helper: numeric-first, NULLs/non-numeric last, deterministically., Sort helper: numeric-first, NULLs/non-numeric last, deterministically., Sort helper: numeric-first, NULLs/non-numeric last, deterministically.

### Community 1592 - "Community 1592"
Cohesion: 0.5
Nodes (4): _cohort_stats(), Return ``{topic_id: (cohort_total, cohort_topic_count)}``.      A topic's **pe, Return ``{topic_id: (cohort_total, cohort_topic_count)}``.      A topic's **pe, Return ``{topic_id: (cohort_total, cohort_topic_count)}``.      A topic's **pe

### Community 1593 - "Community 1593"
Cohesion: 0.5
Nodes (4): compute_score_snapshots(), Trigger snapshot computation for all topics in an exam.      Delegates to ``co, Trigger snapshot computation for all topics in an exam.      Delegates to ``co, Trigger snapshot computation for all topics in an exam.      Delegates to ``co

### Community 1594 - "Community 1594"
Cohesion: 0.5
Nodes (4): _question(), Their answer is theirs. Hiding it because the corpus changed under them     wou, test_an_attempt_survives_its_question_losing_verification(), test_the_excerpt_is_cut_on_a_word_boundary_with_an_ellipsis()

### Community 1595 - "Community 1595"
Cohesion: 0.67
Nodes (4): _admin_psql(), _apply(), _psql_file(), _swap_dbname()

### Community 1602 - "Community 1602"
Cohesion: 0.5
Nodes (4): Deterministic, collision-resistant slug.      Micro-theme strings are long pro, Deterministic, collision-resistant slug.      Micro-theme strings are long pro, Deterministic, collision-resistant slug.      Micro-theme strings are long pro, slugify()
...
Cohesion: 0.67
Nodes (3): db_health(), DbHealth, get_pool()

### Community 1657 - "Community 1657"
Cohesion: 0.67
Nodes (3): AdapterDefaults, Per-publisher defaults applied to a fetched document when the source row     do, Per-publisher defaults applied to a fetched document when the source row     do

### Community 1658 - "Community 1658"
Cohesion: 0.67
Nodes (3): Resolve the URL to fetch for a source based on its ``adapter_type``.      RSS/, Resolve the URL to fetch for a source based on its ``adapter_type``.      RSS/, resolve_fetch_url()

### Community 1659 - "Community 1659"
Cohesion: 0.67
Nodes (3): _nudge_focus_streak_break(), Reuse planner._missed_days_streak so the two surfaces agree., Reuse planner._missed_days_streak so the two surfaces agree.
...
Cohesion: 0.67
Nodes (3): allocation_targets(), Split ``total`` task slots into shared_core / target_delta / current_affairs, test_allocation_sums_exactly()
...
## Knowledge Gaps
- **19685 isolated node(s):** `Build the v1 bulk-import array for UPSC CSE Prelims 2025 GS Paper I, Set A.  M`, `Diff pyq_*_prelims_gs1_*.json correct_option_label against official UPSC keys.`, `Generate the answer-key migration for UPSC Prelims GS Paper I, 2018-2024.  Inp`, `Loose comparison: case, whitespace, punctuation and quote style.`, `Generate the answer-key migration for UPSC Prelims GS-I 2020 (Set C).  2020 di` (+19680 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **4550 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `LIST` connect `Community 238` to `Community 1`, `Community 3`, `Community 515`, `Community 1035`, `Community 12`, `Community 527`, `Community 1042`, `Community 23`, `Community 536`, `Community 25`, `Community 24`, `Community 539`, `Community 32`, `Community 35`, `Community 36`, `Community 39`, `Community 43`, `Community 45`, `Community 47`, `Community 48`, `Community 49`, `Community 1078`, `Community 567`, `Community 568`, `Community 55`, `Community 58`, `Community 59`, `Community 61`, `Community 1086`, `Community 64`, `Community 68`, `Community 580`, `Community 70`, `Community 582`, `Community 71`, `Community 74`, `Community 75`, `Community 81`, `Community 594`, `Community 600`, `Community 601`, `Community 91`, `Community 92`, `Community 93`, `Community 603`, `Community 1120`, `Community 1123`, `Community 616`, `Community 618`, `Community 1132`, `Community 108`, `Community 1134`, `Community 111`, `Community 1133`, `Community 109`, `Community 114`, `Community 630`, `Community 118`, `Community 120`, `Community 122`, `Community 637`, `Community 638`, `Community 127`, `Community 129`, `Community 131`, `Community 1156`, `Community 132`, `Community 134`, `Community 136`, `Community 139`, `Community 141`, `Community 142`, `Community 143`, `Community 1168`, `Community 661`, `Community 152`, `Community 157`, `Community 160`, `Community 673`, `Community 167`, `Community 175`, `Community 689`, `Community 690`, `Community 693`, `Community 181`, `Community 186`, `Community 187`, `Community 201`, `Community 1228`, `Community 204`, `Community 719`, `Community 208`, `Community 209`, `Community 210`, `Community 1235`, `Community 212`, `Community 726`, `Community 215`, `Community 219`, `Community 223`, `Community 225`, `Community 226`, `Community 227`, `Community 743`, `Community 236`, `Community 751`, `Community 752`, `Community 241`, `Community 244`, `Community 1273`, `Community 1278`, `Community 256`, `Community 769`, `Community 257`, `Community 258`, `Community 776`, `Community 269`, `Community 785`, `Community 787`, `Community 275`, `Community 277`, `Community 276`, `Community 279`, `Community 280`, `Community 282`, `Community 286`, `Community 801`, `Community 802`, `Community 292`, `Community 293`, `Community 299`, `Community 812`, `Community 1330`, `Community 307`, `Community 310`, `Community 829`, `Community 318`, `Community 319`, `Community 830`, `Community 831`, `Community 322`, `Community 835`, `Community 329`, `Community 345`, `Community 356`, `Community 874`, `Community 875`, `Community 364`, `Community 367`, `Community 381`, `Community 389`, `Community 1416`, `Community 1417`, `Community 906`, `Community 910`, `Community 912`, `Community 404`, `Community 917`, `Community 406`, `Community 919`, `Community 407`, `Community 410`, `Community 412`, `Community 413`, `Community 421`, `Community 424`, `Community 426`, `Community 431`, `Community 434`, `Community 440`, `Community 953`, `Community 961`, `Community 964`, `Community 462`, `Community 471`, `Community 478`, `Community 479`, `Community 480`, `Community 993`, `Community 482`, `Community 484`, `Community 1001`, `Community 497`, `Community 500`, `Community 1023`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `SBStub` connect `Community 15` to `Community 512`, `Community 1`, `Community 513`, `Community 518`, `Community 10`, `Community 522`, `Community 13`, `Community 14`, `Community 21`, `Community 534`, `Community 23`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 546`, `Community 36`, `Community 37`, `Community 550`, `Community 549`, `Community 40`, `Community 41`, `Community 554`, `Community 42`, `Community 1071`, `Community 1072`, `Community 1073`, `Community 50`, `Community 563`, `Community 565`, `Community 1079`, `Community 568`, `Community 58`, `Community 60`, `Community 1087`, `Community 592`, `Community 594`, `Community 83`, `Community 82`, `Community 85`, `Community 88`, `Community 89`, `Community 602`, `Community 1118`, `Community 97`, `Community 1122`, `Community 98`, `Community 99`, `Community 105`, `Community 109`, `Community 111`, `Community 112`, `Community 113`, `Community 116`, `Community 632`, `Community 121`, `Community 120`, `Community 635`, `Community 123`, `Community 638`, `Community 127`, `Community 128`, `Community 644`, `Community 132`, `Community 646`, `Community 138`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 657`, `Community 660`, `Community 1176`, `Community 155`, `Community 156`, `Community 159`, `Community 161`, `Community 162`, `Community 163`, `Community 165`, `Community 171`, `Community 172`, `Community 687`, `Community 180`, `Community 1717`, `Community 181`, `Community 1220`, `Community 1221`, `Community 716`, `Community 206`, `Community 207`, `Community 208`, `Community 216`, `Community 217`, `Community 729`, `Community 220`, `Community 223`, `Community 224`, `Community 228`, `Community 230`, `Community 233`, `Community 745`, `Community 753`, `Community 755`, `Community 1779`, `Community 1270`, `Community 250`, `Community 253`, `Community 258`, `Community 1284`, `Community 264`, `Community 266`, `Community 267`, `Community 782`, `Community 784`, `Community 788`, `Community 789`, `Community 291`, `Community 292`, `Community 803`, `Community 294`, `Community 806`, `Community 300`, `Community 301`, `Community 310`, `Community 830`, `Community 319`, `Community 320`, `Community 321`, `Community 322`, `Community 323`, `Community 328`, `Community 336`, `Community 340`, `Community 341`, `Community 349`, `Community 351`, `Community 352`, `Community 353`, `Community 355`, `Community 868`, `Community 869`, `Community 870`, `Community 356`, `Community 875`, `Community 375`, `Community 376`, `Community 889`, `Community 890`, `Community 379`, `Community 377`, `Community 381`, `Community 891`, `Community 391`, `Community 402`, `Community 403`, `Community 417`, `Community 423`, `Community 429`, `Community 434`, `Community 1462`, `Community 440`, `Community 441`, `Community 442`, `Community 444`, `Community 1475`, `Community 455`, `Community 970`, `Community 458`, `Community 469`, `Community 983`, `Community 473`, `Community 474`, `Community 480`, `Community 494`, `Community 496`, `Community 504`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `get_supabase_admin()` connect `Community 3` to `Community 0`, `Community 1`, `Community 519`, `Community 520`, `Community 7`, `Community 1035`, `Community 12`, `Community 17`, `Community 25`, `Community 27`, `Community 1571`, `Community 39`, `Community 43`, `Community 47`, `Community 51`, `Community 1078`, `Community 1593`, `Community 58`, `Community 59`, `Community 73`, `Community 81`, `Community 82`, `Community 84`, `Community 599`, `Community 600`, `Community 87`, `Community 93`, `Community 95`, `Community 613`, `Community 614`, `Community 107`, `Community 1132`, `Community 108`, `Community 1134`, `Community 115`, `Community 1654`, `Community 1142`, `Community 129`, `Community 642`, `Community 641`, `Community 132`, `Community 134`, `Community 137`, `Community 141`, `Community 146`, `Community 177`, `Community 179`, `Community 190`, `Community 192`, `Community 202`, `Community 1228`, `Community 204`, `Community 1230`, `Community 719`, `Community 1231`, `Community 212`, `Community 225`, `Community 227`, `Community 237`, `Community 238`, `Community 751`, `Community 753`, `Community 1272`, `Community 769`, `Community 771`, `Community 772`, `Community 781`, `Community 279`, `Community 281`, `Community 282`, `Community 283`, `Community 287`, `Community 293`, `Community 296`, `Community 299`, `Community 811`, `Community 815`, `Community 816`, `Community 1341`, `Community 1343`, `Community 832`, `Community 336`, `Community 342`, `Community 871`, `Community 366`, `Community 883`, `Community 885`, `Community 374`, `Community 389`, `Community 396`, `Community 403`, `Community 413`, `Community 421`, `Community 424`, `Community 426`, `Community 433`, `Community 434`, `Community 438`, `Community 960`, `Community 961`, `Community 988`, `Community 989`, `Community 990`, `Community 502`?**
...
- **Are the 865 inferred relationships involving `get_supabase_admin()` (e.g. with `_bootstrap_mock_publishers()` and `db_health()`) actually correct?**
  _`get_supabase_admin()` has 865 INFERRED edges - model-reasoned connections that need verification._
