...
| I8-A/B/C — Exam Management consolidation | **I8-A: MERGED (PR #755) · I8-B: IN PROGRESS (PR #757) · I8-C: GATED — I8-B MERGE** | I8-A merged at `899f450b`; I8-B PR open, revision in progress; I8-C gated on I8-B merge; serial, one owner |
...
| I8-B — Manage Exam consolidation | CODE-FIXED, VALIDATION PENDING | Revision in progress: URL-driven tab state, cycle-aware action queue via management endpoint, backend verdict authority (activation_verdict), identity header (management_mode/cadence/is_active/family/org), entity-level CTA routes (row/paper/document params), embedded 404 visible error, behavioral tests. PR #757 open. |
