...
| I8-A/B/C — Exam Management consolidation | **I8-A: MERGED (PR #755) · I8-B: CODE-FIXED, VALIDATION PENDING · I8-C: GATED — I8-B MERGE** | I8-A merged at `899f450b`; I8-B PR open; I8-C gated on I8-B merge; serial, one owner |
...
| I8-B — Manage Exam consolidation | CODE-FIXED, VALIDATION PENDING | Embeds verdict/action queue/activation checks into Manage Exam drill-in. Overview tab eliminated. Cycle moved to `?cycle=` query param. ConsoleWorkQueue reduced to single "Manage exam" CTA. Compat redirects for `/console/:id`, `/workspace/:id`, `/workspace/:id/:cycle_id`. |
