...
| I6 cycle-setup gate document | **DRAFT / REBASE VERIFIED — PR #758** | Gate document created in `docs/status/Exam-Cycle-Setup-Gate-2026-06-22.md`; rebased onto main post-PR #757 merge (385912b); all REBASE VERIFY items resolved; I9 backend contract proposed; acceptance scenarios A1–A9 defined; UNRESOLVED items upgraded to DERIVED — PROPOSED RESOLUTION. Operator approval of all DERIVED items required before I9 dispatch; I8-C prerequisite still pending. |
| I8-A/B/C — Exam Management consolidation | **I8-A: MERGED (PR #755) · I8-B: MERGED (PR #757 at 385912b) · I8-C: UNBLOCKED — IMPLEMENTATION PENDING** | I8-A merged at `899f450b`; I8-B merged at `385912b` (URL-driven tab state, cycle-aware action queue, backend verdict authority, identity header, deep-link params, behavioral tests); I8-C now unblocked; serial, one owner |
...
| I8-C — Advanced Repair isolation | UNBLOCKED — IMPLEMENTATION PENDING | I8-B merged; I8-C now unblocked. Scope limited to access model only: adds overflow action in Manage Exam, adds `exam_intelligence.cms` permission gate, adds AdminSafetyBanner warning. Sidebar removal already done by I8-A — I8-C does NOT re-do it. I9 dispatch blocked until I8-C completes. |
