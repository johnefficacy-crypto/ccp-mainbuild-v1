...
| I8-A/B/C — Exam Management consolidation | **I8-A: MERGED (PR #755) · I8-B: MERGED (PR #757) · I8-C: CODE-FIXED, VALIDATION PENDING** | I8-A merged at `899f450b`; I8-B merged at `385912bd`; I8-C branch `feat/i8c-advanced-repair-isolation` open; serial, one owner |
...
| I8-C — Advanced Repair isolation | CODE-FIXED, VALIDATION PENDING — PR #759 open (draft) | Overflow action in Manage Exam (`AdvancedRepairMenu`); `exam_intelligence.cms` permission gate; `AdminSafetyBanner` replaces amber banner; scoped list requests (exam_id / exam_cycle_id); `/console` redirect to `/exam-intelligence`; navContract updated; 27 new tests (8 More-menu + 19 access-control). Unused import (AdminExamGovernanceConsole) removed; Vercel preview deployed successfully. CI pending: validate-pr-body + frontend on latest push. |
