...
Last repo verification: 2026-06-21 at `main @ 2308b31` + PR #753 branch `fix/a4-sync-submit-allowlist-bypass` (includes PRs #745 mastery error-pattern fix, #746 allowlist/pinned-mode fix, #753 pinned-mode-per-attempt + A4 sync-submit + analytics-retry re-resolution fix).
...
| I7 — KG exam lane removal | **MERGED / CODE PRESENT** | PR #749 merged. |
| Mock semantics trust fix | **MERGED / CODE PRESENT** | PR #751 merged. |
...
| I6 cycle-setup gate document | **APPROVED — READY FOR MERGE — PR #761** | Gate document created in `docs/status/Exam-Cycle-Setup-Gate-2026-06-22.md`; rebased onto main post-PR #757 and #759 merges; all REBASE VERIFY items resolved; I9 backend contract proposed; acceptance scenarios A1–A9 defined; decision register D01–D16 added; I6 exit criteria E1–E6 defined. PR #761 supersedes PR #758; PR #758 is closed without merge (2026-06-22). Operator decisions recorded: D01–D16 all APPROVED (johnefficacy-crypto, 2026-06-23/24); D13 APPROVED 2026-06-24 as controlled temporary admin-readiness waiver. E1–E6 all MET: E5 confirmed green at 1e7eb6d; E6 approved by johnefficacy-crypto 2026-06-24. PR #761 marked ready for merge. I9 and D13 waiver implementation are separate follow-up PRs. J1/J2 unblocked once PR #761 merges. |
| I8-A/B/C — Exam Management consolidation | **I8-A: MERGED (PR #755) · I8-B: MERGED (PR #757 at 385912bd) · I8-C: MERGED (PR #759 at a98a0dc)** | I8-A merged at `899f450b`; I8-B merged at `385912bd`; I8-C merged at `a98a0dc` (overflow action, `exam_intelligence.cms` permission gate, AdminSafetyBanner, scoped list requests, WAI-ARIA keyboard nav); I9 dispatch unblocked from I8 sequencing; serial, one owner |
...
| I8-C — Advanced Repair isolation | MERGED — PR #759 (a98a0dc) | Overflow action in Manage Exam (`AdvancedRepairMenu`); `exam_intelligence.cms` permission gate; `AdminSafetyBanner` replaces amber banner; scoped list requests (exam_id / exam_cycle_id); `/console` redirect to `/exam-intelligence`; navContract updated; all auth hydration, scope prop, race, and WAI-ARIA fixes landed; 18 scope tests + 21 access tests + 6 keyboard-nav tests. I9 dispatch from I8-C sequencing requirement now unblocked. |
...
| J1 — Advanced Repair scoping | DEFERRED — GATED BY I6 APPROVAL | Selected exam + cycle scope, search, filters, pagination, explicit warning, permission gate. I8-C merged; now gated on I6 gate approval and I9 dispatch. |
| J2 — missing operational editors in Manage Exam | DEFERRED — GATED BY I6 APPROVAL | Move normal work into Manage Exam tabs: topic/microtopic management, alias management, prerequisite editing, historical paper creation, question/option correction, policy flag correction, cycle-specific entity management. I8-C merged; now gated on I6 gate approval and I9 dispatch. |
