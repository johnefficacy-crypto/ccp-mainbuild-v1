...
do $$
declare
  v_family_id  uuid := 'e2ew0000-0000-4000-8000-000000000001';
  v_exam_id    uuid := 'e2ew0000-0000-4000-8000-000000000002';
  v_subject_id uuid := 'e2ew0000-0000-4000-8000-000000000003';
  v_topic_id   uuid := 'e2ew0000-0000-4000-8000-000000000004';
  v_paper_id   uuid := 'e2ew0000-0000-4000-8000-000000000005';
begin
