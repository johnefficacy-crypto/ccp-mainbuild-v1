...
def _exam_seed(*, with_cycle: bool = True, with_exam_start: bool = True):
    ...
    if with_cycle:
        seed["exam_cycles"] = [{
            "id": "cyc-1",
            "exam_id": "exam-1",
            "reviewer_status": "verified", "cycle_name": "2026",
            "status": "active",
...
def test_v2_2_cycle_loaded_from_resolver_cycle_id():
    ...
    seed = {
        ...
        "exams": [{"id": "exam-1", "slug": "ssc-cgl", "name": "SSC CGL",
                   "exam_type": "recruitment", "is_active": True}],
        "exam_cycles": [
            {"id": "cyc-old", "exam_id": "exam-1", "reviewer_status": "verified", "cycle_name": "2025 Cycle",
             "status": "completed", "exam_start": (today - timedelta(days=365)).isoformat(), "year": 2025},
            {"id": "cyc-new", "exam_id": "exam-1", "reviewer_status": "verified", "cycle_name": "2026 Cycle",
