...
# Baseline rule_types mirror migration 247's CHECK. experience_min_years is
...
# mirroring the DB fail-closed CHECK in migration 247.
...
def _valid_qualification_combination(node: Any) -> bool:
    """Mirror of migration 247's is_valid_qualification_combination()."""
...
def create_rule(
    ...
    # (exam_id, stream_id, scope, rule_type) per migration 247 — a common rule
