...
import { humanizeToken, relativeDate } from "../../features/admin/exam-intelligence/operatorChrome";
              ...
              {audit.map((row, i) => (
                ...
                >
                  <div style={{ minWidth: 0 }}>
                    ...
                    <div className="anno">{row.target ? humanizeToken(row.target) : "—"} · {row.actor}</div>
