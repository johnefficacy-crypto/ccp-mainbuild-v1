...
const STEPS = [
  ...
  { id: "study", title: "Study rhythm", subtitle: "We'll adapt recommendations to your weekly capacity.", fields: ["study_mode", "weekly_hours_goal", "target_exam"] },
];
...
export default function Onboarding() {
  ...
  const methods = useForm({
    ...
    defaultValues: {
      name: auth.user?.name || "", date_of_birth: "", gender: "", category: "", pwbd_status: "", state: "", education_level: "", qualification: "", stream: "", qualification_year: "", marks_type: "percentage", percentage: "", cgpa: "", goal_exams: [], preferred_sectors: [], preferred_states: [], willing_to_relocate: true, study_mode: "", weekly_hours_goal: "", target_exam: "",
    },
    mode: "onTouched",
  });
