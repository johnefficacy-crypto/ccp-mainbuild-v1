...
export default function MCQMulti({ question, mode, value, onChange, disabled, showExplanation }) {
  ...
  return <div><QuestionStem text={question.question_text} images={question.images}/><OptionList options={question.options} selected={sel} multiple onSelect={toggle} disabled={disabled||mode==="review"}/>{showExplanation && question.explanation ? <MathRenderer text={question.explanation} />:null}<CommonTrap mode={mode} text={question.common_trap}/></div>;
}
