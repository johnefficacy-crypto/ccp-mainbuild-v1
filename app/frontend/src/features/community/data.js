...
export const RESOURCES = [
  { id: "res1", title: "UPSC CSE 2026 Notification (PDF)", type: "strategy_guide", category: "study_material", exam: "upsc-cse", subject: "Meta", sourceTrust: "official", contributedBy: "u_admin", upvotes: 3210, verifiedByTopper: false, createdAt: "3d", size: "4.2 MB" },
  { id: "res2", title: "Federalism · 47-page notes", type: "notes", category: "study_material", exam: "upsc-cse", subject: "Polity", sourceTrust: "community", contributedBy: "u_ritu", upvotes: 1241, verifiedByTopper: true, createdAt: "1d", size: "2.1 MB" },
  { id: "res3", title: "PYQ archive · Polity 2018–2024", type: "pyq_paper", category: "pyq", exam: "upsc-cse", subject: "Polity", sourceTrust: "official", contributedBy: "u_admin", upvotes: 2842, verifiedByTopper: false, createdAt: "2w", size: "12.6 MB" },
  { id: "res4", title: "Economy · Monetary policy summary", type: "notes", category: "study_material", exam: "upsc-cse", subject: "Economy", sourceTrust: "coaching", contributedBy: "u_neha", upvotes: 412, verifiedByTopper: false, createdAt: "5d", size: "880 KB" },
  { id: "res5", title: "Daily compiler template (Notion)", type: "video_link", category: "study_material", exam: "upsc-cse", subject: "Meta", sourceTrust: "community", contributedBy: "u_aarav", upvotes: 208, verifiedByTopper: false, createdAt: "1w", size: "link" },
  { id: "res6", title: "SSC CGL Quant — Percentage shortcuts", type: "notes", category: "study_material", exam: "SSC CGL", subject: "Quant", sourceTrust: "community", contributedBy: "u_zaid", upvotes: 312, verifiedByTopper: false, createdAt: "4d", size: "1.4 MB" },
  { id: "res7", title: "Laxmikanth · chapter map (handwritten)", type: "book", category: "study_material", exam: "upsc-cse", subject: "Polity", sourceTrust: "unknown", contributedBy: "u_anjali", upvotes: 88, verifiedByTopper: false, createdAt: "3d", size: "3.1 MB", flagged: true },
  { id: "res8", title: "IPS interview transcript · 2023 batch", type: "strategy_guide", category: "study_material", exam: "upsc-cse", subject: "Interview", sourceTrust: "community", contributedBy: "u_arjun", upvotes: 914, verifiedByTopper: true, createdAt: "2w", size: "640 KB" },
];
