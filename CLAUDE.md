...
5. `docs/status/career-copilot-checklist.md` — implementation/product-decision history
6. `docs/operator-validation/registry.json` and generated `docs/operator-validation/INDEX.md` — live operator-validation gates
...
- `docs/operator-validation/registry.json` is the only mutable source for operator-validation gate status. `docs/operator-validation/INDEX.md` is generated and must never be edited manually.
- `docs/status/career-copilot-checklist.md` remains implementation/product-decision history. Do not mirror live operator gate status into it or into track checklists and runbooks.
